namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MLProblemType_CrtMLEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : MLProblemType
	{

namespace Terrasoft.Configuration
{
	...
	public class SysModuleVisaSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysModuleVisa_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysModuleVisa : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysModuleVisa_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysModuleVisa_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysModuleVisa_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleVisa
	{

		public SysModuleVisa_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysModuleVisa_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysModuleVisa_CrtCoreBaseEventsProcess : SysModuleVisa_CrtCoreBaseEventsProcess<SysModuleVisa>
	{
	...
	public partial class SysModuleVisa_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysModuleVisaEventsProcess : SysModuleVisa_CrtCoreBaseEventsProcess
	{

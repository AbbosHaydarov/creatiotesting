namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_Exchange_TerrasoftSchema : Terrasoft.Configuration.Activity_CrtDocument_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_Exchange_Terrasoft : Terrasoft.Configuration.Activity_CrtDocument_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_ExchangeEventsProcess<TEntity> : Terrasoft.Configuration.Activity_CrtDocumentEventsProcess<TEntity> where TEntity : Activity_Exchange_Terrasoft
	{

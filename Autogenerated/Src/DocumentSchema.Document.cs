namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Document_Document_TerrasoftSchema : Terrasoft.Configuration.Document_CrtFinservDocument_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateNumberColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("2d430460-3822-44db-892c-6b8dd675827f");
			return column;
		}
	...
	/// Document.
	/// </summary>
	public class Document_Document_Terrasoft : Terrasoft.Configuration.Document_CrtFinservDocument_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Document_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.Document_CrtFinservDocumentEventsProcess<TEntity> where TEntity : Document_Document_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServicePactType_CrtSLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ServicePactType
	{

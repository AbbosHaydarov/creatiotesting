namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignTargetStatus_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CampaignTargetStatus
	{

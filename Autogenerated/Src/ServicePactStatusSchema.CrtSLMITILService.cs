namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServicePactStatus_CrtSLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ServicePactStatus
	{

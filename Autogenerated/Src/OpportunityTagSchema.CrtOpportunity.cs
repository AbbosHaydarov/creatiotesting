namespace Terrasoft.Configuration
{
	...
	public class OpportunityTag_CrtOpportunity_Terrasoft : Terrasoft.Configuration.BaseTag
	{
		...
		protected override void InitializeThrowEvents() {
			Deleting += (s, e) => ThrowEvent("OpportunityTag_CrtOpportunity_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("OpportunityTag_CrtOpportunity_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("OpportunityTag_CrtOpportunity_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("OpportunityTag_CrtOpportunity_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("OpportunityTag_CrtOpportunity_TerrasoftSaving", e);

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FileExtension_CrtUIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : FileExtension
	{

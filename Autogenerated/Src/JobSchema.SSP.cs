namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class JobSchema : Terrasoft.Configuration.Job_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Job title.
	/// </summary>
	public class Job : Terrasoft.Configuration.Job_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Job_SSPEventsProcess<TEntity> : Terrasoft.Configuration.Job_CrtCoreBaseEventsProcess<TEntity> where TEntity : Job
	{

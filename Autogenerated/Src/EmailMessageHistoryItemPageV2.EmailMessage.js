		...
		return {
			...
			methods: {
				...
				getEmailActionParams: function (action) {
					const entitySchemaName = "Activity";
					const emailConfig = this.getModuleStructure(entitySchemaName);
					const activityEntityStructure = Terrasoft.ModuleUtils.getEntityStructureByName(entitySchemaName);
					if (activityEntityStructure.page8X) {
						return {
							hash: emailConfig.cardModule + '/EmailFormPage/edit/' + this.get("RecordId")
						};
					}
					return {

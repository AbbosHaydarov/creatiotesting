namespace Terrasoft.Configuration
{
	...
	public class BaseCodeImageLookupSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BaseCodeImageLookup_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class BaseCodeImageLookup : Terrasoft.Configuration.BaseCodeLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new BaseCodeImageLookup_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: BaseCodeImageLookup_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class BaseCodeImageLookup_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BaseCodeImageLookup
	{

		public BaseCodeImageLookup_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "BaseCodeImageLookup_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class BaseCodeImageLookup_CrtCoreBaseEventsProcess : BaseCodeImageLookup_CrtCoreBaseEventsProcess<BaseCodeImageLookup>
	{
	...
	public partial class BaseCodeImageLookup_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class BaseCodeImageLookupEventsProcess : BaseCodeImageLookup_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class RemindingSchema : Terrasoft.Configuration.Reminding_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Notification.
	/// </summary>
	public class Reminding : Terrasoft.Configuration.Reminding_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Reminding_CrtNUIEventsProcess<TEntity> : Terrasoft.Configuration.Reminding_CrtCoreBaseEventsProcess<TEntity> where TEntity : Reminding
	{

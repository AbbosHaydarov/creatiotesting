namespace Terrasoft.Configuration
{
	...
	#region Class: CommunicationType_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class CommunicationType_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseImageLookupSchema
	{

		#region Constructors: Public

		public CommunicationType_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public CommunicationType_CrtCoreBase_TerrasoftSchema(CommunicationType_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public CommunicationType_CrtCoreBase_TerrasoftSchema(CommunicationType_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "CommunicationType_CrtCoreBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new CommunicationType_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CommunicationType_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new CommunicationType_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new CommunicationType_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: CommunicationType_CrtCoreBase_Terrasoft

	/// <summary>
	/// Communication option type.
	/// </summary>
	public class CommunicationType_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseImageLookup
	{

		#region Constructors: Public

		public CommunicationType_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "CommunicationType_CrtCoreBase_Terrasoft";
		}

		public CommunicationType_CrtCoreBase_Terrasoft(CommunicationType_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new CommunicationType_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("CommunicationType_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("CommunicationType_CrtCoreBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("CommunicationType_CrtCoreBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("CommunicationType_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("CommunicationType_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("CommunicationType_CrtCoreBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("CommunicationType_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new CommunicationType_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: CommunicationType_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class CommunicationType_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseImageLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CommunicationType_CrtCoreBase_Terrasoft
	{

		public CommunicationType_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "CommunicationType_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class CommunicationType_CrtCoreBaseEventsProcess : CommunicationType_CrtCoreBaseEventsProcess<CommunicationType_CrtCoreBase_Terrasoft>
	{
	...
	public partial class CommunicationType_CrtCoreBaseEventsProcess<TEntity>
	{

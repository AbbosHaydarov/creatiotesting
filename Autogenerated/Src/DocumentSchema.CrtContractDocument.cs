namespace Terrasoft.Configuration
{
	...
	public class Document_CrtContractDocument_TerrasoftSchema : Terrasoft.Configuration.Document_CrtDocument_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateNumberColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("05ec5c8c-fd85-418e-8d4a-95cd4f8b1f77");
			return column;
		}
	...
	public class Document_CrtContractDocument_Terrasoft : Terrasoft.Configuration.Document_CrtDocument_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Document_CrtContractDocument_TerrasoftDeleted", e);
			Validating += (s, e) => ThrowEvent("Document_CrtContractDocument_TerrasoftValidating", e);

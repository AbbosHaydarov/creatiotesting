namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class PricelistSchema : Terrasoft.Configuration.BaseLookupSchema
	{
	...
	/// Price list.
	/// </summary>
	public class Pricelist : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("PricelistDeleted", e);
			Inserting += (s, e) => ThrowEvent("PricelistInserting", e);
			Validating += (s, e) => ThrowEvent("PricelistValidating", e);
	...
	/// <exclude/>
	public partial class Pricelist_CrtProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : Pricelist
	{
	...
	/// <exclude/>
	public class Pricelist_CrtProductCatalogueEventsProcess : Pricelist_CrtProductCatalogueEventsProcess<Pricelist>
	{
	...
	/// <exclude/>
	public class PricelistEventsProcess : Pricelist_CrtProductCatalogueEventsProcess
	{

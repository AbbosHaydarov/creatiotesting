namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysSettings_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysSettings
	{

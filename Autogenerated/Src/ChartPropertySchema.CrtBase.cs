namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ChartProperty_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ChartProperty
	{

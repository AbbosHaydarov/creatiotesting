namespace Terrasoft.Configuration
{
	...
	public class DocumentFile : Terrasoft.Configuration.DocumentFile_CrtDocument_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("DocumentFileDeleting", e);
			Inserted += (s, e) => ThrowEvent("DocumentFileInserted", e);
			Inserting += (s, e) => ThrowEvent("DocumentFileInserting", e);
			Saved += (s, e) => ThrowEvent("DocumentFileSaved", e);
			Saving += (s, e) => ThrowEvent("DocumentFileSaving", e);
			Updated += (s, e) => ThrowEvent("DocumentFileUpdated", e);
			Validating += (s, e) => ThrowEvent("DocumentFileValidating", e);

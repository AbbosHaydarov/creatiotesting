namespace Terrasoft.Configuration
{
	...
	#region Class: File_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class File_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public File_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public File_CrtCoreBase_TerrasoftSchema(File_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public File_CrtCoreBase_TerrasoftSchema(File_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "File_CrtCoreBase_Terrasoft";
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("77cd05e5-e1fd-39a2-77e3-cced2aa45a51")) == null) {
				Columns.Add(CreateTotalSizeColumn());
			}
		}
		...
		protected virtual EntitySchemaColumn CreateTotalSizeColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Integer")) {
				UId = new Guid("77cd05e5-e1fd-39a2-77e3-cced2aa45a51"),
				Name = @"TotalSize",
				CreatedInSchemaUId = new Guid("556c5867-60a7-4456-aae1-a57a122bef70"),
				ModifiedInSchemaUId = new Guid("556c5867-60a7-4456-aae1-a57a122bef70"),
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new File_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new File_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new File_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new File_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: File_CrtCoreBase_Terrasoft

	/// <summary>
	/// File.
	/// </summary>
	public class File_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public File_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "File_CrtCoreBase_Terrasoft";
		}

		public File_CrtCoreBase_Terrasoft(File_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new File_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("File_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("File_CrtCoreBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("File_CrtCoreBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("File_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("File_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("File_CrtCoreBase_TerrasoftSaving", e);
			Updated += (s, e) => ThrowEvent("File_CrtCoreBase_TerrasoftUpdated", e);
			Validating += (s, e) => ThrowEvent("File_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new File_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: File_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class File_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : File_CrtCoreBase_Terrasoft
	{

		public File_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "File_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class File_CrtCoreBaseEventsProcess : File_CrtCoreBaseEventsProcess<File_CrtCoreBase_Terrasoft>
	{

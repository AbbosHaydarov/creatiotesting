namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignFile_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : CampaignFile
	{

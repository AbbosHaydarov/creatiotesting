namespace Terrasoft.Configuration
{
	...
	#region Class: AccountDuplicate_CrtBase_TerrasoftSchema

	/// <exclude/>
	public class AccountDuplicate_CrtBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public AccountDuplicate_CrtBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public AccountDuplicate_CrtBase_TerrasoftSchema(AccountDuplicate_CrtBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public AccountDuplicate_CrtBase_TerrasoftSchema(AccountDuplicate_CrtBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "AccountDuplicate_CrtBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new AccountDuplicate_CrtBase_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new AccountDuplicate_CrtBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new AccountDuplicate_CrtBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: AccountDuplicate_CrtBase_Terrasoft

	/// <summary>
	/// Account duplicate.
	/// </summary>
	public class AccountDuplicate_CrtBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public AccountDuplicate_CrtBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "AccountDuplicate_CrtBase_Terrasoft";
		}

		public AccountDuplicate_CrtBase_Terrasoft(AccountDuplicate_CrtBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("AccountDuplicate_CrtBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("AccountDuplicate_CrtBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("AccountDuplicate_CrtBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("AccountDuplicate_CrtBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("AccountDuplicate_CrtBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("AccountDuplicate_CrtBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("AccountDuplicate_CrtBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new AccountDuplicate_CrtBase_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class AccountDuplicate_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : AccountDuplicate_CrtBase_Terrasoft
	{
	...
	/// <exclude/>
	public class AccountDuplicate_CrtBaseEventsProcess : AccountDuplicate_CrtBaseEventsProcess<AccountDuplicate_CrtBase_Terrasoft>
	{

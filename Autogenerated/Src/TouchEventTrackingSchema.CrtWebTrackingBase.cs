namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TouchEventTracking_CrtWebTrackingBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : TouchEventTracking
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FileSecurityExcludedUri_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : FileSecurityExcludedUri
	{

namespace Terrasoft.Configuration
{
	...
	public class ServiceTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ServiceType_CrtSLMEventsProcess(userConnection);
		}
	...
	public class ServiceType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new ServiceType_CrtSLMEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("ServiceTypeDeleting", e);
			Inserted += (s, e) => ThrowEvent("ServiceTypeInserted", e);
			Inserting += (s, e) => ThrowEvent("ServiceTypeInserting", e);
			Saved += (s, e) => ThrowEvent("ServiceTypeSaved", e);
			Saving += (s, e) => ThrowEvent("ServiceTypeSaving", e);
	...
	#region Class: ServiceType_CrtSLMEventsProcess

	/// <exclude/>
	public partial class ServiceType_CrtSLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ServiceType
	{

		public ServiceType_CrtSLMEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "ServiceType_CrtSLMEventsProcess";
	...
	/// <exclude/>
	public class ServiceType_CrtSLMEventsProcess : ServiceType_CrtSLMEventsProcess<ServiceType>
	{
	...
	public partial class ServiceType_CrtSLMEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class ServiceTypeEventsProcess : ServiceType_CrtSLMEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	public class SysAdminOperationSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysAdminOperation_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysAdminOperation : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysAdminOperation_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysAdminOperation_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysAdminOperation_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysAdminOperation
	{

		public SysAdminOperation_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysAdminOperation_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysAdminOperation_CrtCoreBaseEventsProcess : SysAdminOperation_CrtCoreBaseEventsProcess<SysAdminOperation>
	{
	...
	public partial class SysAdminOperation_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysAdminOperationEventsProcess : SysAdminOperation_CrtCoreBaseEventsProcess
	{

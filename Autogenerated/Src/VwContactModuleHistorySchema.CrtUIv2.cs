namespace Terrasoft.Configuration
{
	...
	#region Class: VwContactModuleHistory_CrtUIv2_TerrasoftSchema

	/// <exclude/>
	public class VwContactModuleHistory_CrtUIv2_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public VwContactModuleHistory_CrtUIv2_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public VwContactModuleHistory_CrtUIv2_TerrasoftSchema(VwContactModuleHistory_CrtUIv2_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public VwContactModuleHistory_CrtUIv2_TerrasoftSchema(VwContactModuleHistory_CrtUIv2_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "VwContactModuleHistory_CrtUIv2_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new VwContactModuleHistory_CrtUIv2_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new VwContactModuleHistory_CrtUIv2_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new VwContactModuleHistory_CrtUIv2_TerrasoftSchema(this, true);
		}
	...
	#region Class: VwContactModuleHistory_CrtUIv2_Terrasoft

	/// <summary>
	/// Contacts section history (view).
	/// </summary>
	public class VwContactModuleHistory_CrtUIv2_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public VwContactModuleHistory_CrtUIv2_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "VwContactModuleHistory_CrtUIv2_Terrasoft";
		}

		public VwContactModuleHistory_CrtUIv2_Terrasoft(VwContactModuleHistory_CrtUIv2_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("VwContactModuleHistory_CrtUIv2_TerrasoftDeleted", e);
			Inserting += (s, e) => ThrowEvent("VwContactModuleHistory_CrtUIv2_TerrasoftInserting", e);
			Validating += (s, e) => ThrowEvent("VwContactModuleHistory_CrtUIv2_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new VwContactModuleHistory_CrtUIv2_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class VwContactModuleHistory_CrtUIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwContactModuleHistory_CrtUIv2_Terrasoft
	{
	...
	/// <exclude/>
	public class VwContactModuleHistory_CrtUIv2EventsProcess : VwContactModuleHistory_CrtUIv2EventsProcess<VwContactModuleHistory_CrtUIv2_Terrasoft>
	{

namespace Terrasoft.Configuration
{
	...
	#region Class: ContactInFolder_CrtBase_TerrasoftSchema

	/// <exclude/>
	public class ContactInFolder_CrtBase_TerrasoftSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{

		#region Constructors: Public

		public ContactInFolder_CrtBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public ContactInFolder_CrtBase_TerrasoftSchema(ContactInFolder_CrtBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public ContactInFolder_CrtBase_TerrasoftSchema(ContactInFolder_CrtBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "ContactInFolder_CrtBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new ContactInFolder_CrtBase_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new ContactInFolder_CrtBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new ContactInFolder_CrtBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: ContactInFolder_CrtBase_Terrasoft

	/// <summary>
	/// Contact in folder.
	/// </summary>
	public class ContactInFolder_CrtBase_Terrasoft : Terrasoft.Configuration.BaseItemInFolder
	{

		#region Constructors: Public

		public ContactInFolder_CrtBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "ContactInFolder_CrtBase_Terrasoft";
		}

		public ContactInFolder_CrtBase_Terrasoft(ContactInFolder_CrtBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("ContactInFolder_CrtBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("ContactInFolder_CrtBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("ContactInFolder_CrtBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("ContactInFolder_CrtBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("ContactInFolder_CrtBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("ContactInFolder_CrtBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("ContactInFolder_CrtBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new ContactInFolder_CrtBase_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class ContactInFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ContactInFolder_CrtBase_Terrasoft
	{
		...
		public override void ThrowEvent(ProcessExecutingContext context, string message) {
			switch(message) {
					case "ContactInFolder_CrtBase_TerrasoftDeleted":
	...
	/// <exclude/>
	public class ContactInFolder_CrtBaseEventsProcess : ContactInFolder_CrtBaseEventsProcess<ContactInFolder_CrtBase_Terrasoft>
	{

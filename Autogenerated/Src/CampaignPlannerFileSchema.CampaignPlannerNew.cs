namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignPlannerFile_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : CampaignPlannerFile
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailPriority_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BulkEmailPriority
	{

namespace Terrasoft.Configuration
{
	...
	public class ContactDecisionRoleSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ContactDecisionRole_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class ContactDecisionRole : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new ContactDecisionRole_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: ContactDecisionRole_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class ContactDecisionRole_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ContactDecisionRole
	{

		public ContactDecisionRole_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "ContactDecisionRole_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class ContactDecisionRole_CrtCoreBaseEventsProcess : ContactDecisionRole_CrtCoreBaseEventsProcess<ContactDecisionRole>
	{
	...
	public partial class ContactDecisionRole_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class ContactDecisionRoleEventsProcess : ContactDecisionRole_CrtCoreBaseEventsProcess
	{

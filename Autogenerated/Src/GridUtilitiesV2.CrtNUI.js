define("GridUtilitiesV2", [
	...
	"performancecountermanager", "ModuleUtils", "DefaultProfileHelper", "NetworkUtilities", "@creatio/utils",
	"MaskHelper", "BaseGridRowViewModel", "ColumnUtilities", "QueryCancellationMixin", "AngularPageUtilitiesMixin",
	...
	Ext.define("Terrasoft.configuration.mixins.GridUtilities", {
		...
		createLink: function(entitySchemaName, columnPath, displayValue, recordId) {
			...
			if (pages?.length) {
				...
				const options = {
					action: Terrasoft.ConfigurationEnums.CardOperation.EDIT,

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProductInTag_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : ProductInTag
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Account_CrtMLLeadConversion_TerrasoftSchema : Terrasoft.Configuration.Account_AddressFinance_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateCodeColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("02ea6590-09d5-47c0-9fd1-af8ff16cf814");
	...
	/// Legal entity.
	/// </summary>
	public class Account_CrtMLLeadConversion_Terrasoft : Terrasoft.Configuration.Account_AddressFinance_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Account_CrtMLLeadConversion_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Account_CrtMLLeadConversion_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Account_CrtMLLeadConversion_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Account_CrtMLLeadConversion_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Account_CrtMLLeadConversion_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Account_CrtMLLeadConversion_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Account_CrtMLLeadConversion_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Account_CrtMLLeadConversionEventsProcess<TEntity> : Terrasoft.Configuration.Account_AddressFinanceEventsProcess<TEntity> where TEntity : Account_CrtMLLeadConversion_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignScheduledMode_CrtCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CampaignScheduledMode
	{

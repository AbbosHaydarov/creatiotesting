namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VideoHelp_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : VideoHelp
	{

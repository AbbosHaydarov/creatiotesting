		...
		return {
			...
			methods: {
				...
				getGridDataColumns: function() {
					...
					defColumnsConfig.EmailDesignerType = {path: "EmailDesignerType"};
				 ...
				 */
				copyRecord: function() {
					var wizardDesignerTypeId = 'e8fff45c-1226-4c34-b26f-1e5ad88815b0';
					var activeRow = this.getActiveRow();
					var createdInDesigner = activeRow.get("EmailDesignerType");
					if (createdInDesigner?.value?.toLowerCase() === wizardDesignerTypeId || !createdInDesigner) {
						this.callParent(arguments);
						return;
					}
					Terrasoft.showInformation(resources.localizableStrings.CantCopyEmailFromNewDesignerMessage);
				}
			},
			diff: /**SCHEMA_DIFF*/[
				{

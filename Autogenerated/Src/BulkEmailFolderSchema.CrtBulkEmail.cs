namespace Terrasoft.Configuration
{
	...
	public class BulkEmailFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BulkEmailFolder_CrtBulkEmailEventsProcess(userConnection);
		}
	...
	public class BulkEmailFolder : Terrasoft.Configuration.BaseFolder
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new BulkEmailFolder_CrtBulkEmailEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: BulkEmailFolder_CrtBulkEmailEventsProcess

	/// <exclude/>
	public partial class BulkEmailFolder_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : BulkEmailFolder
	{

		public BulkEmailFolder_CrtBulkEmailEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "BulkEmailFolder_CrtBulkEmailEventsProcess";
	...
	/// <exclude/>
	public class BulkEmailFolder_CrtBulkEmailEventsProcess : BulkEmailFolder_CrtBulkEmailEventsProcess<BulkEmailFolder>
	{
	...
	public partial class BulkEmailFolder_CrtBulkEmailEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class BulkEmailFolderEventsProcess : BulkEmailFolder_CrtBulkEmailEventsProcess
	{

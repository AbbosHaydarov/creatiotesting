namespace Terrasoft.Configuration
{
	...
	#region Class: MailServer_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class MailServer_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public MailServer_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public MailServer_CrtCoreBase_TerrasoftSchema(MailServer_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public MailServer_CrtCoreBase_TerrasoftSchema(MailServer_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "MailServer_CrtCoreBase_Terrasoft";
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("a8c3835b-fcbf-11cd-0454-5fa5a8d8e399")) == null) {
				Columns.Add(CreateIsLimitModeColumn());
			}
		}
		...
		protected virtual EntitySchemaColumn CreateIsLimitModeColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Boolean")) {
				UId = new Guid("a8c3835b-fcbf-11cd-0454-5fa5a8d8e399"),
				Name = @"IsLimitMode",
				CreatedInSchemaUId = new Guid("7ba8351f-9a61-49e6-9e0d-8b32ed25c4c4"),
				ModifiedInSchemaUId = new Guid("7ba8351f-9a61-49e6-9e0d-8b32ed25c4c4"),
				CreatedInPackageId = new Guid("db0e9783-e8ca-46f3-bfb5-048c58619271")
			};
		}
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new MailServer_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new MailServer_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new MailServer_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new MailServer_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: MailServer_CrtCoreBase_Terrasoft

	/// <summary>
	/// Email provider.
	/// </summary>
	public class MailServer_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public MailServer_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "MailServer_CrtCoreBase_Terrasoft";
		}

		public MailServer_CrtCoreBase_Terrasoft(MailServer_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		/// Limit mode flag.
		/// </summary>
		public bool IsLimitMode {
			get {
				return GetTypedColumnValue<bool>("IsLimitMode");
			}
			set {
				SetColumnValue("IsLimitMode", value);
			}
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new MailServer_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("MailServer_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("MailServer_CrtCoreBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("MailServer_CrtCoreBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("MailServer_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("MailServer_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("MailServer_CrtCoreBase_TerrasoftSaving", e);
			Updated += (s, e) => ThrowEvent("MailServer_CrtCoreBase_TerrasoftUpdated", e);
			Validating += (s, e) => ThrowEvent("MailServer_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new MailServer_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: MailServer_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class MailServer_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : MailServer_CrtCoreBase_Terrasoft
	{

		public MailServer_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "MailServer_CrtCoreBaseEventsProcess";
		...
		public override void ThrowEvent(ProcessExecutingContext context, string message) {
			switch(message) {
					case "MailServer_CrtCoreBase_TerrasoftInserting":
	...
	/// <exclude/>
	public class MailServer_CrtCoreBaseEventsProcess : MailServer_CrtCoreBaseEventsProcess<MailServer_CrtCoreBase_Terrasoft>
	{

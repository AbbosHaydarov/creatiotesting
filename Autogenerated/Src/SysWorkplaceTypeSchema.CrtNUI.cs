namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysWorkplaceType_CrtNUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysWorkplaceType
	{

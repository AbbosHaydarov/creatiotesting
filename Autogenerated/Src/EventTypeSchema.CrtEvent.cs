namespace Terrasoft.Configuration
{
	...
	public class EventTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EventType_CrtEventEventsProcess(userConnection);
		}
	...
	public class EventType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new EventType_CrtEventEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: EventType_CrtEventEventsProcess

	/// <exclude/>
	public partial class EventType_CrtEventEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : EventType
	{

		public EventType_CrtEventEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "EventType_CrtEventEventsProcess";
	...
	/// <exclude/>
	public class EventType_CrtEventEventsProcess : EventType_CrtEventEventsProcess<EventType>
	{
	...
	public partial class EventType_CrtEventEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class EventTypeEventsProcess : EventType_CrtEventEventsProcess
	{

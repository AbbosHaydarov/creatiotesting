namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysSolution_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseHierarchicalLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysSolution
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CountrySchema : Terrasoft.Configuration.Country_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Country.
	/// </summary>
	public class Country : Terrasoft.Configuration.Country_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Country_SSPEventsProcess<TEntity> : Terrasoft.Configuration.Country_CrtCoreBaseEventsProcess<TEntity> where TEntity : Country
	{

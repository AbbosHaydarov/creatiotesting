namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MktgActivityFolder_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : MktgActivityFolder
	{

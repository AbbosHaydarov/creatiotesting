namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ActivityStatusSchema : Terrasoft.Configuration.ActivityStatus_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Activity status.
	/// </summary>
	public class ActivityStatus : Terrasoft.Configuration.ActivityStatus_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class ActivityStatus_CrtProductivityAppEventsProcess<TEntity> : Terrasoft.Configuration.ActivityStatus_CrtCoreBaseEventsProcess<TEntity> where TEntity : ActivityStatus
	{

namespace Terrasoft.Configuration
{
	...
	public class ServicePactTag : Terrasoft.Configuration.BaseTag
	{
		...
		protected override void InitializeThrowEvents() {
			Deleting += (s, e) => ThrowEvent("ServicePactTagDeleting", e);
			Inserted += (s, e) => ThrowEvent("ServicePactTagInserted", e);
			Inserting += (s, e) => ThrowEvent("ServicePactTagInserting", e);
			Saved += (s, e) => ThrowEvent("ServicePactTagSaved", e);
			Saving += (s, e) => ThrowEvent("ServicePactTagSaving", e);

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class StageBase_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : StageBase
	{

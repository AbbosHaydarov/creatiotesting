			...
			ServiceHelper.callService({
				...
				data: {
					request: {
						...
						includeProcessExecutionData: Terrasoft.Features.getIsEnabled("GetProcessStepsViaResponse")
					}
				},
				callback: function(response, success) {
					const executionData = response.processExecutionData;
					if (executionData) {
						Terrasoft.ProcessExecutionDataCollector.add(executionData, {});
					}
					Ext.callback(callback, scope, [response, success]);
				}
			});
		},

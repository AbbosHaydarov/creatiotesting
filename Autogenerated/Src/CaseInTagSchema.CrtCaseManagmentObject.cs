namespace Terrasoft.Configuration
{
	...
	public class CaseInTag : Terrasoft.Configuration.BaseEntityInTag
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("CaseInTagDeleting", e);
			Inserted += (s, e) => ThrowEvent("CaseInTagInserted", e);
			Inserting += (s, e) => ThrowEvent("CaseInTagInserting", e);
			Saved += (s, e) => ThrowEvent("CaseInTagSaved", e);
			Saving += (s, e) => ThrowEvent("CaseInTagSaving", e);
	...
	/// <exclude/>
	public partial class CaseInTag_CrtCaseManagmentObjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : CaseInTag
	{

		...
		return {
			...
			methods: {
				...
				_getPageSchemaListEsq: function() {
					...
					if (this._getIsAllowed8XPages()) {
						this._applyAllow8XPagesFilter(filters, pageSchemaLeftExpression);
					} else {
				 ...
				 * @private
				 */
				_applyAllow8XPagesFilter: function(filters, pageSchemaLeftExpression){
				 ...
				 * @private
				 */
				_getIsAllowed8XPages: function() {
					if(Terrasoft.Features.getIsDisabled("ProcessFeatures.Use8XPages")){
						return false;
					}
					if(Terrasoft.Features.getIsEnabled("OpenEditPageUserTask.Disallow8XPagesIn7XUI")){
						return this.get("UseNewShell");
					}
					return true;
				},

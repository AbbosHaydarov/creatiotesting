namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmployeeInFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : EmployeeInFolder
	{

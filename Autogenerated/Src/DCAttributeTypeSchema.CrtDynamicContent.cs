namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DCAttributeType_CrtDynamicContentEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : DCAttributeType
	{

namespace Terrasoft.Configuration
{
	...
	public class BaseCodeLookupSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BaseCodeLookup_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class BaseCodeLookup : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new BaseCodeLookup_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: BaseCodeLookup_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BaseCodeLookup
	{

		public BaseCodeLookup_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "BaseCodeLookup_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class BaseCodeLookup_CrtCoreBaseEventsProcess : BaseCodeLookup_CrtCoreBaseEventsProcess<BaseCodeLookup>
	{
	...
	public partial class BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class BaseCodeLookupEventsProcess : BaseCodeLookup_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebsiteEventType_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : WebsiteEventType
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContentBuilderFontSet_ContentBuilderEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ContentBuilderFontSet
	{

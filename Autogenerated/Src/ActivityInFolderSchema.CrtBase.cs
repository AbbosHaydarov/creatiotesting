namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ActivityInFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ActivityInFolder
	{

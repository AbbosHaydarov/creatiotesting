namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LookupInTag_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : LookupInTag
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Case_CrtSLM_TerrasoftSchema : Terrasoft.Configuration.Case_CrtPortal_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateNumberColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("3179e425-d87c-4c9c-a201-53e19a977f6d");
	...
	/// Case.
	/// </summary>
	public class Case_CrtSLM_Terrasoft : Terrasoft.Configuration.Case_CrtPortal_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Inserted += (s, e) => ThrowEvent("Case_CrtSLM_TerrasoftInserted", e);
			...
			Validating += (s, e) => ThrowEvent("Case_CrtSLM_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Case_CrtSLMEventsProcess<TEntity> : Terrasoft.Configuration.Case_CrtPortalEventsProcess<TEntity> where TEntity : Case_CrtSLM_Terrasoft
	{

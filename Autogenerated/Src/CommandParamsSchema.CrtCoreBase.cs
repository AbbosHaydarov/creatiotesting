namespace Terrasoft.Configuration
{
	...
	public class CommandParamsSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CommandParams_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class CommandParams : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new CommandParams_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: CommandParams_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class CommandParams_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CommandParams
	{

		public CommandParams_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "CommandParams_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class CommandParams_CrtCoreBaseEventsProcess : CommandParams_CrtCoreBaseEventsProcess<CommandParams>
	{
	...
	public partial class CommandParams_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class CommandParamsEventsProcess : CommandParams_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class EventSchema : Terrasoft.Configuration.Event_CrtEventMarketingApp_TerrasoftSchema
	{
	...
	/// Event.
	/// </summary>
	public class Event : Terrasoft.Configuration.Event_CrtEventMarketingApp_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Event_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.Event_CrtEventMarketingAppEventsProcess<TEntity> where TEntity : Event
	{

namespace Terrasoft.Configuration
{
	...
	public class MLModelTagSchema : Terrasoft.Configuration.BaseTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new MLModelTag_CrtMLEventsProcess(userConnection);
		}
	...
	public class MLModelTag : Terrasoft.Configuration.BaseTag
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new MLModelTag_CrtMLEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			...
			Inserted += (s, e) => ThrowEvent("MLModelTagInserted", e);
	...
	#region Class: MLModelTag_CrtMLEventsProcess

	/// <exclude/>
	public partial class MLModelTag_CrtMLEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_SSPEventsProcess<TEntity> where TEntity : MLModelTag
	{

		public MLModelTag_CrtMLEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "MLModelTag_CrtMLEventsProcess";
	...
	/// <exclude/>
	public class MLModelTag_CrtMLEventsProcess : MLModelTag_CrtMLEventsProcess<MLModelTag>
	{
	...
	public partial class MLModelTag_CrtMLEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class MLModelTagEventsProcess : MLModelTag_CrtMLEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	public abstract class BaseTaskQueueMessage
	{
		...
		public override string ToString() => Json.Serialize(this, true);
		...
		/// <summary>
		/// Empty implementation for the Execute method.
		/// </summary>
		/// <param name="userConnection">Instance of the <see cref="UserConnection"/>.</param>
		public virtual void Execute(UserConnection userConnection) { }

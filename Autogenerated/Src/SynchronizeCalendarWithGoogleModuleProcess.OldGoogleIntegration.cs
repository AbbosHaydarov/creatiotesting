namespace Terrasoft.Core.Process
{
	...
	public class SynchronizeCalendarWithGoogleModuleProcessSchema : Terrasoft.Core.Process.ProcessSchema
	{
		...
		protected virtual void InitializeAuthProcessParameters(IParametrizedProcessSchemaElement parametrizedElement) {
			var pageInstanceIdParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("cc9310fc-a52d-421d-bdd3-96cacb1f5cf7"),
			...
			var activeTreeGridCurrentRowIdParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("9e866ee4-de44-49d1-90b9-367d2f4a2e5f"),
				ContainerUId = new Guid("25e2ba09-5d6e-4bc4-9fdb-679621f61f72"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("3d5ca9a9-8a90-433c-8e51-fab6c0c2cc58"),
			...
			var userTokenParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("239b7352-cf79-482c-a0d4-295ac8c82c19"),
				ContainerUId = new Guid("25e2ba09-5d6e-4bc4-9fdb-679621f61f72"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("3d5ca9a9-8a90-433c-8e51-fab6c0c2cc58"),
			...
			var activeTreeGridClientIdParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("dcde3647-2a1d-40ac-8003-b235e26c5029"),
				ContainerUId = new Guid("25e2ba09-5d6e-4bc4-9fdb-679621f61f72"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("3d5ca9a9-8a90-433c-8e51-fab6c0c2cc58"),
			...
			var integrationProcessIdParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("3776deb1-2b5c-49c8-9049-6572809ac1d0"),
				ContainerUId = new Guid("25e2ba09-5d6e-4bc4-9fdb-679621f61f72"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("3d5ca9a9-8a90-433c-8e51-fab6c0c2cc58"),
			...
			var syncProcessResultParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("aef698bc-7234-4d73-8471-f36f0fa4662c"),
				ContainerUId = new Guid("25e2ba09-5d6e-4bc4-9fdb-679621f61f72"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("3d5ca9a9-8a90-433c-8e51-fab6c0c2cc58"),
			...
			var synchronizationAuthenticationErrorMessageParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("92e4b8df-036c-4367-bf77-758312f2a8f3"),
				ContainerUId = new Guid("25e2ba09-5d6e-4bc4-9fdb-679621f61f72"),
				CreatedInOwnerSchemaUId = Guid.Empty,
	...
	public class SynchronizeCalendarWithGoogleModuleProcess : Terrasoft.Core.Process.Process
	{
		...
		public ProcessToken ScriptPrepareAuthProcessToken {
			get {
				return _scriptPrepareAuthProcessToken ?? (_scriptPrepareAuthProcessToken = new ProcessToken(UserConnection) {
					...
					SchemaElementUId = new Guid("fb67f422-83f2-4879-9b9e-a3cc19a73195"),
					CreatedInSchemaUId = InternalSchemaUId,
					ExecutedEventHandler = OnExecuted,
				});
			}
		...
		protected override void InitializeMetaPathParameterValues() {
			...
			MetaPathParameterValues.Add("cc9310fc-a52d-421d-bdd3-96cacb1f5cf7", () => AuthProcess.PageInstanceId);
			MetaPathParameterValues.Add("9e866ee4-de44-49d1-90b9-367d2f4a2e5f", () => AuthProcess.ActiveTreeGridCurrentRowId);
			MetaPathParameterValues.Add("239b7352-cf79-482c-a0d4-295ac8c82c19", () => AuthProcess.UserToken);
			MetaPathParameterValues.Add("dcde3647-2a1d-40ac-8003-b235e26c5029", () => AuthProcess.ActiveTreeGridClientId);
			MetaPathParameterValues.Add("3776deb1-2b5c-49c8-9049-6572809ac1d0", () => AuthProcess.IntegrationProcessId);
			MetaPathParameterValues.Add("aef698bc-7234-4d73-8471-f36f0fa4662c", () => AuthProcess.SyncProcessResult);
			MetaPathParameterValues.Add("92e4b8df-036c-4367-bf77-758312f2a8f3", () => AuthProcess.SynchronizationAuthenticationErrorMessage);
		}

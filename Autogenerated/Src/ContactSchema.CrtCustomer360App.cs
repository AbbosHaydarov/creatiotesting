namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Contact_CrtCustomer360App_TerrasoftSchema : Terrasoft.Configuration.Contact_SSP_TerrasoftSchema
	{
	...
	/// Contact.
	/// </summary>
	public class Contact_CrtCustomer360App_Terrasoft : Terrasoft.Configuration.Contact_SSP_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Contact_CrtCustomer360App_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Contact_CrtCustomer360App_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Contact_CrtCustomer360App_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Contact_CrtCustomer360App_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Contact_CrtCustomer360App_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Contact_CrtCustomer360App_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Contact_CrtCustomer360App_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Contact_CrtCustomer360AppEventsProcess<TEntity> : Terrasoft.Configuration.Contact_SSPEventsProcess<TEntity> where TEntity : Contact_CrtCustomer360App_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CaseFolder_CrtCaseManagmentObjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : CaseFolder
	{

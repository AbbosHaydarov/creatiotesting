namespace Terrasoft.Configuration
{
		...
		IFragmentSynchronizable, ICampaignSignalEntityHandlerFactory
	{
        ...
        #region Constanst: Protected

        protected const string EntityFiltersPropertyName = "EntityFilters";
        protected const string HasEntityFiltersPropertyName = "HasEntityFilters";

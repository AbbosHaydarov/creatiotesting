namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CurrencyRateSchema : Terrasoft.Configuration.CurrencyRate_CrtBase_TerrasoftSchema
	{
	...
	/// Exchange rate.
	/// </summary>
	public class CurrencyRate : Terrasoft.Configuration.CurrencyRate_CrtBase_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Saving += (s, e) => ThrowEvent("CurrencyRateSaving", e);
			Validating += (s, e) => ThrowEvent("CurrencyRateValidating", e);
	...
	/// <exclude/>
	public partial class CurrencyRate_CrtUIv2EventsProcess<TEntity> : Terrasoft.Configuration.CurrencyRate_CrtBaseEventsProcess<TEntity> where TEntity : CurrencyRate
	{
	...
	/// <exclude/>
	public class CurrencyRate_CrtUIv2EventsProcess : CurrencyRate_CrtUIv2EventsProcess<CurrencyRate>
	{
	...
	/// <exclude/>
	public class CurrencyRateEventsProcess : CurrencyRate_CrtUIv2EventsProcess
	{

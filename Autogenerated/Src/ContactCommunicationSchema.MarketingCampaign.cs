namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ContactCommunicationSchema : Terrasoft.Configuration.ContactCommunication_CrtBulkEmailEngine_TerrasoftSchema
	{
	...
	/// </summary>
	public class ContactCommunication : Terrasoft.Configuration.ContactCommunication_CrtBulkEmailEngine_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("ContactCommunicationDeleted", e);
			Deleting += (s, e) => ThrowEvent("ContactCommunicationDeleting", e);
			Inserted += (s, e) => ThrowEvent("ContactCommunicationInserted", e);
			Inserting += (s, e) => ThrowEvent("ContactCommunicationInserting", e);
			Saved += (s, e) => ThrowEvent("ContactCommunicationSaved", e);
			Saving += (s, e) => ThrowEvent("ContactCommunicationSaving", e);
	...
	/// <exclude/>
	public partial class ContactCommunication_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.ContactCommunication_CrtBulkEmailEngineEventsProcess<TEntity> where TEntity : ContactCommunication
	{

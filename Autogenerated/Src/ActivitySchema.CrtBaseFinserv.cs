namespace Terrasoft.Configuration
{
	...
	#region Class: Activity_CrtBaseFinserv_TerrasoftSchema

	/// <exclude/>
	public class Activity_CrtBaseFinserv_TerrasoftSchema : Terrasoft.Configuration.Activity_OmnichannelMessaging_TerrasoftSchema
	{

		#region Constructors: Public

		public Activity_CrtBaseFinserv_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Activity_CrtBaseFinserv_TerrasoftSchema(Activity_CrtBaseFinserv_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Activity_CrtBaseFinserv_TerrasoftSchema(Activity_CrtBaseFinserv_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			RealUId = new Guid("f14f331a-2e10-467b-a9e6-a26a990f6a9b");
			Name = "Activity_CrtBaseFinserv_Terrasoft";
			ParentSchemaUId = new Guid("c449d832-a4cc-4b01-b9d5-8a12c42a9f89");
			ExtendParent = true;
			CreatedInPackageId = new Guid("57257a35-c8f0-49fe-97ff-e0b62707cd5e");
			IsDBView = false;
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Activity_CrtBaseFinserv_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Activity_CrtBaseFinservEventsProcess(userConnection);
		}

		public override object Clone() {
			return new Activity_CrtBaseFinserv_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Activity_CrtBaseFinserv_TerrasoftSchema(this, true);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("f14f331a-2e10-467b-a9e6-a26a990f6a9b"));
		}
	...
	#region Class: Activity_CrtBaseFinserv_Terrasoft

	/// <summary>
	/// Activity.
	/// </summary>
	public class Activity_CrtBaseFinserv_Terrasoft : Terrasoft.Configuration.Activity_OmnichannelMessaging_Terrasoft
	{

		#region Constructors: Public

		public Activity_CrtBaseFinserv_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Activity_CrtBaseFinserv_Terrasoft";
		}

		public Activity_CrtBaseFinserv_Terrasoft(Activity_CrtBaseFinserv_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Activity_CrtBaseFinservEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		public override object Clone() {
			return new Activity_CrtBaseFinserv_Terrasoft(this);
		}
	...
	#region Class: Activity_CrtBaseFinservEventsProcess

	/// <exclude/>
	public partial class Activity_CrtBaseFinservEventsProcess<TEntity> : Terrasoft.Configuration.Activity_OmnichannelMessagingEventsProcess<TEntity> where TEntity : Activity_CrtBaseFinserv_Terrasoft
	{

		public Activity_CrtBaseFinservEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Activity_CrtBaseFinservEventsProcess";
		...
		private Guid InternalSchemaUId {
			get {
				return new Guid("f14f331a-2e10-467b-a9e6-a26a990f6a9b");
			}
		}
	...
	/// <exclude/>
	public class Activity_CrtBaseFinservEventsProcess : Activity_CrtBaseFinservEventsProcess<Activity_CrtBaseFinserv_Terrasoft>
	{
	...
	public partial class Activity_CrtBaseFinservEventsProcess<TEntity>
	{

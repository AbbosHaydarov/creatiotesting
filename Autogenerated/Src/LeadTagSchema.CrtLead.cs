namespace Terrasoft.Configuration
{
	...
	public class LeadTag_CrtLead_Terrasoft : Terrasoft.Configuration.BaseTag
	{
		...
		protected override void InitializeThrowEvents() {
			Deleting += (s, e) => ThrowEvent("LeadTag_CrtLead_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("LeadTag_CrtLead_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("LeadTag_CrtLead_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("LeadTag_CrtLead_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("LeadTag_CrtLead_TerrasoftSaving", e);

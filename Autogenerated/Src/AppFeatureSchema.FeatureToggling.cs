namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AppFeature_FeatureTogglingEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : AppFeature
	{

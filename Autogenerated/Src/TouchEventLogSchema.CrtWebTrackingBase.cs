namespace Terrasoft.Configuration
{
	...
	public class TouchEventLogSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override EntitySchemaColumn CreateDescriptionColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("3c867b56-1c4b-4b9c-9cb7-ed072edd0992");
			return column;
		}
	...
	/// <exclude/>
	public partial class TouchEventLog_CrtWebTrackingBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : TouchEventLog
	{

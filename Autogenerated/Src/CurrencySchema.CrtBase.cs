namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Currency_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : Currency_CrtBase_Terrasoft
	{

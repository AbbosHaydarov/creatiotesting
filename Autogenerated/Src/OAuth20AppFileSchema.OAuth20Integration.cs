namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OAuth20AppFile_OAuth20IntegrationEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : OAuth20AppFile
	{

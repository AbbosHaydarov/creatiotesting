namespace Terrasoft.Configuration
{
	...
	#region Class: Account_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class Account_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public Account_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Account_CrtCoreBase_TerrasoftSchema(Account_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Account_CrtCoreBase_TerrasoftSchema(Account_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "Account_CrtCoreBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Account_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Account_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new Account_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Account_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: Account_CrtCoreBase_Terrasoft

	/// <summary>
	/// Account.
	/// </summary>
	public class Account_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public Account_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Account_CrtCoreBase_Terrasoft";
		}

		public Account_CrtCoreBase_Terrasoft(Account_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Account_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Account_CrtCoreBase_TerrasoftDeleted", e);
			Inserting += (s, e) => ThrowEvent("Account_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Account_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Account_CrtCoreBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Account_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new Account_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: Account_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class Account_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Account_CrtCoreBase_Terrasoft
	{
		...
		public class GenerateNumberUserTaskFlowElement : GenerateSequenseNumberUserTask
		{
			...
			public GenerateNumberUserTaskFlowElement(UserConnection userConnection, Account_CrtCoreBaseEventsProcess<TEntity> process)
				: base(userConnection) {
				UId = Guid.NewGuid();
				Owner = process;
		...
		public Account_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Account_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class Account_CrtCoreBaseEventsProcess : Account_CrtCoreBaseEventsProcess<Account_CrtCoreBase_Terrasoft>
	{

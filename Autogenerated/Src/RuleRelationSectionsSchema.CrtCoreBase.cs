namespace Terrasoft.Configuration
{
	...
	public class RuleRelationSectionsSchema : Terrasoft.Configuration.LookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new RuleRelationSections_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class RuleRelationSections : Terrasoft.Configuration.Lookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new RuleRelationSections_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("RuleRelationSectionsDeleting", e);
			Inserted += (s, e) => ThrowEvent("RuleRelationSectionsInserted", e);
			Inserting += (s, e) => ThrowEvent("RuleRelationSectionsInserting", e);
			Saved += (s, e) => ThrowEvent("RuleRelationSectionsSaved", e);
			Saving += (s, e) => ThrowEvent("RuleRelationSectionsSaving", e);
	...
	#region Class: RuleRelationSections_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class RuleRelationSections_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : RuleRelationSections
	{

		public RuleRelationSections_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "RuleRelationSections_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class RuleRelationSections_CrtCoreBaseEventsProcess : RuleRelationSections_CrtCoreBaseEventsProcess<RuleRelationSections>
	{
	...
	public partial class RuleRelationSections_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class RuleRelationSectionsEventsProcess : RuleRelationSections_CrtCoreBaseEventsProcess
	{

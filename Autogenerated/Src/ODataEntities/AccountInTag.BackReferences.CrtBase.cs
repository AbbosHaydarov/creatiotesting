namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AccountInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public AccountInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AccountInTag";
		...
		public AccountTag Tag {
			get {
				return _tag ??
					(_tag = new AccountTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Account Entity {
			get {
				return _entity ??
					(_entity = new Account(LookupColumnEntities.GetEntity("Entity")));
			}
		}

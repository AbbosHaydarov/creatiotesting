namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ContactInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public ContactInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ContactInTag";
		...
		public ContactTag Tag {
			get {
				return _tag ??
					(_tag = new ContactTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Contact Entity {
			get {
				return _entity ??
					(_entity = new Contact(LookupColumnEntities.GetEntity("Entity")));
			}
		}

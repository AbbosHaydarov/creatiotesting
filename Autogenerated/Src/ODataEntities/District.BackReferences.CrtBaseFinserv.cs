namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class District : Terrasoft.Core.Entities.Entity
	{
		...
		public District(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "District";
		...
		public IEnumerable<Account> AccountCollectionByDistrict {
			get;
			set;
		}

		public IEnumerable<AccountAddress> AccountAddressCollectionByDistrict {
			get;
			set;
		}

		public IEnumerable<AppFormAddress> AppFormAddressCollectionByDistrict {
			get;
			set;
		}

		public IEnumerable<City> CityCollectionByDistrict {
			get;
			set;
		}

		public IEnumerable<Contact> ContactCollectionByDistrict {
			get;
			set;
		}

		public IEnumerable<ContactAddress> ContactAddressCollectionByDistrict {
			get;
			set;
		}

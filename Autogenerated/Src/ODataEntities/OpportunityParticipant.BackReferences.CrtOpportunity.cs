namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OpportunityParticipant : Terrasoft.Core.Entities.Entity
	{
		...
		public OpportunityParticipant(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OpportunityParticipant";
		...
		public OpportunityParticipantRole Role {
			get {
				return _role ??
					(_role = new OpportunityParticipantRole(LookupColumnEntities.GetEntity("Role")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	public class FileType : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<AppFormFile> AppFormFileCollectionByType {
			get;
			set;
		}

		public IEnumerable<AppValidationItemFile> AppValidationItemFileCollectionByType {
			get;
			set;
		}

		public IEnumerable<BankAccountFile> BankAccountFileCollectionByType {
			get;
			set;
		}

		public IEnumerable<BankCardFile> BankCardFileCollectionByType {
			get;
			set;
		}
		...
		public IEnumerable<DocListInFinAppFile> DocListInFinAppFileCollectionByType {
			get;
			set;
		}
		...
		public IEnumerable<FinApplicationFile> FinApplicationFileCollectionByType {
			get;
			set;
		}
		...
		public IEnumerable<RegDocumentFile> RegDocumentFileCollectionByType {
			get;
			set;
		}

		public IEnumerable<SamlIdpCertificate> SamlIdpCertificateCollectionByType {
			get;
			set;
		}

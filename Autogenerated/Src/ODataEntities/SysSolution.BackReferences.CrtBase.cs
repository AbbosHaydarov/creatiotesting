namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysSolution : Terrasoft.Core.Entities.Entity
	{
		...
		public SysSolution(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysSolution";
		...
		public SysSolution Parent {
			get {
				return _parent ??
					(_parent = new SysSolution(LookupColumnEntities.GetEntity("Parent")));
			}
		}

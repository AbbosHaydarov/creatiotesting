namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysModuleEditLczOld : Terrasoft.Core.Entities.Entity
	{
		...
		public SysModuleEditLczOld(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysModuleEditLczOld";
		...
		/// <exclude/>
		public string RecordPageCaption {
			get {
				return GetTypedColumnValue<string>("RecordPageCaption");
			}
			set {
				SetColumnValue("RecordPageCaption", value);
				if (_record != null) {
					_record.PageCaption = value;
				}
			}
		}

		private SysModuleEdit _record;
		/// <summary>
		/// Record Id.
		/// </summary>
		public SysModuleEdit Record {
			get {
				return _record ??
					(_record = new SysModuleEdit(LookupColumnEntities.GetEntity("Record")));
			}
		}

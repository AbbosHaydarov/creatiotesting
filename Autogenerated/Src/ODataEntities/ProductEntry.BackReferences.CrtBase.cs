namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProductEntry : Terrasoft.Core.Entities.Entity
	{
		...
		public ProductEntry(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProductEntry";
		...
		public Product CrossSalesOferring {
			get {
				return _crossSalesOferring ??
					(_crossSalesOferring = new Product(LookupColumnEntities.GetEntity("CrossSalesOferring")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ConsultationThemeBlock : Terrasoft.Core.Entities.Entity
	{
		...
		public ConsultationThemeBlock(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ConsultationThemeBlock";
		...
		public IEnumerable<ConsultationTheme> ConsultationThemeCollectionByBlock {
			get;
			set;
		}

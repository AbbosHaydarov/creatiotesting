namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysProcessIntermediateEvent : Terrasoft.Core.Entities.Entity
	{
		...
		public SysProcessIntermediateEvent(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysProcessIntermediateEvent";
		...
		public SysProcessElementData SysProcessElement {
			get {
				return _sysProcessElement ??
					(_sysProcessElement = new SysProcessElementData(LookupColumnEntities.GetEntity("SysProcessElement")));
			}
		}

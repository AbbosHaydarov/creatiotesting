namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwProcessLibInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public VwProcessLibInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwProcessLibInFolder";
		...
		private VwProcessLibFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public VwProcessLibFolder Folder {
			get {
				return _folder ??
					(_folder = new VwProcessLibFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysTranslationInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysTranslationInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysTranslationInFolder";
		...
		private SysTranslationFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public SysTranslationFolder Folder {
			get {
				return _folder ??
					(_folder = new SysTranslationFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}
		...
		public SysTranslation SysTranslation {
			get {
				return _sysTranslation ??
					(_sysTranslation = new SysTranslation(LookupColumnEntities.GetEntity("SysTranslation")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class MessagePublisherBySection : Terrasoft.Core.Entities.Entity
	{
		...
		public MessagePublisherBySection(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "MessagePublisherBySection";
		...
		public MessagePublisher MessagePublisher {
			get {
				return _messagePublisher ??
					(_messagePublisher = new MessagePublisher(LookupColumnEntities.GetEntity("MessagePublisher")));
			}
		}

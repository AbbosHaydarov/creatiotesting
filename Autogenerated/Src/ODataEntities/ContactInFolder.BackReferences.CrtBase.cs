namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ContactInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ContactInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ContactInFolder";
		...
		private ContactFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public ContactFolder Folder {
			get {
				return _folder ??
					(_folder = new ContactFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OpportunityFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public OpportunityFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OpportunityFolder";
		...
		public OpportunityFolder Parent {
			get {
				return _parent ??
					(_parent = new OpportunityFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

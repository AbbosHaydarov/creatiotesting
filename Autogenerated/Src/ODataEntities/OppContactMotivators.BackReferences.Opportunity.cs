namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OppContactMotivators : Terrasoft.Core.Entities.Entity
	{
		...
		public OppContactMotivators(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OppContactMotivators";
		...
		public OppContactMotivatType Type {
			get {
				return _type ??
					(_type = new OppContactMotivatType(LookupColumnEntities.GetEntity("Type")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwSysProcessFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public VwSysProcessFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwSysProcessFolder";
		...
		public VwSysProcessFolder Parent {
			get {
				return _parent ??
					(_parent = new VwSysProcessFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

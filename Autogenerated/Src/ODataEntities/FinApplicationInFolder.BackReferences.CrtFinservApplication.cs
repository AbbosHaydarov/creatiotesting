namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class FinApplicationInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public FinApplicationInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "FinApplicationInFolder";
		...
		private FinApplicationFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public FinApplicationFolder Folder {
			get {
				return _folder ??
					(_folder = new FinApplicationFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

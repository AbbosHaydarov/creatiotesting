namespace Terrasoft.Configuration.OData
{
	...
	public class SysImage : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<AppForm> AppFormCollectionByPhoto {
			get;
			set;
		}
		...
		public IEnumerable<FinApplication> FinApplicationCollectionByPhoto {
			get;
			set;
		}
		...
		public IEnumerable<ServiceLevel> ServiceLevelCollectionByImage {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysAdminUnitFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysAdminUnitFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysAdminUnitFolder";
		...
		public SysAdminUnitFolder Parent {
			get {
				return _parent ??
					(_parent = new SysAdminUnitFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

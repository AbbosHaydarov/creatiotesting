namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class StoredReportResources : Terrasoft.Core.Entities.Entity
	{
		...
		public StoredReportResources(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "StoredReportResources";
		...
		public StoredReport DevExpressReport {
			get {
				return _devExpressReport ??
					(_devExpressReport = new StoredReport(LookupColumnEntities.GetEntity("DevExpressReport")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OperatorState : Terrasoft.Core.Entities.Entity
	{
		...
		public OperatorState(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OperatorState";
		...
		public IEnumerable<OperatorSession> OperatorSessionCollectionByOperatorState {
			get;
			set;
		}

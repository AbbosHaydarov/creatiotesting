namespace Terrasoft.Configuration.OData
{
	...
	public class SysModuleReport : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<DocListInCondition> DocListInConditionCollectionBySysModuleReport {
			get;
			set;
		}

		public IEnumerable<DocListInFinApp> DocListInFinAppCollectionBySysModuleReport {
			get;
			set;
		}

		public IEnumerable<DocumentList> DocumentListCollectionBySysModuleReport {
			get;
			set;
		}

		public IEnumerable<DocumentListInProduct> DocumentListInProductCollectionBySysModuleReport {
			get;
			set;
		}
		...
		/// <exclude/>
		public string SysEntitySchemaTitle {
			get {
				return GetTypedColumnValue<string>("SysEntitySchemaTitle");
			}
			set {
				SetColumnValue("SysEntitySchemaTitle", value);
				if (_sysEntitySchema != null) {
					_sysEntitySchema.Title = value;
				}
			}
		}

		private VwEntityObjects _sysEntitySchema;
		/// <summary>
		/// Object.
		/// </summary>
		public VwEntityObjects SysEntitySchema {
			get {
				return _sysEntitySchema ??
					(_sysEntitySchema = new VwEntityObjects(LookupColumnEntities.GetEntity("SysEntitySchema")));
			}
		}

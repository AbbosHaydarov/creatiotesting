namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class GeneratedWebFormFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public GeneratedWebFormFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "GeneratedWebFormFolder";
		...
		public GeneratedWebFormFolder Parent {
			get {
				return _parent ??
					(_parent = new GeneratedWebFormFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class MeetingTranscript : Terrasoft.Core.Entities.Entity
	{
		...
		public MeetingTranscript(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "MeetingTranscript";
		...
		public IEnumerable<Activity> ActivityCollectionByMeetingTranscript {
			get;
			set;
		}

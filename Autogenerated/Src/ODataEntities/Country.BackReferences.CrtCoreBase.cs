namespace Terrasoft.Configuration.OData
{
	...
	public class Country : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<AppForm> AppFormCollectionByCitizenship {
			get;
			set;
		}

		public IEnumerable<AppFormAddress> AppFormAddressCollectionByCountry {
			get;
			set;
		}
		...
		public IEnumerable<Contact> ContactCollectionByCitizenship {
			get;
			set;
		}
		...
		public IEnumerable<District> DistrictCollectionByCountry {
			get;
			set;
		}
		...
		public IEnumerable<RegDocument> RegDocumentCollectionByCitizenship {
			get;
			set;
		}

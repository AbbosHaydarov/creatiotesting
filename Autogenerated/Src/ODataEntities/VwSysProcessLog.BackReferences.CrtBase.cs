namespace Terrasoft.Configuration.OData
{
	...
	public class VwSysProcessLog : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<VwSysProcessLog> VwSysProcessLogCollectionByRoot {
			get;
			set;
		}

		public IEnumerable<VwSysProcessMILog> VwSysProcessMILogCollectionByRoot {
			get;
			set;
		}
		...
		private VwSysProcessLog _root;
		/// <summary>
		/// Root process.
		/// </summary>
		public VwSysProcessLog Root {
			get {
				return _root ??
					(_root = new VwSysProcessLog(LookupColumnEntities.GetEntity("Root")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class EntryPoint : Terrasoft.Core.Entities.Entity
	{
		...
		public EntryPoint(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "EntryPoint";
		...
		public SysProcessElementData SysProcessElementData {
			get {
				return _sysProcessElementData ??
					(_sysProcessElementData = new SysProcessElementData(LookupColumnEntities.GetEntity("SysProcessElementData")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ForecastRow : Terrasoft.Core.Entities.Entity
	{
		...
		public ForecastRow(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ForecastRow";
		...
		public IEnumerable<ForecastHistoryCell> ForecastHistoryCellCollectionByRow {
			get;
			set;
		}

		public IEnumerable<ForecastHistoryRow> ForecastHistoryRowCollectionByRow {
			get;
			set;
		}

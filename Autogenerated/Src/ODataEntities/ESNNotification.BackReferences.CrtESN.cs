namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ESNNotification : Terrasoft.Core.Entities.Entity
	{
		...
		public ESNNotification(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ESNNotification";
		...
		public ESNNotificationType Type {
			get {
				return _type ??
					(_type = new ESNNotificationType(LookupColumnEntities.GetEntity("Type")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class PeriodType : Terrasoft.Core.Entities.Entity
	{
		...
		public PeriodType(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "PeriodType";
		...
		public IEnumerable<FinIndicator> FinIndicatorCollectionByPeriodType {
			get;
			set;
		}

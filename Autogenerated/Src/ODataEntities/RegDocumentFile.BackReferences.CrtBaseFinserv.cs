namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class RegDocumentFile : Terrasoft.Core.Entities.Entity
	{
		...
		public RegDocumentFile(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "RegDocumentFile";
		...
		public RegDocument RegDocument {
			get {
				return _regDocument ??
					(_regDocument = new RegDocument(LookupColumnEntities.GetEntity("RegDocument")));
			}
		}

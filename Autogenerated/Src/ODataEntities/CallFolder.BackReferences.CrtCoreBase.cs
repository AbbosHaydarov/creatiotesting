namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CallFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public CallFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CallFolder";
		...
		public CallFolder Parent {
			get {
				return _parent ??
					(_parent = new CallFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

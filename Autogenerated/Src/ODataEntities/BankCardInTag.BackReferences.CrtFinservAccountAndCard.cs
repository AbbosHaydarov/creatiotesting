namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BankCardInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public BankCardInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BankCardInTag";
		...
		private BankCardTag _tag;
		/// <summary>
		/// Tag.
		/// </summary>
		public BankCardTag Tag {
			get {
				return _tag ??
					(_tag = new BankCardTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		private BankCard _entity;
		/// <summary>
		/// Object.
		/// </summary>
		public BankCard Entity {
			get {
				return _entity ??
					(_entity = new BankCard(LookupColumnEntities.GetEntity("Entity")));
			}
		}

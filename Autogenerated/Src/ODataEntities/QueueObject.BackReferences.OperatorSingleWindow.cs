namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class QueueObject : Terrasoft.Core.Entities.Entity
	{
		...
		public QueueObject(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "QueueObject";
		...
		public IEnumerable<QueueObjectColumn> QueueObjectColumnCollectionByQueueObject {
			get;
			set;
		}

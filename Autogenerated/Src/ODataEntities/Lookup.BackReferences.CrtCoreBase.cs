namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class Lookup : Terrasoft.Core.Entities.Entity
	{
		...
		public Lookup(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "Lookup";
		...
		public IEnumerable<Specification> SpecificationCollectionByLookup {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CaseOrigin : Terrasoft.Core.Entities.Entity
	{
		...
		public CaseOrigin(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CaseOrigin";
		...
		public IEnumerable<Case> CaseCollectionByOrigin {
			get;
			set;
		}

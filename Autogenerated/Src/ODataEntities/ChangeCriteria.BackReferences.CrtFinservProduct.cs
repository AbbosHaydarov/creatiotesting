namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ChangeCriteria : Terrasoft.Core.Entities.Entity
	{
		...
		public ChangeCriteria(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ChangeCriteria";
		...
		public IEnumerable<ChangeCriteriaInCondition> ChangeCriteriaInConditionCollectionByChangeCriteria {
			get;
			set;
		}

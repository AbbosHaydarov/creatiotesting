namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LeadGenCampaignGroups : Terrasoft.Core.Entities.Entity
	{
		...
		public LeadGenCampaignGroups(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LeadGenCampaignGroups";
		...
		public IEnumerable<LeadGenExtendedLeadInformation> LeadGenExtendedLeadInformationCollectionByLeadGenCampaignGroups {
			get;
			set;
		}

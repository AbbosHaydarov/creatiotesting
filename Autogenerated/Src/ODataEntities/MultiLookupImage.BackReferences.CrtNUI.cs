namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class MultiLookupImage : Terrasoft.Core.Entities.Entity
	{
		...
		public MultiLookupImage(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "MultiLookupImage";
		...
		public SysImage LookupImage {
			get {
				return _lookupImage ??
					(_lookupImage = new SysImage(LookupColumnEntities.GetEntity("LookupImage")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OppDepartmentForecast : Terrasoft.Core.Entities.Entity
	{
		...
		public OppDepartmentForecast(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OppDepartmentForecast";
		...
		public ForecastColumn ForecastColumn {
			get {
				return _forecastColumn ??
					(_forecastColumn = new ForecastColumn(LookupColumnEntities.GetEntity("ForecastColumn")));
			}
		}

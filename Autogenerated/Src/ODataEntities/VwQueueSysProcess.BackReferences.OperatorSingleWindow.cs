namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwQueueSysProcess : Terrasoft.Core.Entities.Entity
	{
		...
		public VwQueueSysProcess(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwQueueSysProcess";
		...
		public IEnumerable<Queue> QueueCollectionByBusinessProcessSchema {
			get;
			set;
		}

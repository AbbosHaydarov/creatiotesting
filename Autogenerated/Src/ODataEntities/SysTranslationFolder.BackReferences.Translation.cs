namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysTranslationFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysTranslationFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysTranslationFolder";
		...
		public SysTranslationFolder Parent {
			get {
				return _parent ??
					(_parent = new SysTranslationFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

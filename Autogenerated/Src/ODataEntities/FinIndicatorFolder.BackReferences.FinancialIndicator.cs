namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class FinIndicatorFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public FinIndicatorFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "FinIndicatorFolder";
		...
		public IEnumerable<FinIndicatorFolder> FinIndicatorFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<FinIndicatorInFolder> FinIndicatorInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public FinIndicatorFolder Parent {
			get {
				return _parent ??
					(_parent = new FinIndicatorFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

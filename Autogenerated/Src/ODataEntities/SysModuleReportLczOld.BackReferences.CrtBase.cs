namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysModuleReportLczOld : Terrasoft.Core.Entities.Entity
	{
		...
		public SysModuleReportLczOld(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysModuleReportLczOld";
		...
		private SysModuleReport _record;
		/// <summary>
		/// Record Id.
		/// </summary>
		public SysModuleReport Record {
			get {
				return _record ??
					(_record = new SysModuleReport(LookupColumnEntities.GetEntity("Record")));
			}
		}

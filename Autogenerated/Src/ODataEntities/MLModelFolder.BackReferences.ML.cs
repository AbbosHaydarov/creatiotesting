namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class MLModelFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public MLModelFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "MLModelFolder";
		...
		public MLModelFolder Parent {
			get {
				return _parent ??
					(_parent = new MLModelFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

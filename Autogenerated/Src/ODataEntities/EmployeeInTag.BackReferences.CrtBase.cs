namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class EmployeeInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public EmployeeInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "EmployeeInTag";
		...
		private EmployeeTag _tag;
		/// <summary>
		/// Tag.
		/// </summary>
		public EmployeeTag Tag {
			get {
				return _tag ??
					(_tag = new EmployeeTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Employee Entity {
			get {
				return _entity ??
					(_entity = new Employee(LookupColumnEntities.GetEntity("Entity")));
			}
		}

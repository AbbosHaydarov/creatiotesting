namespace Terrasoft.Configuration.OData
{
	...
	public class Case : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<CaseConsultationTheme> CaseConsultationThemeCollectionByCase {
			get;
			set;
		}
		...
		public IEnumerable<CaseHistory> CaseHistoryCollectionByCase {
			get;
			set;
		}
		...
		public IEnumerable<FinApplication> FinApplicationCollectionByCase {
			get;
			set;
		}

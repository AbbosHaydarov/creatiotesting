namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SocialChannelFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SocialChannelFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SocialChannelFolder";
		...
		public SocialChannelFolder Parent {
			get {
				return _parent ??
					(_parent = new SocialChannelFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

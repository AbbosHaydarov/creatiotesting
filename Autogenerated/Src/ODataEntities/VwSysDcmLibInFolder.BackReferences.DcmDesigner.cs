namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwSysDcmLibInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public VwSysDcmLibInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwSysDcmLibInFolder";
		...
		private VwSysDcmLibFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public VwSysDcmLibFolder Folder {
			get {
				return _folder ??
					(_folder = new VwSysDcmLibFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

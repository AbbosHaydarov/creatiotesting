namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LeadGenLeadForms : Terrasoft.Core.Entities.Entity
	{
		...
		public LeadGenLeadForms(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LeadGenLeadForms";
		...
		public IEnumerable<LeadGenExtendedLeadInformation> LeadGenExtendedLeadInformationCollectionByLeadGenLeadForms {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OAuth20AppFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public OAuth20AppFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OAuth20AppFolder";
		...
		public OAuth20AppFolder Parent {
			get {
				return _parent ??
					(_parent = new OAuth20AppFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwSysProcessInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public VwSysProcessInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwSysProcessInFolder";
		...
		private VwSysProcessFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public VwSysProcessFolder Folder {
			get {
				return _folder ??
					(_folder = new VwSysProcessFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

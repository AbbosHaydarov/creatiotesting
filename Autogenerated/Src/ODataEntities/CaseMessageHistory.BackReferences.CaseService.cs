namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CaseMessageHistory : Terrasoft.Core.Entities.Entity
	{
		...
		public CaseMessageHistory(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CaseMessageHistory";
		...
		public IEnumerable<PortalEmailMessage> PortalEmailMessageCollectionByCaseMessageHistory {
			get;
			set;
		}

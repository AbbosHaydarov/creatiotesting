namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysSettingsFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysSettingsFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysSettingsFolder";
		...
		public SysSettingsFolder Parent {
			get {
				return _parent ??
					(_parent = new SysSettingsFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

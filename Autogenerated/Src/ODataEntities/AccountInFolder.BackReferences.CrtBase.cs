namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AccountInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public AccountInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AccountInFolder";
		...
		private AccountFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public AccountFolder Folder {
			get {
				return _folder ??
					(_folder = new AccountFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwSysProcess : Terrasoft.Core.Entities.Entity
	{
		...
		public VwSysProcess(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwSysProcess";
		...
		public IEnumerable<ConsultationTheme> ConsultationThemeCollectionByProcessSchema {
			get;
			set;
		}

		public IEnumerable<CTIProcessAction> CTIProcessActionCollectionByProcessSchema {
			get;
			set;
		}

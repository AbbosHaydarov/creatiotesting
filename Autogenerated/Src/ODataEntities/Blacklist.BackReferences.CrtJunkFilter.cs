namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class Blacklist : Terrasoft.Core.Entities.Entity
	{
		...
		public Blacklist(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "Blacklist";
		...
		public JunkFilterTypeOfField TypeOfField {
			get {
				return _typeOfField ??
					(_typeOfField = new JunkFilterTypeOfField(LookupColumnEntities.GetEntity("TypeOfField")));
			}
		}

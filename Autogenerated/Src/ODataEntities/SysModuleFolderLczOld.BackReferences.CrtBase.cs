namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysModuleFolderLczOld : Terrasoft.Core.Entities.Entity
	{
		...
		public SysModuleFolderLczOld(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysModuleFolderLczOld";
		...
		private SysModuleFolder _record;
		/// <summary>
		/// Record Id.
		/// </summary>
		public SysModuleFolder Record {
			get {
				return _record ??
					(_record = new SysModuleFolder(LookupColumnEntities.GetEntity("Record")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class MLModelInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public MLModelInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "MLModelInFolder";
		...
		private MLModelFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public MLModelFolder Folder {
			get {
				return _folder ??
					(_folder = new MLModelFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

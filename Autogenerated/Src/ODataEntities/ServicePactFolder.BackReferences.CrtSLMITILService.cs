namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ServicePactFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ServicePactFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ServicePactFolder";
		...
		public IEnumerable<ServicePactFolder> ServicePactFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<ServicePactInFolder> ServicePactInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public ServicePactFolder Parent {
			get {
				return _parent ??
					(_parent = new ServicePactFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ServiceItemFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ServiceItemFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ServiceItemFolder";
		...
		public IEnumerable<ServiceItemFolder> ServiceItemFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<ServiceItemInFolder> ServiceItemInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public ServiceItemFolder Parent {
			get {
				return _parent ??
					(_parent = new ServiceItemFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

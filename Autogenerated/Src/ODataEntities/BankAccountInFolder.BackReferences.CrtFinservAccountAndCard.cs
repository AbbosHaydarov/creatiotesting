namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BankAccountInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public BankAccountInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BankAccountInFolder";
		...
		private BankAccountFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public BankAccountFolder Folder {
			get {
				return _folder ??
					(_folder = new BankAccountFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

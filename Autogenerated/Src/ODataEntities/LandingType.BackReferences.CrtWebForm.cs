namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LandingType : Terrasoft.Core.Entities.Entity
	{
		...
		public LandingType(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LandingType";
		...
		public IEnumerable<VwLandingInCampaign> VwLandingInCampaignCollectionByType {
			get;
			set;
		}
		...
		public VwSysSchemaInfo SchemaUid {
			get {
				return _schemaUid ??
					(_schemaUid = new VwSysSchemaInfo(LookupColumnEntities.GetEntity("SchemaUid")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class DocListInFinAppFile : Terrasoft.Core.Entities.Entity
	{
		...
		public DocListInFinAppFile(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "DocListInFinAppFile";
		...
		public DocListInFinApp DocListInFinApp {
			get {
				return _docListInFinApp ??
					(_docListInFinApp = new DocListInFinApp(LookupColumnEntities.GetEntity("DocListInFinApp")));
			}
		}

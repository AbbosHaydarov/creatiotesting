namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SsoIdentityType : Terrasoft.Core.Entities.Entity
	{
		...
		public SsoIdentityType(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SsoIdentityType";
		...
		public IEnumerable<SsoIdentityProvider> SsoIdentityProviderCollectionByType {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LeadGenAdSets : Terrasoft.Core.Entities.Entity
	{
		...
		public LeadGenAdSets(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LeadGenAdSets";
		...
		public IEnumerable<LeadGenExtendedLeadInformation> LeadGenExtendedLeadInformationCollectionByLeadGenAdSets {
			get;
			set;
		}

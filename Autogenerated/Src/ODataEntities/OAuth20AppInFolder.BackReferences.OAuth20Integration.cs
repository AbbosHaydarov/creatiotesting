namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OAuth20AppInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public OAuth20AppInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OAuth20AppInFolder";
		...
		private OAuth20AppFolder _folder;
		/// <summary>
		/// OAuth 2.0 application group.
		/// </summary>
		public OAuth20AppFolder Folder {
			get {
				return _folder ??
					(_folder = new OAuth20AppFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SpecInherited : Terrasoft.Core.Entities.Entity
	{
		...
		public SpecInherited(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SpecInherited";
		...
		public SpecTableInherited SpecTableInheritedX {
			get {
				return _specTableInheritedX ??
					(_specTableInheritedX = new SpecTableInherited(LookupColumnEntities.GetEntity("SpecTableInheritedX")));
			}
		}
		...
		public SpecTableInherited SpecTableInheritedY {
			get {
				return _specTableInheritedY ??
					(_specTableInheritedY = new SpecTableInherited(LookupColumnEntities.GetEntity("SpecTableInheritedY")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProcessInDetails : Terrasoft.Core.Entities.Entity
	{
		...
		public ProcessInDetails(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProcessInDetails";
		...
		public SysDetail SysDetail {
			get {
				return _sysDetail ??
					(_sysDetail = new SysDetail(LookupColumnEntities.GetEntity("SysDetail")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ActivityFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ActivityFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ActivityFolder";
		...
		public ActivityFolder Parent {
			get {
				return _parent ??
					(_parent = new ActivityFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

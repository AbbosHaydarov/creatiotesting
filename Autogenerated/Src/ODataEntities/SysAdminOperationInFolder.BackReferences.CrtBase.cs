namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysAdminOperationInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysAdminOperationInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysAdminOperationInFolder";
		...
		private SysAdminOperationFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public SysAdminOperationFolder Folder {
			get {
				return _folder ??
					(_folder = new SysAdminOperationFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

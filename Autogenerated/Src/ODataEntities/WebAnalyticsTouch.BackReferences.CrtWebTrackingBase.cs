namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class WebAnalyticsTouch : Terrasoft.Core.Entities.Entity
	{
		...
		public WebAnalyticsTouch(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "WebAnalyticsTouch";
		...
		public WebAnalyticsVisitor WebAnalyticsVisitor {
			get {
				return _webAnalyticsVisitor ??
					(_webAnalyticsVisitor = new WebAnalyticsVisitor(LookupColumnEntities.GetEntity("WebAnalyticsVisitor")));
			}
		}

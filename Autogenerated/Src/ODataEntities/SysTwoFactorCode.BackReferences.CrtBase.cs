namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysTwoFactorCode : Terrasoft.Core.Entities.Entity
	{
		...
		public SysTwoFactorCode(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysTwoFactorCode";
		...
		public string Provider {
			get {
				return GetTypedColumnValue<string>("Provider");
			}
			set {
				SetColumnValue("Provider", value);
			}
		}

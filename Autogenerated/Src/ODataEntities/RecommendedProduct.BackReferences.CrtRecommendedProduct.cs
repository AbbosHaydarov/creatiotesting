namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class RecommendedProduct : Terrasoft.Core.Entities.Entity
	{
		...
		public RecommendedProduct(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "RecommendedProduct";
		...
		public RecommendProductStatus Status {
			get {
				return _status ??
					(_status = new RecommendProductStatus(LookupColumnEntities.GetEntity("Status")));
			}
		}

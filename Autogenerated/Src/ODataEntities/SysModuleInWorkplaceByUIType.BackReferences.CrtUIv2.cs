namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysModuleInWorkplaceByUIType : Terrasoft.Core.Entities.Entity
	{
		...
		public SysModuleInWorkplaceByUIType(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysModuleInWorkplaceByUIType";
		...
		public SysWorkplace SysWorkplace {
			get {
				return _sysWorkplace ??
					(_sysWorkplace = new SysWorkplace(LookupColumnEntities.GetEntity("SysWorkplace")));
			}
		}
		...
		public SectionUIType SectionUIType {
			get {
				return _sectionUIType ??
					(_sectionUIType = new SectionUIType(LookupColumnEntities.GetEntity("SectionUIType")));
			}
		}

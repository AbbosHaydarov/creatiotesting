namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SpecTableInherited : Terrasoft.Core.Entities.Entity
	{
		...
		public SpecTableInherited(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SpecTableInherited";
		...
		public IEnumerable<SpecInherited> SpecInheritedCollectionBySpecTableInheritedX {
			get;
			set;
		}

		public IEnumerable<SpecInherited> SpecInheritedCollectionBySpecTableInheritedY {
			get;
			set;
		}

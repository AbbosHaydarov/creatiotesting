namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class WebhookLog : Terrasoft.Core.Entities.Entity
	{
		...
		public WebhookLog(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "WebhookLog";
		...
		public Webhook Webhook {
			get {
				return _webhook ??
					(_webhook = new Webhook(LookupColumnEntities.GetEntity("Webhook")));
			}
		}

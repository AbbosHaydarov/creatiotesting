namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class Pricelist : Terrasoft.Core.Entities.Entity
	{
		...
		public Pricelist(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "Pricelist";
		...
		public IEnumerable<DocumentProduct> DocumentProductCollectionByPriceList {
			get;
			set;
		}

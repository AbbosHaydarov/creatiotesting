namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OpportunityCondition : Terrasoft.Core.Entities.Entity
	{
		...
		public OpportunityCondition(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OpportunityCondition";
		...
		public IEnumerable<FinApplication> FinApplicationCollectionByOpportunityCondition {
			get;
			set;
		}

		public IEnumerable<FinApplicationSpec> FinApplicationSpecCollectionByOpportunityCondition {
			get;
			set;
		}

		public IEnumerable<SpecInCondition> SpecInConditionCollectionByOpportunityCondition {
			get;
			set;
		}

		public IEnumerable<VwFinActiveProduct> VwFinActiveProductCollectionByOpportunityCondition {
			get;
			set;
		}

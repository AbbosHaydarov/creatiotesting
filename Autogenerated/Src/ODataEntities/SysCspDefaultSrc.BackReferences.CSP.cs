namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysCspDefaultSrc : Terrasoft.Core.Entities.Entity
	{
		...
		public SysCspDefaultSrc(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysCspDefaultSrc";
		...
		public IEnumerable<SysCspDefSrcInDirectv> SysCspDefSrcInDirectvCollectionByCspDefaultSource {
			get;
			set;
		}

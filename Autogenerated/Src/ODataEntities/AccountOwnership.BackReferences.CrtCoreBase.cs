namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AccountOwnership : Terrasoft.Core.Entities.Entity
	{
		...
		public AccountOwnership(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AccountOwnership";
		...
		public IEnumerable<AppFormCareer> AppFormCareerCollectionByLegalForm {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BulkEmailResponseReason : Terrasoft.Core.Entities.Entity
	{
		...
		public BulkEmailResponseReason(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BulkEmailResponseReason";
		...
		public IEnumerable<BulkEmailResponseDetails> BulkEmailResponseDetailsCollectionByReason {
			get;
			set;
		}

		public IEnumerable<VwBulkEmailAudience> VwBulkEmailAudienceCollectionByResponseReason {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class EmailTemplateInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public EmailTemplateInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "EmailTemplateInTag";
		...
		private EmailTemplateTag _tag;
		/// <summary>
		/// Email message template section tag.
		/// </summary>
		public EmailTemplateTag Tag {
			get {
				return _tag ??
					(_tag = new EmailTemplateTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public EmailTemplate Entity {
			get {
				return _entity ??
					(_entity = new EmailTemplate(LookupColumnEntities.GetEntity("Entity")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SiteEventTypeInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SiteEventTypeInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SiteEventTypeInFolder";
		...
		private SiteEventTypeFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public SiteEventTypeFolder Folder {
			get {
				return _folder ??
					(_folder = new SiteEventTypeFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

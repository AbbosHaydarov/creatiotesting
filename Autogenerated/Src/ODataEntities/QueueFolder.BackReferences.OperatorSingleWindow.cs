namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class QueueFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public QueueFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "QueueFolder";
		...
		public IEnumerable<QueueFolder> QueueFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<QueueInFolder> QueueInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public QueueFolder Parent {
			get {
				return _parent ??
					(_parent = new QueueFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

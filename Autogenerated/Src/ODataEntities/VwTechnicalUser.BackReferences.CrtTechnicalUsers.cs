namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwTechnicalUser : Terrasoft.Core.Entities.Entity
	{
		...
		public VwTechnicalUser(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwTechnicalUser";
		...
		public SysLanguage SysCulture {
			get {
				return _sysCulture ??
					(_sysCulture = new SysLanguage(LookupColumnEntities.GetEntity("SysCulture")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	public class SysPrcHistoryLog : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<SysPrcHistoryLog> SysPrcHistoryLogCollectionByRoot {
			get;
			set;
		}
		...
		private SysPrcHistoryLog _root;
		/// <summary>
		/// Root process.
		/// </summary>
		public SysPrcHistoryLog Root {
			get {
				return _root ??
					(_root = new SysPrcHistoryLog(LookupColumnEntities.GetEntity("Root")));
			}
		}

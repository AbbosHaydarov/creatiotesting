namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwSysDcmLibFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public VwSysDcmLibFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwSysDcmLibFolder";
		...
		public VwSysDcmLibFolder Parent {
			get {
				return _parent ??
					(_parent = new VwSysDcmLibFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BankCardFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public BankCardFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BankCardFolder";
		...
		public IEnumerable<BankCardFolder> BankCardFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<BankCardInFolder> BankCardInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public BankCardFolder Parent {
			get {
				return _parent ??
					(_parent = new BankCardFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

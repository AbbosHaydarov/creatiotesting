namespace Terrasoft.Configuration.OData
{
	...
	public class SysFileContentStorage : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<AppFormFile> AppFormFileCollectionBySysFileStorage {
			get;
			set;
		}

		public IEnumerable<AppValidationItemFile> AppValidationItemFileCollectionBySysFileStorage {
			get;
			set;
		}

		public IEnumerable<BankAccountFile> BankAccountFileCollectionBySysFileStorage {
			get;
			set;
		}

		public IEnumerable<BankCardFile> BankCardFileCollectionBySysFileStorage {
			get;
			set;
		}
		...
		public IEnumerable<DocListInFinAppFile> DocListInFinAppFileCollectionBySysFileStorage {
			get;
			set;
		}
		...
		public IEnumerable<FinApplicationFile> FinApplicationFileCollectionBySysFileStorage {
			get;
			set;
		}
		...
		public IEnumerable<RegDocumentFile> RegDocumentFileCollectionBySysFileStorage {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AccountFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public AccountFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AccountFolder";
		...
		public IEnumerable<FinIndicator> FinIndicatorCollectionByAccountFolder {
			get;
			set;
		}
		...
		public AccountFolder Parent {
			get {
				return _parent ??
					(_parent = new AccountFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

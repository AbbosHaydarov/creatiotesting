namespace Terrasoft.Configuration.OData
{
	...
	public class CommunicationType : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<AppFormCommunication> AppFormCommunicationCollectionByCommunicationType {
			get;
			set;
		}

		public IEnumerable<AppFormMainContact> AppFormMainContactCollectionByCommunicationType1 {
			get;
			set;
		}

		public IEnumerable<AppFormMainContact> AppFormMainContactCollectionByCommunicationType2 {
			get;
			set;
		}

		public IEnumerable<AppFormMainContact> AppFormMainContactCollectionByCommunicationType3 {
			get;
			set;
		}

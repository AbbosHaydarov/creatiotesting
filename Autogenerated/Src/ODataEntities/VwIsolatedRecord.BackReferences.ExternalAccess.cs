namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwIsolatedRecord : Terrasoft.Core.Entities.Entity
	{
		...
		public VwIsolatedRecord(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwIsolatedRecord";
		...
		public VwSysSchemaInfo EntitySchema {
			get {
				return _entitySchema ??
					(_entitySchema = new VwSysSchemaInfo(LookupColumnEntities.GetEntity("EntitySchema")));
			}
		}

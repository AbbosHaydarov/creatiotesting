namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysInactivePackageInApp : Terrasoft.Core.Entities.Entity
	{
		...
		public SysInactivePackageInApp(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysInactivePackageInApp";
		...
		public SysInactivePackage SysInactivePackage {
			get {
				return _sysInactivePackage ??
					(_sysInactivePackage = new SysInactivePackage(LookupColumnEntities.GetEntity("SysInactivePackage")));
			}
		}

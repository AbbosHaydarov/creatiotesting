namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class EmailTemplateFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public EmailTemplateFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "EmailTemplateFolder";
		...
		public IEnumerable<EmailTemplateFolder> EmailTemplateFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<EmailTemplateInFolder> EmailTemplateInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public EmailTemplateFolder Parent {
			get {
				return _parent ??
					(_parent = new EmailTemplateFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysProcessUserTaskFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysProcessUserTaskFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysProcessUserTaskFolder";
		...
		public SysProcessUserTaskFolder Parent {
			get {
				return _parent ??
					(_parent = new SysProcessUserTaskFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

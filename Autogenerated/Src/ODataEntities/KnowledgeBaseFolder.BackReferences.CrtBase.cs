namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class KnowledgeBaseFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public KnowledgeBaseFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "KnowledgeBaseFolder";
		...
		public KnowledgeBaseFolder Parent {
			get {
				return _parent ??
					(_parent = new KnowledgeBaseFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class MktgActivityFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public MktgActivityFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "MktgActivityFolder";
		...
		public IEnumerable<MktgActivityFolder> MktgActivityFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<MktgActivityInFolder> MktgActivityInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public MktgActivityFolder Parent {
			get {
				return _parent ??
					(_parent = new MktgActivityFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class FinIndicatorInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public FinIndicatorInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "FinIndicatorInFolder";
		...
		private FinIndicatorFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public FinIndicatorFolder Folder {
			get {
				return _folder ??
					(_folder = new FinIndicatorFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}
		...
		public FinIndicator FinIndicator {
			get {
				return _finIndicator ??
					(_finIndicator = new FinIndicator(LookupColumnEntities.GetEntity("FinIndicator")));
			}
		}

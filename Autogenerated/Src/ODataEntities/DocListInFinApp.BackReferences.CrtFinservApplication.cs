namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class DocListInFinApp : Terrasoft.Core.Entities.Entity
	{
		...
		public DocListInFinApp(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "DocListInFinApp";
		...
		public IEnumerable<DocListInFinAppFile> DocListInFinAppFileCollectionByDocListInFinApp {
			get;
			set;
		}
		...
		public Document DocumentLink {
			get {
				return _documentLink ??
					(_documentLink = new Document(LookupColumnEntities.GetEntity("DocumentLink")));
			}
		}

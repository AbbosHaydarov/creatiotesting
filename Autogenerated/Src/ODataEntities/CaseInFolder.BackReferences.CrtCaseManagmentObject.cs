namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CaseInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public CaseInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CaseInFolder";
		...
		private CaseFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public CaseFolder Folder {
			get {
				return _folder ??
					(_folder = new CaseFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

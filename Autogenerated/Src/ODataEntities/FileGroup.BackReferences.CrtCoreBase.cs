namespace Terrasoft.Configuration.OData
{
	...
	public class FileGroup : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<AppFormFile> AppFormFileCollectionByFileGroup {
			get;
			set;
		}

		public IEnumerable<AppValidationItemFile> AppValidationItemFileCollectionByFileGroup {
			get;
			set;
		}

		public IEnumerable<BankAccountFile> BankAccountFileCollectionByFileGroup {
			get;
			set;
		}

		public IEnumerable<BankCardFile> BankCardFileCollectionByFileGroup {
			get;
			set;
		}
		...
		public IEnumerable<DocListInFinAppFile> DocListInFinAppFileCollectionByFileGroup {
			get;
			set;
		}
		...
		public IEnumerable<FinApplicationFile> FinApplicationFileCollectionByFileGroup {
			get;
			set;
		}
		...
		public IEnumerable<RegDocumentFile> RegDocumentFileCollectionByFileGroup {
			get;
			set;
		}

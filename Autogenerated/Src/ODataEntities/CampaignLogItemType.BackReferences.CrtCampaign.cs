namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CampaignLogItemType : Terrasoft.Core.Entities.Entity
	{
		...
		public CampaignLogItemType(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CampaignLogItemType";
		...
		public IEnumerable<CampaignLog> CampaignLogCollectionByAction {
			get;
			set;
		}

		public IEnumerable<VwCampaignLog> VwCampaignLogCollectionByAction {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	public class ProductType : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<ChangeCriteria> ChangeCriteriaCollectionByProductType {
			get;
			set;
		}

		public IEnumerable<DefSpecification> DefSpecificationCollectionByProductType {
			get;
			set;
		}

		public IEnumerable<DocListInCondition> DocListInConditionCollectionByProductType {
			get;
			set;
		}

		public IEnumerable<DocListInFinApp> DocListInFinAppCollectionByProductType {
			get;
			set;
		}

		public IEnumerable<DocumentList> DocumentListCollectionByProductType {
			get;
			set;
		}

		public IEnumerable<DocumentListInProduct> DocumentListInProductCollectionByProductType {
			get;
			set;
		}

		public IEnumerable<FinApplication> FinApplicationCollectionByProductType {
			get;
			set;
		}
		...
		public IEnumerable<ProductKind> ProductKindCollectionByProductType {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class WebhookStatus : Terrasoft.Core.Entities.Entity
	{
		...
		public WebhookStatus(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "WebhookStatus";
		...
		public IEnumerable<Webhook> WebhookCollectionByStatus {
			get;
			set;
		}

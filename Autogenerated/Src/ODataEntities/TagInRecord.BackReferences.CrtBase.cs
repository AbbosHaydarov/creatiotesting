namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class TagInRecord : Terrasoft.Core.Entities.Entity
	{
		...
		public TagInRecord(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "TagInRecord";
		...
		public Tag Tag {
			get {
				return _tag ??
					(_tag = new Tag(LookupColumnEntities.GetEntity("Tag")));
			}
		}

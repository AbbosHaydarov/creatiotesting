namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProductInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public ProductInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProductInTag";
		...
		public ProductTag Tag {
			get {
				return _tag ??
					(_tag = new ProductTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Product Entity {
			get {
				return _entity ??
					(_entity = new Product(LookupColumnEntities.GetEntity("Entity")));
			}
		}

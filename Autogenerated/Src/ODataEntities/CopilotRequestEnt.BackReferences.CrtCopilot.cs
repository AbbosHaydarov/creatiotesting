namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CopilotRequestEnt : Terrasoft.Core.Entities.Entity
	{
		...
		public CopilotRequestEnt(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CopilotRequestEnt";
		...
		public IEnumerable<CopilotMessageEnt> CopilotMessageEntCollectionByCopilotRequest {
			get;
			set;
		}

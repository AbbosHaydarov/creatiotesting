namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ExternalAccessFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ExternalAccessFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ExternalAccessFolder";
		...
		public ExternalAccessFolder Parent {
			get {
				return _parent ??
					(_parent = new ExternalAccessFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

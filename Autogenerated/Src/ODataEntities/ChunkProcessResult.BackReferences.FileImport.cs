namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ChunkProcessResult : Terrasoft.Core.Entities.Entity
	{
		...
		public ChunkProcessResult(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ChunkProcessResult";
		...
		public ImportSessionChunk ImportSessionChunk {
			get {
				return _importSessionChunk ??
					(_importSessionChunk = new ImportSessionChunk(LookupColumnEntities.GetEntity("ImportSessionChunk")));
			}
		}

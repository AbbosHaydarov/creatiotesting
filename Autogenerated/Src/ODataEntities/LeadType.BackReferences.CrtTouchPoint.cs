namespace Terrasoft.Configuration.OData
{
	...
	public class LeadType : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<Contact> ContactCollectionByCustomerNeed {
			get;
			set;
		}

		public IEnumerable<FormSubmit> FormSubmitCollectionByCustomerNeed {
			get;
			set;
		}
		...
		public IEnumerable<SpecificationInLeadType> SpecificationInLeadTypeCollectionByLeadType {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class EmailFolderColumnValuesSetting : Terrasoft.Core.Entities.Entity
	{
		...
		public EmailFolderColumnValuesSetting(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "EmailFolderColumnValuesSetting";
		...
		public ActivityFolder EmailFolder {
			get {
				return _emailFolder ??
					(_emailFolder = new ActivityFolder(LookupColumnEntities.GetEntity("EmailFolder")));
			}
		}

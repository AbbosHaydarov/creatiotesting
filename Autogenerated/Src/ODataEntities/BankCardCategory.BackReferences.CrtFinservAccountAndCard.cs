namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BankCardCategory : Terrasoft.Core.Entities.Entity
	{
		...
		public BankCardCategory(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BankCardCategory";
		...
		public IEnumerable<BankCard> BankCardCollectionByBankCardCategory {
			get;
			set;
		}

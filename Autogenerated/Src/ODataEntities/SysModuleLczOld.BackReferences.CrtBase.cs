namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysModuleLczOld : Terrasoft.Core.Entities.Entity
	{
		...
		public SysModuleLczOld(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysModuleLczOld";
		...
		private SysModule _record;
		/// <summary>
		/// Record Id.
		/// </summary>
		public SysModule Record {
			get {
				return _record ??
					(_record = new SysModule(LookupColumnEntities.GetEntity("Record")));
			}
		}

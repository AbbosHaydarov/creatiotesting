namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CampaignFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public CampaignFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CampaignFolder";
		...
		public IEnumerable<CampaignFolder> CampaignFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<CampaignInFolder> CampaignInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public CampaignFolder Parent {
			get {
				return _parent ??
					(_parent = new CampaignFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

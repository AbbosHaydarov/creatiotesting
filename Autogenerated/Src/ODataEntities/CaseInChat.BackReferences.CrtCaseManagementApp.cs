namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CaseInChat : Terrasoft.Core.Entities.Entity
	{
		...
		public CaseInChat(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CaseInChat";
		...
		public OmniChat Chat {
			get {
				return _chat ??
					(_chat = new OmniChat(LookupColumnEntities.GetEntity("Chat")));
			}
		}

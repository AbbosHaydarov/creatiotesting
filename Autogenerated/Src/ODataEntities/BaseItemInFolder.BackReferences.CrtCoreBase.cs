namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BaseItemInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public BaseItemInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BaseItemInFolder";
		...
		public BaseFolder Folder {
			get {
				return _folder ??
					(_folder = new BaseFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

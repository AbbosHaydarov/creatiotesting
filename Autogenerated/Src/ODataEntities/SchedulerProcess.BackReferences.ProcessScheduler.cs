namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SchedulerProcess : Terrasoft.Core.Entities.Entity
	{
		...
		public SchedulerProcess(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SchedulerProcess";
		...
		public SchedulerExpression SchedulerExpression {
			get {
				return _schedulerExpression ??
					(_schedulerExpression = new SchedulerExpression(LookupColumnEntities.GetEntity("SchedulerExpression")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysRepository : Terrasoft.Core.Entities.Entity
	{
		...
		public SysRepository(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysRepository";
		...
		public IEnumerable<SysInactivePackage> SysInactivePackageCollectionBySysRepository {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AccountAnniversary : Terrasoft.Core.Entities.Entity
	{
		...
		public AccountAnniversary(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AccountAnniversary";
		...
		public AnniversaryType AnniversaryType {
			get {
				return _anniversaryType ??
					(_anniversaryType = new AnniversaryType(LookupColumnEntities.GetEntity("AnniversaryType")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class QueueInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public QueueInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "QueueInFolder";
		...
		private QueueFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public QueueFolder Folder {
			get {
				return _folder ??
					(_folder = new QueueFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

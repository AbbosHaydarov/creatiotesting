namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SecFolderTreeFavorite : Terrasoft.Core.Entities.Entity
	{
		...
		public SecFolderTreeFavorite(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SecFolderTreeFavorite";
		...
		public FolderTree FolderTree {
			get {
				return _folderTree ??
					(_folderTree = new FolderTree(LookupColumnEntities.GetEntity("FolderTree")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class TrackingProject : Terrasoft.Core.Entities.Entity
	{
		...
		public TrackingProject(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "TrackingProject";
		...
		public IEnumerable<TrackingResource> TrackingResourceCollectionByProject {
			get;
			set;
		}

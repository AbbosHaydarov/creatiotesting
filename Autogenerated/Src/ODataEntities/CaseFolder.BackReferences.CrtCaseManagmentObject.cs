namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CaseFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public CaseFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CaseFolder";
		...
		public IEnumerable<CaseFolder> CaseFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<CaseInFolder> CaseInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public CaseFolder Parent {
			get {
				return _parent ??
					(_parent = new CaseFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AccessControlWhitelist : Terrasoft.Core.Entities.Entity
	{
		...
		public AccessControlWhitelist(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AccessControlWhitelist";
		...
		public VwSysSchemaInfo Page {
			get {
				return _page ??
					(_page = new VwSysSchemaInfo(LookupColumnEntities.GetEntity("Page")));
			}
		}

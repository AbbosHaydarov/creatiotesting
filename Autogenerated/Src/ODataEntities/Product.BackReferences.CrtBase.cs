namespace Terrasoft.Configuration.OData
{
	...
	public class Product : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<Activity> ActivityCollectionByProduct {
			get;
			set;
		}
		...
		public IEnumerable<BankAccount> BankAccountCollectionByPackage {
			get;
			set;
		}

		public IEnumerable<BankAccount> BankAccountCollectionByProduct {
			get;
			set;
		}

		public IEnumerable<BankCard> BankCardCollectionByPackage {
			get;
			set;
		}

		public IEnumerable<BankCard> BankCardCollectionByProduct {
			get;
			set;
		}

		public IEnumerable<CaseConsultationTheme> CaseConsultationThemeCollectionByProduct {
			get;
			set;
		}
		...
		public IEnumerable<Contract> ContractCollectionByPackage {
			get;
			set;
		}

		public IEnumerable<Contract> ContractCollectionByProduct {
			get;
			set;
		}

		public IEnumerable<DocumentListInProduct> DocumentListInProductCollectionByProduct {
			get;
			set;
		}
		...
		public IEnumerable<FinApplication> FinApplicationCollectionByPackage {
			get;
			set;
		}

		public IEnumerable<FinApplication> FinApplicationCollectionByProduct {
			get;
			set;
		}
		...
		public IEnumerable<ProductCondition> ProductConditionCollectionByProduct {
			get;
			set;
		}
		...
		public IEnumerable<ProductInPackage> ProductInPackageCollectionByPackage {
			get;
			set;
		}

		public IEnumerable<ProductInPackage> ProductInPackageCollectionByProduct {
			get;
			set;
		}
		...
		public IEnumerable<VwFinActiveProduct> VwFinActiveProductCollectionByProduct {
			get;
			set;
		}
		...
		public ProductStatus ProductStatus {
			get {
				return _productStatus ??
					(_productStatus = new ProductStatus(LookupColumnEntities.GetEntity("ProductStatus")));
			}
		}
		...
		public ProductKind ProductKind {
			get {
				return _productKind ??
					(_productKind = new ProductKind(LookupColumnEntities.GetEntity("ProductKind")));
			}
		}
		...
		public Account InsuranceCompany {
			get {
				return _insuranceCompany ??
					(_insuranceCompany = new Account(LookupColumnEntities.GetEntity("InsuranceCompany")));
			}
		}
		...
		public ClientTypeForProduct AvailableFor {
			get {
				return _availableFor ??
					(_availableFor = new ClientTypeForProduct(LookupColumnEntities.GetEntity("AvailableFor")));
			}
		}

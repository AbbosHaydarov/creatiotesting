namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AppFormInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public AppFormInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AppFormInFolder";
		...
		private AppFormFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public AppFormFolder Folder {
			get {
				return _folder ??
					(_folder = new AppFormFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

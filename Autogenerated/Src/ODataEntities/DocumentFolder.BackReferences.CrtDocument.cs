namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class DocumentFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public DocumentFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "DocumentFolder";
		...
		public DocumentFolder Parent {
			get {
				return _parent ??
					(_parent = new DocumentFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

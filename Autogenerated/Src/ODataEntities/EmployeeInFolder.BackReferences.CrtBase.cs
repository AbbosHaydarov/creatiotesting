namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class EmployeeInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public EmployeeInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "EmployeeInFolder";
		...
		private EmployeeFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public EmployeeFolder Folder {
			get {
				return _folder ??
					(_folder = new EmployeeFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysNumberFormat : Terrasoft.Core.Entities.Entity
	{
		...
		public SysNumberFormat(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysNumberFormat";
		...
		public IEnumerable<SysAdminUnit> SysAdminUnitCollectionByNumberFormat {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AccountEmployeesNumber : Terrasoft.Core.Entities.Entity
	{
		...
		public AccountEmployeesNumber(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AccountEmployeesNumber";
		...
		public IEnumerable<FormSubmit> FormSubmitCollectionByAccountEmployeesNumber {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysAppTemplateInfoItem : Terrasoft.Core.Entities.Entity
	{
		...
		public SysAppTemplateInfoItem(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysAppTemplateInfoItem";
		...
		public SysAppTemplate SysAppTemplate {
			get {
				return _sysAppTemplate ??
					(_sysAppTemplate = new SysAppTemplate(LookupColumnEntities.GetEntity("SysAppTemplate")));
			}
		}

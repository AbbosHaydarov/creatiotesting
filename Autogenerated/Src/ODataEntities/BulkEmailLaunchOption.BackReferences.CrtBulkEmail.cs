namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BulkEmailLaunchOption : Terrasoft.Core.Entities.Entity
	{
		...
		public BulkEmailLaunchOption(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BulkEmailLaunchOption";
		...
		public IEnumerable<BulkEmail> BulkEmailCollectionByLaunchOption {
			get;
			set;
		}

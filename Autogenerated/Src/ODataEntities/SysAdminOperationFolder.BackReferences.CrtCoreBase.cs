namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysAdminOperationFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysAdminOperationFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysAdminOperationFolder";
		...
		public IEnumerable<SysAdminOperationInFolder> SysAdminOperationInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public SysAdminOperationFolder Parent {
			get {
				return _parent ??
					(_parent = new SysAdminOperationFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BankAccountFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public BankAccountFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BankAccountFolder";
		...
		public IEnumerable<BankAccountFolder> BankAccountFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<BankAccountInFolder> BankAccountInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public BankAccountFolder Parent {
			get {
				return _parent ??
					(_parent = new BankAccountFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

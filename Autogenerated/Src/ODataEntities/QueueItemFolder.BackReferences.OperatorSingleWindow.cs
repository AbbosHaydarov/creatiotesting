namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class QueueItemFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public QueueItemFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "QueueItemFolder";
		...
		public VwQueueItem Parent {
			get {
				return _parent ??
					(_parent = new VwQueueItem(LookupColumnEntities.GetEntity("Parent")));
			}
		}

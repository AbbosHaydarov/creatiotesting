namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class FileInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public FileInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "FileInFolder";
		...
		public FileFolder Folder {
			get {
				return _folder ??
					(_folder = new FileFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}
		...
		public File File {
			get {
				return _file ??
					(_file = new File(LookupColumnEntities.GetEntity("File")));
			}
		}

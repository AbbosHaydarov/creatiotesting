namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SiteEventTypeFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SiteEventTypeFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SiteEventTypeFolder";
		...
		public IEnumerable<SiteEventTypeFolder> SiteEventTypeFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<SiteEventTypeInFolder> SiteEventTypeInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public SiteEventTypeFolder Parent {
			get {
				return _parent ??
					(_parent = new SiteEventTypeFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwSysProcessEntity : Terrasoft.Core.Entities.Entity
	{
		...
		public VwSysProcessEntity(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwSysProcessEntity";
		...
		public VwSysProcessLog SysProcess {
			get {
				return _sysProcess ??
					(_sysProcess = new VwSysProcessLog(LookupColumnEntities.GetEntity("SysProcess")));
			}
		}
		...
		public VwSysSchemaInWorkspace SysSchema {
			get {
				return _sysSchema ??
					(_sysSchema = new VwSysSchemaInWorkspace(LookupColumnEntities.GetEntity("SysSchema")));
			}
		}

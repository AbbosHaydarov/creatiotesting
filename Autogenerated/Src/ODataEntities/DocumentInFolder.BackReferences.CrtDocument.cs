namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class DocumentInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public DocumentInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "DocumentInFolder";
		...
		public DocumentFolder Folder {
			get {
				return _folder ??
					(_folder = new DocumentFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

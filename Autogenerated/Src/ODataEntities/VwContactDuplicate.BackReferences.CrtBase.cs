namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwContactDuplicate : Terrasoft.Core.Entities.Entity
	{
		...
		public VwContactDuplicate(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwContactDuplicate";
		...
		public Contact Entity1 {
			get {
				return _entity1 ??
					(_entity1 = new Contact(LookupColumnEntities.GetEntity("Entity1")));
			}
		}
		...
		public Contact Entity2 {
			get {
				return _entity2 ??
					(_entity2 = new Contact(LookupColumnEntities.GetEntity("Entity2")));
			}
		}

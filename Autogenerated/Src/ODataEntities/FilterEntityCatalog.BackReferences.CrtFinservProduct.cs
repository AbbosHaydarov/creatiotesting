namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class FilterEntityCatalog : Terrasoft.Core.Entities.Entity
	{
		...
		public FilterEntityCatalog(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "FilterEntityCatalog";
		...
		public IEnumerable<DocListInCondition> DocListInConditionCollectionByFilterEntity {
			get;
			set;
		}

		public IEnumerable<DocumentListStage> DocumentListStageCollectionByFilterEntity {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CampaignPlannerFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public CampaignPlannerFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CampaignPlannerFolder";
		...
		public IEnumerable<CampaignPlannerFolder> CampaignPlannerFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<CampaignPlannerInFolder> CampaignPlannerInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public CampaignPlannerFolder Parent {
			get {
				return _parent ??
					(_parent = new CampaignPlannerFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

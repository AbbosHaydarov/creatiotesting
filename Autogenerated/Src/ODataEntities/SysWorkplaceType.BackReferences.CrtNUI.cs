namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysWorkplaceType : Terrasoft.Core.Entities.Entity
	{
		...
		public SysWorkplaceType(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysWorkplaceType";
		...
		public IEnumerable<SysMobileWorkplace> SysMobileWorkplaceCollectionByType {
			get;
			set;
		}

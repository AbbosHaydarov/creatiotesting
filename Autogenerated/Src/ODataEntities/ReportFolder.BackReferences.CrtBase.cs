namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ReportFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ReportFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ReportFolder";
		...
		public ReportFolder Parent {
			get {
				return _parent ??
					(_parent = new ReportFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

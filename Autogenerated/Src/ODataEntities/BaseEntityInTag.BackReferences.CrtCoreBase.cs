namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BaseEntityInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public BaseEntityInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BaseEntityInTag";
		...
		public Lookup Tag {
			get {
				return _tag ??
					(_tag = new Lookup(LookupColumnEntities.GetEntity("Tag")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OpportunityInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public OpportunityInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OpportunityInFolder";
		...
		private OpportunityFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public OpportunityFolder Folder {
			get {
				return _folder ??
					(_folder = new OpportunityFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

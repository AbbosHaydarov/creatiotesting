namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SsoProviderType : Terrasoft.Core.Entities.Entity
	{
		...
		public SsoProviderType(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SsoProviderType";
		...
		public IEnumerable<SsoSettingsTemplate> SsoSettingsTemplateCollectionByProviderType {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OmniChatFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public OmniChatFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OmniChatFolder";
		...
		public IEnumerable<OmniChatFolder> OmniChatFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<OmniChatInFolder> OmniChatInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public OmniChatFolder Parent {
			get {
				return _parent ??
					(_parent = new OmniChatFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

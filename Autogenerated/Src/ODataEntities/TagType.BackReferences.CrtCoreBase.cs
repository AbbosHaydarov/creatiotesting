namespace Terrasoft.Configuration.OData
{
	...
	public class TagType : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<AppFormTag> AppFormTagCollectionByType {
			get;
			set;
		}

		public IEnumerable<BankAccountTag> BankAccountTagCollectionByType {
			get;
			set;
		}

		public IEnumerable<BankCardTag> BankCardTagCollectionByType {
			get;
			set;
		}
		...
		public IEnumerable<FinApplicationTag> FinApplicationTagCollectionByType {
			get;
			set;
		}

		public IEnumerable<FinIndicatorTag> FinIndicatorTagCollectionByType {
			get;
			set;
		}

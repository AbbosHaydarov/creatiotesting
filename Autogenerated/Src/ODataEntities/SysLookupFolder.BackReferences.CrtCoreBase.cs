namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysLookupFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysLookupFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysLookupFolder";
		...
		public SysLookupFolder Parent {
			get {
				return _parent ??
					(_parent = new SysLookupFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

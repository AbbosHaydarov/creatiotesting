namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LMStartEvent : Terrasoft.Core.Entities.Entity
	{
		...
		public LMStartEvent(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LMStartEvent";
		...
		public IEnumerable<LMColumnTemplate> LMColumnTemplateCollectionByLMStartEvent {
			get;
			set;
		}

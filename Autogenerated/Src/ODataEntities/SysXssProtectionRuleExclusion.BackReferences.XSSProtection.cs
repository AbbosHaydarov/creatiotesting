namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysXssProtectionRuleExclusion : Terrasoft.Core.Entities.Entity
	{
		...
		public SysXssProtectionRuleExclusion(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysXssProtectionRuleExclusion";
		...
		public SysXssProtectRuleExclType ExclusionType {
			get {
				return _exclusionType ??
					(_exclusionType = new SysXssProtectRuleExclType(LookupColumnEntities.GetEntity("ExclusionType")));
			}
		}

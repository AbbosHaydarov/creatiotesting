namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ReportInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ReportInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ReportInFolder";
		...
		public ReportFolder Folder {
			get {
				return _folder ??
					(_folder = new ReportFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}
		...
		public Report Report {
			get {
				return _report ??
					(_report = new Report(LookupColumnEntities.GetEntity("Report")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class DocumentListStage : Terrasoft.Core.Entities.Entity
	{
		...
		public DocumentListStage(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "DocumentListStage";
		...
		public IEnumerable<DocListInCondition> DocListInConditionCollectionByDocumentListStage {
			get;
			set;
		}

		public IEnumerable<DocListInFinApp> DocListInFinAppCollectionByDocumentListStage {
			get;
			set;
		}

		public IEnumerable<DocumentList> DocumentListCollectionByDocumentListStage {
			get;
			set;
		}

		public IEnumerable<DocumentListInProduct> DocumentListInProductCollectionByDocumentListStage {
			get;
			set;
		}

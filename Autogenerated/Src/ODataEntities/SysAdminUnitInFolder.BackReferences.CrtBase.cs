namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysAdminUnitInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysAdminUnitInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysAdminUnitInFolder";
		...
		private SysAdminUnitFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public SysAdminUnitFolder Folder {
			get {
				return _folder ??
					(_folder = new SysAdminUnitFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	public class Opportunity : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<Contract> ContractCollectionByOpportunity {
			get;
			set;
		}
		...
		public IEnumerable<SpecificationInOpportunity> SpecificationInOpportunityCollectionByOpportunity {
			get;
			set;
		}

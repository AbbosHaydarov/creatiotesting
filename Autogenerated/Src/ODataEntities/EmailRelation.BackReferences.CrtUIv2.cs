namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class EmailRelation : Terrasoft.Core.Entities.Entity
	{
		...
		public EmailRelation(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "EmailRelation";
		...
		public Activity Email {
			get {
				return _email ??
					(_email = new Activity(LookupColumnEntities.GetEntity("Email")));
			}
		}

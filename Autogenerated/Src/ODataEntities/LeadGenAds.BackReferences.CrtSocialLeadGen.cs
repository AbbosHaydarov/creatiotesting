namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LeadGenAds : Terrasoft.Core.Entities.Entity
	{
		...
		public LeadGenAds(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LeadGenAds";
		...
		public IEnumerable<LeadGenExtendedLeadInformation> LeadGenExtendedLeadInformationCollectionByLeadGenAds {
			get;
			set;
		}

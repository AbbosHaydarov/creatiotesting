namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LookupFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public LookupFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LookupFolder";
		...
		public LookupFolder Parent {
			get {
				return _parent ??
					(_parent = new LookupFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

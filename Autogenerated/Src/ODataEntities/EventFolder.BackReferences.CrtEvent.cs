namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class EventFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public EventFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "EventFolder";
		...
		public IEnumerable<EventFolder> EventFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<EventInFolder> EventInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public EventFolder Parent {
			get {
				return _parent ??
					(_parent = new EventFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

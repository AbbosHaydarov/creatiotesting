namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ContractFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ContractFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ContractFolder";
		...
		public ContractFolder Parent {
			get {
				return _parent ??
					(_parent = new ContractFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class MLError : Terrasoft.Core.Entities.Entity
	{
		...
		public MLError(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "MLError";
		...
		public IEnumerable<MLModel> MLModelCollectionByLastTrainingError {
			get;
			set;
		}

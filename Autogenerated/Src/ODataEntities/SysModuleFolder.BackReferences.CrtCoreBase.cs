namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysModuleFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysModuleFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysModuleFolder";
		...
		public City Parent {
			get {
				return _parent ??
					(_parent = new City(LookupColumnEntities.GetEntity("Parent")));
			}
		}

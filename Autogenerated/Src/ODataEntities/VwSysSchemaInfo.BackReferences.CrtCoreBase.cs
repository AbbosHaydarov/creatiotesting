namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwSysSchemaInfo : Terrasoft.Core.Entities.Entity
	{
		...
		public VwSysSchemaInfo(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwSysSchemaInfo";
		...
		public IEnumerable<AccessControlWhitelist> AccessControlWhitelistCollectionByPage {
			get;
			set;
		}

		public IEnumerable<CopilotMessageEnt> CopilotMessageEntCollectionByIntent {
			get;
			set;
		}

		public IEnumerable<CopilotSessionEnt> CopilotSessionEntCollectionByCurrentIntent {
			get;
			set;
		}
		...
		public IEnumerable<VwCopilotRequest> VwCopilotRequestCollectionByIntent {
			get;
			set;
		}

		public IEnumerable<VwCopilotSessionIntent> VwCopilotSessionIntentCollectionByIntent {
			get;
			set;
		}

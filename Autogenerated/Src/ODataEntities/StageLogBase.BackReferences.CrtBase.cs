namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class StageLogBase : Terrasoft.Core.Entities.Entity
	{
		...
		public StageLogBase(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "StageLogBase";
		...
		public Lookup RootEntity {
			get {
				return _rootEntity ??
					(_rootEntity = new Lookup(LookupColumnEntities.GetEntity("RootEntity")));
			}
		}
		...
		public Lookup Stage {
			get {
				return _stage ??
					(_stage = new Lookup(LookupColumnEntities.GetEntity("Stage")));
			}
		}

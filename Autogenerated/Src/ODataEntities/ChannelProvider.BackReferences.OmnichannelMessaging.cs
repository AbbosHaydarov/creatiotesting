namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ChannelProvider : Terrasoft.Core.Entities.Entity
	{
		...
		public ChannelProvider(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ChannelProvider";
		...
		public IEnumerable<Channel> ChannelCollectionByProvider {
			get;
			set;
		}
		...
		public SysImage Icon {
			get {
				return _icon ??
					(_icon = new SysImage(LookupColumnEntities.GetEntity("Icon")));
			}
		}

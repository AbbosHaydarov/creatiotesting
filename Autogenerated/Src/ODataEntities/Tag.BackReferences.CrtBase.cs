namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class Tag : Terrasoft.Core.Entities.Entity
	{
		...
		public Tag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "Tag";
		...
		public IEnumerable<TagInRecord> TagInRecordCollectionByTag {
			get;
			set;
		}

		public IEnumerable<TagInSchema> TagInSchemaCollectionByTag {
			get;
			set;
		}
		...
		public TagAccess TagAccess {
			get {
				return _tagAccess ??
					(_tagAccess = new TagAccess(LookupColumnEntities.GetEntity("TagAccess")));
			}
		}

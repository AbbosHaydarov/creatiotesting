namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ExternalAccessInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ExternalAccessInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ExternalAccessInFolder";
		...
		private ExternalAccessFolder _folder;
		/// <summary>
		/// External access folder.
		/// </summary>
		public ExternalAccessFolder Folder {
			get {
				return _folder ??
					(_folder = new ExternalAccessFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CampaignInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public CampaignInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CampaignInFolder";
		...
		private CampaignFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public CampaignFolder Folder {
			get {
				return _folder ??
					(_folder = new CampaignFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

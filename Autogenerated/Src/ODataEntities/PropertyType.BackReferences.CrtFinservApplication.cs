namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class PropertyType : Terrasoft.Core.Entities.Entity
	{
		...
		public PropertyType(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "PropertyType";
		...
		public IEnumerable<AppFormProperty> AppFormPropertyCollectionByPropertyType {
			get;
			set;
		}

		public IEnumerable<SpecInPropertyType> SpecInPropertyTypeCollectionByPropertyType {
			get;
			set;
		}
		...
		public CollateralObjectType CollateralObjectType {
			get {
				return _collateralObjectType ??
					(_collateralObjectType = new CollateralObjectType(LookupColumnEntities.GetEntity("CollateralObjectType")));
			}
		}

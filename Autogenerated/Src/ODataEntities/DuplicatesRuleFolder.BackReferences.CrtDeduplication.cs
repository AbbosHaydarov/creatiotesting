namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class DuplicatesRuleFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public DuplicatesRuleFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "DuplicatesRuleFolder";
		...
		public DuplicatesRuleFolder Parent {
			get {
				return _parent ??
					(_parent = new DuplicatesRuleFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

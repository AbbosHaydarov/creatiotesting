namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProductFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ProductFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProductFolder";
		...
		public ProductFolder Parent {
			get {
				return _parent ??
					(_parent = new ProductFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

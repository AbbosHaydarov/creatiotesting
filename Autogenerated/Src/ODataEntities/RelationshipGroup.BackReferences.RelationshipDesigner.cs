namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class RelationshipGroup : Terrasoft.Core.Entities.Entity
	{
		...
		public RelationshipGroup(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "RelationshipGroup";
		...
		public IEnumerable<RelationEntityInGroup> RelationEntityInGroupCollectionByRelationshipGroup {
			get;
			set;
		}

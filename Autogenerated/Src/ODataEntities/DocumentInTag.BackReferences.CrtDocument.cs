namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class DocumentInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public DocumentInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "DocumentInTag";
		...
		public DocumentTag Tag {
			get {
				return _tag ??
					(_tag = new DocumentTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Document Entity {
			get {
				return _entity ??
					(_entity = new Document(LookupColumnEntities.GetEntity("Entity")));
			}
		}

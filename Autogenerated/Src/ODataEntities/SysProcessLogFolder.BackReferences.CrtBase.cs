namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysProcessLogFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public SysProcessLogFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysProcessLogFolder";
		...
		public SysProcessLogFolder Parent {
			get {
				return _parent ??
					(_parent = new SysProcessLogFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysModuleDetailLczOld : Terrasoft.Core.Entities.Entity
	{
		...
		public SysModuleDetailLczOld(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysModuleDetailLczOld";
		...
		private SysModuleDetail _record;
		/// <summary>
		/// Record Id.
		/// </summary>
		public SysModuleDetail Record {
			get {
				return _record ??
					(_record = new SysModuleDetail(LookupColumnEntities.GetEntity("Record")));
			}
		}

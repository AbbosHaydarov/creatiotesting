namespace Terrasoft.Configuration.OData
{
	...
	public class FolderType : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<AppFormFolder> AppFormFolderCollectionByFolderType {
			get;
			set;
		}

		public IEnumerable<BankAccountFolder> BankAccountFolderCollectionByFolderType {
			get;
			set;
		}

		public IEnumerable<BankCardFolder> BankCardFolderCollectionByFolderType {
			get;
			set;
		}
		...
		public IEnumerable<FinApplicationFolder> FinApplicationFolderCollectionByFolderType {
			get;
			set;
		}

		public IEnumerable<FinIndicatorFolder> FinIndicatorFolderCollectionByFolderType {
			get;
			set;
		}

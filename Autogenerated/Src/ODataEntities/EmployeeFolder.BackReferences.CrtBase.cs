namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class EmployeeFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public EmployeeFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "EmployeeFolder";
		...
		public EmployeeFolder Parent {
			get {
				return _parent ??
					(_parent = new EmployeeFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

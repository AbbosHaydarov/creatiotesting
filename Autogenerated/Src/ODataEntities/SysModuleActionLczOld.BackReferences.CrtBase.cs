namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysModuleActionLczOld : Terrasoft.Core.Entities.Entity
	{
		...
		public SysModuleActionLczOld(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysModuleActionLczOld";
		...
		private SysModuleAction _record;
		/// <summary>
		/// Record Id.
		/// </summary>
		public SysModuleAction Record {
			get {
				return _record ??
					(_record = new SysModuleAction(LookupColumnEntities.GetEntity("Record")));
			}
		}

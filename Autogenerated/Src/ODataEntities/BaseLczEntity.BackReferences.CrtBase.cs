namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BaseLczEntity : Terrasoft.Core.Entities.Entity
	{
		...
		public BaseLczEntity(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BaseLczEntity";
		...
		public BaseLookup Record {
			get {
				return _record ??
					(_record = new BaseLookup(LookupColumnEntities.GetEntity("Record")));
			}
		}

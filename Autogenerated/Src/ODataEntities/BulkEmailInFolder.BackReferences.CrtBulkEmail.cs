namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class BulkEmailInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public BulkEmailInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "BulkEmailInFolder";
		...
		private BulkEmailFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public BulkEmailFolder Folder {
			get {
				return _folder ??
					(_folder = new BulkEmailFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

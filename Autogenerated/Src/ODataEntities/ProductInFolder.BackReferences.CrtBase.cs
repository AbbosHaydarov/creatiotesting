namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProductInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ProductInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProductInFolder";
		...
		public ProductFolder Folder {
			get {
				return _folder ??
					(_folder = new ProductFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

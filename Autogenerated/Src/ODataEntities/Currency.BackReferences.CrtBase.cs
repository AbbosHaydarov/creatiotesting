namespace Terrasoft.Configuration.OData
{
	...
	public class Currency : Terrasoft.Core.Entities.Entity
	{
		...
		public IEnumerable<BankAccount> BankAccountCollectionByCurrency {
			get;
			set;
		}

		public IEnumerable<BankCard> BankCardCollectionByCurrency {
			get;
			set;
		}
		...
		public IEnumerable<ExternalBankAccount> ExternalBankAccountCollectionByCurrency {
			get;
			set;
		}

		public IEnumerable<FinIndicator> FinIndicatorCollectionByCurrency {
			get;
			set;
		}
		...
		public IEnumerable<OpportunityProductInterest> OpportunityProductInterestCollectionByCurrency {
			get;
			set;
		}

		public IEnumerable<OpportunityProductInterest> OpportunityProductInterestCollectionByCurrencyRevenue {
			get;
			set;
		}
		...
		public IEnumerable<Transaction> TransactionCollectionByTransactionCurrency {
			get;
			set;
		}

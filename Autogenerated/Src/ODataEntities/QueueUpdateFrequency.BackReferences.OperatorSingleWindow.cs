namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class QueueUpdateFrequency : Terrasoft.Core.Entities.Entity
	{
		...
		public QueueUpdateFrequency(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "QueueUpdateFrequency";
		...
		public IEnumerable<Queue> QueueCollectionByQueueUpdateFrequency {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class WebServiceV2Folder : Terrasoft.Core.Entities.Entity
	{
		...
		public WebServiceV2Folder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "WebServiceV2Folder";
		...
		public WebServiceV2Folder Parent {
			get {
				return _parent ??
					(_parent = new WebServiceV2Folder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OrgStructureUnit : Terrasoft.Core.Entities.Entity
	{
		...
		public OrgStructureUnit(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OrgStructureUnit";
		...
		public Employee Head {
			get {
				return _head ??
					(_head = new Employee(LookupColumnEntities.GetEntity("Head")));
			}
		}
		...
		public OrgStructureUnit Parent {
			get {
				return _parent ??
					(_parent = new OrgStructureUnit(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LeadGenCampaigns : Terrasoft.Core.Entities.Entity
	{
		...
		public LeadGenCampaigns(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LeadGenCampaigns";
		...
		public IEnumerable<LeadGenExtendedLeadInformation> LeadGenExtendedLeadInformationCollectionByLeadGenCampaigns {
			get;
			set;
		}

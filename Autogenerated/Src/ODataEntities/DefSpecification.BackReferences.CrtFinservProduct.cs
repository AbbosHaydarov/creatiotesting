namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class DefSpecification : Terrasoft.Core.Entities.Entity
	{
		...
		public DefSpecification(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "DefSpecification";
		...
		public IEnumerable<ChangeCriteriaInCondition> ChangeCriteriaInConditionCollectionByVariableSpecification {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysQuerySqlText : Terrasoft.Core.Entities.Entity
	{
		...
		public SysQuerySqlText(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysQuerySqlText";
		...
		public IEnumerable<SysQueryRuleApplyLog> SysQueryRuleApplyLogCollectionBySysQuerySqlText {
			get;
			set;
		}

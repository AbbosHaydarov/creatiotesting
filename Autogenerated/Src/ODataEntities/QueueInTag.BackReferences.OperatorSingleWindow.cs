namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class QueueInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public QueueInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "QueueInTag";
		...
		public QueueTag Tag {
			get {
				return _tag ??
					(_tag = new QueueTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Queue Entity {
			get {
				return _entity ??
					(_entity = new Queue(LookupColumnEntities.GetEntity("Entity")));
			}
		}

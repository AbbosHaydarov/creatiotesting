namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AppFormProperty : Terrasoft.Core.Entities.Entity
	{
		...
		public AppFormProperty(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AppFormProperty";
		...
		public IEnumerable<SpecInAppFormProperty> SpecInAppFormPropertyCollectionByAppFormProperty {
			get;
			set;
		}
		...
		public PropertyType PropertyType {
			get {
				return _propertyType ??
					(_propertyType = new PropertyType(LookupColumnEntities.GetEntity("PropertyType")));
			}
		}

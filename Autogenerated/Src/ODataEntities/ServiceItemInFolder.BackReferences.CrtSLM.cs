namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ServiceItemInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ServiceItemInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ServiceItemInFolder";
		...
		private ServiceItemFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public ServiceItemFolder Folder {
			get {
				return _folder ??
					(_folder = new ServiceItemFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

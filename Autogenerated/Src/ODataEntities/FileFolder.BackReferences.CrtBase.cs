namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class FileFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public FileFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "FileFolder";
		...
		public FileFolder Parent {
			get {
				return _parent ??
					(_parent = new FileFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

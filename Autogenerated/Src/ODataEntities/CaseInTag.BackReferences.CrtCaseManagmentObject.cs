namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class CaseInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public CaseInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "CaseInTag";
		...
		public CaseTag Tag {
			get {
				return _tag ??
					(_tag = new CaseTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Case Entity {
			get {
				return _entity ??
					(_entity = new Case(LookupColumnEntities.GetEntity("Entity")));
			}
		}

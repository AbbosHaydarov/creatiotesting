namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class QueueStatus : Terrasoft.Core.Entities.Entity
	{
		...
		public QueueStatus(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "QueueStatus";
		...
		public IEnumerable<Queue> QueueCollectionByStatus {
			get;
			set;
		}

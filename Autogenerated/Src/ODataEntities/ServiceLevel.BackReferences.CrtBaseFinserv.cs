namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ServiceLevel : Terrasoft.Core.Entities.Entity
	{
		...
		public ServiceLevel(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ServiceLevel";
		...
		public IEnumerable<Contact> ContactCollectionByServiceLevel {
			get;
			set;
		}

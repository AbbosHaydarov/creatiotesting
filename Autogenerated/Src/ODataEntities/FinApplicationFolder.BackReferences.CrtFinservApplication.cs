namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class FinApplicationFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public FinApplicationFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "FinApplicationFolder";
		...
		public IEnumerable<FinApplicationFolder> FinApplicationFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<FinApplicationInFolder> FinApplicationInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public FinApplicationFolder Parent {
			get {
				return _parent ??
					(_parent = new FinApplicationFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysEntityOperationGrantee : Terrasoft.Core.Entities.Entity
	{
		...
		public SysEntityOperationGrantee(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysEntityOperationGrantee";
		...
		public SysEntityOperation SysEntityOperation {
			get {
				return _sysEntityOperation ??
					(_sysEntityOperation = new SysEntityOperation(LookupColumnEntities.GetEntity("SysEntityOperation")));
			}
		}

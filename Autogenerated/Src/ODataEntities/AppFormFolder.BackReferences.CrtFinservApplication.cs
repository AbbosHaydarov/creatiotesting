namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class AppFormFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public AppFormFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "AppFormFolder";
		...
		public IEnumerable<AppFormFolder> AppFormFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<AppFormInFolder> AppFormInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public AppFormFolder Parent {
			get {
				return _parent ??
					(_parent = new AppFormFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

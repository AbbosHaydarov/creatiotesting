namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class VwProcessLibFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public VwProcessLibFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "VwProcessLibFolder";
		...
		public VwProcessLibFolder Parent {
			get {
				return _parent ??
					(_parent = new VwProcessLibFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}

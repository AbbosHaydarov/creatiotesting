namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ContractInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public ContractInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ContractInTag";
		...
		private ContractTag _tag;
		/// <summary>
		/// Tag.
		/// </summary>
		public ContractTag Tag {
			get {
				return _tag ??
					(_tag = new ContractTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Contract Entity {
			get {
				return _entity ??
					(_entity = new Contract(LookupColumnEntities.GetEntity("Entity")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysPluginPackageInApp : Terrasoft.Core.Entities.Entity
	{
		...
		public SysPluginPackageInApp(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysPluginPackageInApp";
		...
		public SysPluginPackage SysPluginPackage {
			get {
				return _sysPluginPackage ??
					(_sysPluginPackage = new SysPluginPackage(LookupColumnEntities.GetEntity("SysPluginPackage")));
			}
		}

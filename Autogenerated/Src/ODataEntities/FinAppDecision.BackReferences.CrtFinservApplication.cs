namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class FinAppDecision : Terrasoft.Core.Entities.Entity
	{
		...
		public FinAppDecision(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "FinAppDecision";
		...
		public IEnumerable<FinApplication> FinApplicationCollectionByDecision {
			get;
			set;
		}

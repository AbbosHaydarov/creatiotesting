namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LookupInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public LookupInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LookupInTag";
		...
		private LookupTag _tag;
		/// <summary>
		/// Tag.
		/// </summary>
		public LookupTag Tag {
			get {
				return _tag ??
					(_tag = new LookupTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Lookup Entity {
			get {
				return _entity ??
					(_entity = new Lookup(LookupColumnEntities.GetEntity("Entity")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OAuthResource : Terrasoft.Core.Entities.Entity
	{
		...
		public OAuthResource(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OAuthResource";
		...
		public IEnumerable<OAuthResourceInClient> OAuthResourceInClientCollectionByOAuthResource {
			get;
			set;
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OpportunityProductInterest : Terrasoft.Core.Entities.Entity
	{
		...
		public OpportunityProductInterest(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OpportunityProductInterest";
		...
		public Currency CurrencyRevenue {
			get {
				return _currencyRevenue ??
					(_currencyRevenue = new Currency(LookupColumnEntities.GetEntity("CurrencyRevenue")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class LeadInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public LeadInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "LeadInFolder";
		...
		private LeadFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public LeadFolder Folder {
			get {
				return _folder ??
					(_folder = new LeadFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}

namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class SysQueryStackTrace : Terrasoft.Core.Entities.Entity
	{
		...
		public SysQueryStackTrace(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "SysQueryStackTrace";
		...
		public IEnumerable<SysQueryRuleApplyLog> SysQueryRuleApplyLogCollectionBySysQueryStackTrace {
			get;
			set;
		}

namespace Terrasoft.Configuration
{
	...
	public class Opportunity_CrtLeadOppMgmtApp_Terrasoft : Terrasoft.Configuration.Opportunity_CrtMLOpportunityScoring_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Opportunity_CrtLeadOppMgmtApp_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Opportunity_CrtLeadOppMgmtApp_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Opportunity_CrtLeadOppMgmtApp_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Opportunity_CrtLeadOppMgmtApp_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Opportunity_CrtLeadOppMgmtApp_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Opportunity_CrtLeadOppMgmtApp_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Opportunity_CrtLeadOppMgmtApp_TerrasoftValidating", e);

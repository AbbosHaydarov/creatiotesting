namespace Terrasoft.Configuration
{
	...
	public class DepartmentSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Department_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class Department : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Department_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: Department_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class Department_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : Department
	{

		public Department_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Department_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class Department_CrtCoreBaseEventsProcess : Department_CrtCoreBaseEventsProcess<Department>
	{
	...
	public partial class Department_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class DepartmentEventsProcess : Department_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TermDayType_CrtSLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : TermDayType
	{

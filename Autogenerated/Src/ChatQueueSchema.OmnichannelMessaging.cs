namespace Terrasoft.Configuration
{
	...
	#region Class: ChatQueue_OmnichannelMessaging_TerrasoftSchema

	/// <exclude/>
	public class ChatQueue_OmnichannelMessaging_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public ChatQueue_OmnichannelMessaging_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public ChatQueue_OmnichannelMessaging_TerrasoftSchema(ChatQueue_OmnichannelMessaging_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public ChatQueue_OmnichannelMessaging_TerrasoftSchema(ChatQueue_OmnichannelMessaging_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "ChatQueue_OmnichannelMessaging_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new ChatQueue_OmnichannelMessaging_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new ChatQueue_OmnichannelMessaging_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new ChatQueue_OmnichannelMessaging_TerrasoftSchema(this, true);
		}
	...
	#region Class: ChatQueue_OmnichannelMessaging_Terrasoft

	/// <summary>
	/// Chat queue.
	/// </summary>
	public class ChatQueue_OmnichannelMessaging_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public ChatQueue_OmnichannelMessaging_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "ChatQueue_OmnichannelMessaging_Terrasoft";
		}

		public ChatQueue_OmnichannelMessaging_Terrasoft(ChatQueue_OmnichannelMessaging_Terrasoft source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new ChatQueue_OmnichannelMessaging_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class ChatQueue_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ChatQueue_OmnichannelMessaging_Terrasoft
	{
	...
	/// <exclude/>
	public class ChatQueue_OmnichannelMessagingEventsProcess : ChatQueue_OmnichannelMessagingEventsProcess<ChatQueue_OmnichannelMessaging_Terrasoft>
	{

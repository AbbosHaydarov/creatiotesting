namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueFolder_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : QueueFolder
	{

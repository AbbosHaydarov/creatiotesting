namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SysModuleEntitySchema : Terrasoft.Configuration.SysModuleEntity_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Section object.
	/// </summary>
	public class SysModuleEntity : Terrasoft.Configuration.SysModuleEntity_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class SysModuleEntity_SSPEventsProcess<TEntity> : Terrasoft.Configuration.SysModuleEntity_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysModuleEntity
	{

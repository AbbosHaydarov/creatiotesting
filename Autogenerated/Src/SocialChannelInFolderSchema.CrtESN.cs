namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SocialChannelInFolder_CrtESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : SocialChannelInFolder
	{

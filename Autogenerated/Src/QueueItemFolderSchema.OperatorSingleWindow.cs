namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueItemFolder_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : QueueItemFolder
	{

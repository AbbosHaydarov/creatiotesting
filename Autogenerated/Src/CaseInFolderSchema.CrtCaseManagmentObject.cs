namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CaseInFolder_CrtCaseManagmentObjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : CaseInFolder
	{

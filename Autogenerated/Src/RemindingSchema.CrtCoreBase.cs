namespace Terrasoft.Configuration
{
	...
	#region Class: Reminding_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class Reminding_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public Reminding_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Reminding_CrtCoreBase_TerrasoftSchema(Reminding_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Reminding_CrtCoreBase_TerrasoftSchema(Reminding_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "Reminding_CrtCoreBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Reminding_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Reminding_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new Reminding_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Reminding_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: Reminding_CrtCoreBase_Terrasoft

	/// <summary>
	/// Notification.
	/// </summary>
	public class Reminding_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public Reminding_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Reminding_CrtCoreBase_Terrasoft";
		}

		public Reminding_CrtCoreBase_Terrasoft(Reminding_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Reminding_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Reminding_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Reminding_CrtCoreBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Reminding_CrtCoreBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Reminding_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Reminding_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Reminding_CrtCoreBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Reminding_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new Reminding_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: Reminding_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class Reminding_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Reminding_CrtCoreBase_Terrasoft
	{

		public Reminding_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Reminding_CrtCoreBaseEventsProcess";
		...
		public override void ThrowEvent(ProcessExecutingContext context, string message) {
			switch(message) {
					...
					case "Reminding_CrtCoreBase_TerrasoftInserting":
						...
						break;
					case "Reminding_CrtCoreBase_TerrasoftSaving":
	...
	/// <exclude/>
	public class Reminding_CrtCoreBaseEventsProcess : Reminding_CrtCoreBaseEventsProcess<Reminding_CrtCoreBase_Terrasoft>
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailCategory_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BulkEmailCategory
	{

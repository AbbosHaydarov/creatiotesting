namespace Terrasoft.Configuration
{
	...
	public class SysPackageSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("82f9024b-af44-b6d4-1ade-6dbcb1d730e2")) == null) {
				Columns.Add(CreateHierarchyLevelColumn());
			}
		}
		...
		protected virtual EntitySchemaColumn CreateHierarchyLevelColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Integer")) {
				UId = new Guid("82f9024b-af44-b6d4-1ade-6dbcb1d730e2"),
				Name = @"HierarchyLevel",
				CreatedInSchemaUId = new Guid("ca400a85-ec48-4b42-8e50-271929d27871"),
				ModifiedInSchemaUId = new Guid("ca400a85-ec48-4b42-8e50-271929d27871"),
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysPackage_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysPackage : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysPackage_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysPackage_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysPackage_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysPackage
	{

		public SysPackage_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysPackage_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysPackage_CrtCoreBaseEventsProcess : SysPackage_CrtCoreBaseEventsProcess<SysPackage>
	{
	...
	public partial class SysPackage_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysPackageEventsProcess : SysPackage_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Territory_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : Territory
	{

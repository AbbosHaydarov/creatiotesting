namespace Terrasoft.Configuration
{
	...
	#region Class: VwProcessLib_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class VwProcessLib_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.VwSysSchemaInWorkspaceSchema
	{

		#region Constructors: Public

		public VwProcessLib_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public VwProcessLib_CrtCoreBase_TerrasoftSchema(VwProcessLib_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public VwProcessLib_CrtCoreBase_TerrasoftSchema(VwProcessLib_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "VwProcessLib_CrtCoreBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new VwProcessLib_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new VwProcessLib_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new VwProcessLib_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new VwProcessLib_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: VwProcessLib_CrtCoreBase_Terrasoft

	/// <summary>
	/// Process library (view).
	/// </summary>
	public class VwProcessLib_CrtCoreBase_Terrasoft : Terrasoft.Configuration.VwSysSchemaInWorkspace
	{

		#region Constructors: Public

		public VwProcessLib_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "VwProcessLib_CrtCoreBase_Terrasoft";
		}

		public VwProcessLib_CrtCoreBase_Terrasoft(VwProcessLib_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new VwProcessLib_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("VwProcessLib_CrtCoreBase_TerrasoftDeleted", e);
			Inserting += (s, e) => ThrowEvent("VwProcessLib_CrtCoreBase_TerrasoftInserting", e);
			Validating += (s, e) => ThrowEvent("VwProcessLib_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new VwProcessLib_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: VwProcessLib_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class VwProcessLib_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.VwSysSchemaInWorkspace_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwProcessLib_CrtCoreBase_Terrasoft
	{

		public VwProcessLib_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "VwProcessLib_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class VwProcessLib_CrtCoreBaseEventsProcess : VwProcessLib_CrtCoreBaseEventsProcess<VwProcessLib_CrtCoreBase_Terrasoft>
	{
	...
	public partial class VwProcessLib_CrtCoreBaseEventsProcess<TEntity>
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class TouchActionTypeSchema : Terrasoft.Configuration.TouchActionType_CrtGoogleAnalytics_TerrasoftSchema
	{
	...
	/// Web action type.
	/// </summary>
	public class TouchActionType : Terrasoft.Configuration.TouchActionType_CrtGoogleAnalytics_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("TouchActionTypeDeleted", e);
			Deleting += (s, e) => ThrowEvent("TouchActionTypeDeleting", e);
			Inserted += (s, e) => ThrowEvent("TouchActionTypeInserted", e);
			Inserting += (s, e) => ThrowEvent("TouchActionTypeInserting", e);
			Saved += (s, e) => ThrowEvent("TouchActionTypeSaved", e);
			Saving += (s, e) => ThrowEvent("TouchActionTypeSaving", e);
			Validating += (s, e) => ThrowEvent("TouchActionTypeValidating", e);
	...
	/// <exclude/>
	public partial class TouchActionType_CrtMatomoConnectorEventsProcess<TEntity> : Terrasoft.Configuration.TouchActionType_CrtGoogleAnalyticsEventsProcess<TEntity> where TEntity : TouchActionType
	{

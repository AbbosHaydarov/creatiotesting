namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSSPSysAdminUnit_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSSPSysAdminUnit
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventTeamRoles_CrtEventEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : EventTeamRoles
	{

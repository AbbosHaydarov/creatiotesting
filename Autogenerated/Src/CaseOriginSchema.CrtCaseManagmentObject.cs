namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CaseOrigin_CrtCaseManagmentObjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CaseOrigin
	{

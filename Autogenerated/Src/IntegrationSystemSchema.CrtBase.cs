namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class IntegrationSystem_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : IntegrationSystem
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Contact_SSPEventsProcess<TEntity> : Terrasoft.Configuration.Contact_CompletenessEventsProcess<TEntity> where TEntity : Contact_SSP_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	public class CampaignInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CampaignInTag_CrtCampaignEventsProcess(userConnection);
		}
	...
	public class CampaignInTag : Terrasoft.Configuration.BaseEntityInTag
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new CampaignInTag_CrtCampaignEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("CampaignInTagDeleting", e);
			Inserted += (s, e) => ThrowEvent("CampaignInTagInserted", e);
			Inserting += (s, e) => ThrowEvent("CampaignInTagInserting", e);
			Saved += (s, e) => ThrowEvent("CampaignInTagSaved", e);
			Saving += (s, e) => ThrowEvent("CampaignInTagSaving", e);
	...
	#region Class: CampaignInTag_CrtCampaignEventsProcess

	/// <exclude/>
	public partial class CampaignInTag_CrtCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : CampaignInTag
	{

		public CampaignInTag_CrtCampaignEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "CampaignInTag_CrtCampaignEventsProcess";
	...
	/// <exclude/>
	public class CampaignInTag_CrtCampaignEventsProcess : CampaignInTag_CrtCampaignEventsProcess<CampaignInTag>
	{
	...
	public partial class CampaignInTag_CrtCampaignEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class CampaignInTagEventsProcess : CampaignInTag_CrtCampaignEventsProcess
	{

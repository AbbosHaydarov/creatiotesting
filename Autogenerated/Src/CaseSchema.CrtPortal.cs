namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Case_CrtPortal_TerrasoftSchema : Terrasoft.Configuration.Case_CrtCaseManagement_TerrasoftSchema
	{
	...
	/// Case.
	/// </summary>
	public class Case_CrtPortal_Terrasoft : Terrasoft.Configuration.Case_CrtCaseManagement_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Inserted += (s, e) => ThrowEvent("Case_CrtPortal_TerrasoftInserted", e);
			...
			Validating += (s, e) => ThrowEvent("Case_CrtPortal_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Case_CrtPortalEventsProcess<TEntity> : Terrasoft.Configuration.Case_CrtCaseManagementEventsProcess<TEntity> where TEntity : Case_CrtPortal_Terrasoft
	{

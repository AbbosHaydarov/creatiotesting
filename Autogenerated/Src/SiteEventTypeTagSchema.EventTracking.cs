namespace Terrasoft.Configuration
{
	...
	public class SiteEventTypeTag : Terrasoft.Configuration.BaseTag
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("SiteEventTypeTagDeleting", e);
			Inserted += (s, e) => ThrowEvent("SiteEventTypeTagInserted", e);
			Inserting += (s, e) => ThrowEvent("SiteEventTypeTagInserting", e);
			Saved += (s, e) => ThrowEvent("SiteEventTypeTagSaved", e);
			Saving += (s, e) => ThrowEvent("SiteEventTypeTagSaving", e);

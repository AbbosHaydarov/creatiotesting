namespace Terrasoft.Configuration
{
	...
	public class EventInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EventInFolder_CrtEventEventsProcess(userConnection);
		}
	...
	public class EventInFolder : Terrasoft.Configuration.BaseItemInFolder
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new EventInFolder_CrtEventEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: EventInFolder_CrtEventEventsProcess

	/// <exclude/>
	public partial class EventInFolder_CrtEventEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : EventInFolder
	{

		public EventInFolder_CrtEventEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "EventInFolder_CrtEventEventsProcess";
	...
	/// <exclude/>
	public class EventInFolder_CrtEventEventsProcess : EventInFolder_CrtEventEventsProcess<EventInFolder>
	{
	...
	public partial class EventInFolder_CrtEventEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class EventInFolderEventsProcess : EventInFolder_CrtEventEventsProcess
	{

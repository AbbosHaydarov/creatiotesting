namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class RelationType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : RelationType_CrtBase_Terrasoft
	{

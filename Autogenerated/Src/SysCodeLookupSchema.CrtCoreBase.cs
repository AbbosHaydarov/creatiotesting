namespace Terrasoft.Configuration
{
	...
	public class SysCodeLookupSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysCodeLookup_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysCodeLookup : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysCodeLookup_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysCodeLookup_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysCodeLookup_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysCodeLookup
	{

		public SysCodeLookup_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysCodeLookup_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysCodeLookup_CrtCoreBaseEventsProcess : SysCodeLookup_CrtCoreBaseEventsProcess<SysCodeLookup>
	{
	...
	public partial class SysCodeLookup_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysCodeLookupEventsProcess : SysCodeLookup_CrtCoreBaseEventsProcess
	{

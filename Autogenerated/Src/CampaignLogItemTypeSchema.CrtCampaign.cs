namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignLogItemType_CrtCampaignEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CampaignLogItemType
	{

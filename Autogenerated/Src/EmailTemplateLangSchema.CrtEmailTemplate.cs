namespace Terrasoft.Configuration
{
	...
	public class EmailTemplateLangSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EmailTemplateLang_CrtEmailTemplateEventsProcess(userConnection);
		}
	...
	public class EmailTemplateLang : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new EmailTemplateLang_CrtEmailTemplateEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: EmailTemplateLang_CrtEmailTemplateEventsProcess

	/// <exclude/>
	public partial class EmailTemplateLang_CrtEmailTemplateEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : EmailTemplateLang
	{

		public EmailTemplateLang_CrtEmailTemplateEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "EmailTemplateLang_CrtEmailTemplateEventsProcess";
	...
	/// <exclude/>
	public class EmailTemplateLang_CrtEmailTemplateEventsProcess : EmailTemplateLang_CrtEmailTemplateEventsProcess<EmailTemplateLang>
	{
	...
	public partial class EmailTemplateLang_CrtEmailTemplateEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class EmailTemplateLangEventsProcess : EmailTemplateLang_CrtEmailTemplateEventsProcess
	{

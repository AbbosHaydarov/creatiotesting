namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwWebServiceV2_ServiceDesignerEventsProcess<TEntity> : Terrasoft.Configuration.VwSysSchemaInWorkspace_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwWebServiceV2
	{

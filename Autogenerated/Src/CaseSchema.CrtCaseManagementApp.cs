namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Case_CrtCaseManagementApp_TerrasoftSchema : Terrasoft.Configuration.Case_CrtSLMITILService_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateSymptomsColumn() {
			EntitySchemaColumn column = base.CreateSymptomsColumn();
	...
	/// Case.
	/// </summary>
	public class Case_CrtCaseManagementApp_Terrasoft : Terrasoft.Configuration.Case_CrtSLMITILService_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Case_CrtCaseManagementApp_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Case_CrtCaseManagementApp_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Case_CrtCaseManagementApp_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Case_CrtCaseManagementApp_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Case_CrtCaseManagementApp_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Case_CrtCaseManagementApp_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Case_CrtCaseManagementApp_TerrasoftValidating", e);
			DefColumnValuesSet += (s, e) => ThrowEvent("Case_CrtCaseManagementApp_TerrasoftDefColumnValuesSet", e);
	...
	/// <exclude/>
	public partial class Case_CrtCaseManagementAppEventsProcess<TEntity> : Terrasoft.Configuration.Case_CrtSLMITILServiceEventsProcess<TEntity> where TEntity : Case_CrtCaseManagementApp_Terrasoft
	{

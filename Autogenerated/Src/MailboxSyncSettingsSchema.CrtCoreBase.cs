namespace Terrasoft.Configuration
{
	...
	#region Class: MailboxSyncSettings_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class MailboxSyncSettings_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public MailboxSyncSettings_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public MailboxSyncSettings_CrtCoreBase_TerrasoftSchema(MailboxSyncSettings_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public MailboxSyncSettings_CrtCoreBase_TerrasoftSchema(MailboxSyncSettings_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "MailboxSyncSettings_CrtCoreBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new MailboxSyncSettings_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new MailboxSyncSettings_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new MailboxSyncSettings_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new MailboxSyncSettings_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: MailboxSyncSettings_CrtCoreBase_Terrasoft

	/// <summary>
	/// Mailbox synchronization settings.
	/// </summary>
	public class MailboxSyncSettings_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public MailboxSyncSettings_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "MailboxSyncSettings_CrtCoreBase_Terrasoft";
		}

		public MailboxSyncSettings_CrtCoreBase_Terrasoft(MailboxSyncSettings_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new MailboxSyncSettings_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("MailboxSyncSettings_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("MailboxSyncSettings_CrtCoreBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("MailboxSyncSettings_CrtCoreBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("MailboxSyncSettings_CrtCoreBase_TerrasoftInserting", e);
			Loaded += (s, e) => ThrowEvent("MailboxSyncSettings_CrtCoreBase_TerrasoftLoaded", e);
			Saved += (s, e) => ThrowEvent("MailboxSyncSettings_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("MailboxSyncSettings_CrtCoreBase_TerrasoftSaving", e);
			Updated += (s, e) => ThrowEvent("MailboxSyncSettings_CrtCoreBase_TerrasoftUpdated", e);
			Validating += (s, e) => ThrowEvent("MailboxSyncSettings_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new MailboxSyncSettings_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: MailboxSyncSettings_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class MailboxSyncSettings_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : MailboxSyncSettings_CrtCoreBase_Terrasoft
	{

		public MailboxSyncSettings_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "MailboxSyncSettings_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class MailboxSyncSettings_CrtCoreBaseEventsProcess : MailboxSyncSettings_CrtCoreBaseEventsProcess<MailboxSyncSettings_CrtCoreBase_Terrasoft>
	{

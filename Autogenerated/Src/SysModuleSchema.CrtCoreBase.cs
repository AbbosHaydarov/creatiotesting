namespace Terrasoft.Configuration
{
	...
	public class SysModuleSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysModule_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysModule : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysModule_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysModule_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysModule_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModule
	{

		public SysModule_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysModule_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysModule_CrtCoreBaseEventsProcess : SysModule_CrtCoreBaseEventsProcess<SysModule>
	{
	...
	public partial class SysModule_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysModuleEventsProcess : SysModule_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysLookup_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSysLookup
	{

namespace Terrasoft.Configuration
{
	...
	public class MessageTemplateTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new MessageTemplateType_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class MessageTemplateType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new MessageTemplateType_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: MessageTemplateType_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class MessageTemplateType_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : MessageTemplateType
	{

		public MessageTemplateType_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "MessageTemplateType_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class MessageTemplateType_CrtCoreBaseEventsProcess : MessageTemplateType_CrtCoreBaseEventsProcess<MessageTemplateType>
	{
	...
	public partial class MessageTemplateType_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class MessageTemplateTypeEventsProcess : MessageTemplateType_CrtCoreBaseEventsProcess
	{

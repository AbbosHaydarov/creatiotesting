namespace Terrasoft.Configuration
{
	...
	#region Class: BaseTag_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	[IsVirtual]
	public class BaseTag_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public BaseTag_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public BaseTag_CrtCoreBase_TerrasoftSchema(BaseTag_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public BaseTag_CrtCoreBase_TerrasoftSchema(BaseTag_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "BaseTag_CrtCoreBase_Terrasoft";
		...
		protected virtual EntitySchemaColumn CreateColorColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Color")) {
				UId = new Guid("cf1a3343-0b78-669a-e5fe-48cf8a054e1a"),
				Name = @"Color",
				CreatedInSchemaUId = new Guid("9e3f203c-e905-4de5-9468-335b193f2439"),
				ModifiedInSchemaUId = new Guid("9e3f203c-e905-4de5-9468-335b193f2439"),
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new BaseTag_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BaseTag_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new BaseTag_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new BaseTag_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: BaseTag_CrtCoreBase_Terrasoft

	/// <summary>
	/// Base tag.
	/// </summary>
	public class BaseTag_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public BaseTag_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "BaseTag_CrtCoreBase_Terrasoft";
		}

		public BaseTag_CrtCoreBase_Terrasoft(BaseTag_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new BaseTag_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("BaseTag_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("BaseTag_CrtCoreBase_TerrasoftDeleting", e);
			Inserting += (s, e) => ThrowEvent("BaseTag_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("BaseTag_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("BaseTag_CrtCoreBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("BaseTag_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new BaseTag_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: BaseTag_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class BaseTag_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BaseTag_CrtCoreBase_Terrasoft
	{

		public BaseTag_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "BaseTag_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class BaseTag_CrtCoreBaseEventsProcess : BaseTag_CrtCoreBaseEventsProcess<BaseTag_CrtCoreBase_Terrasoft>
	{

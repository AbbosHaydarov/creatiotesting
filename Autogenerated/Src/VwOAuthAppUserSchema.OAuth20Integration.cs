namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwOAuthAppUser_OAuth20IntegrationEventsProcess<TEntity> : Terrasoft.Configuration.OAuthTokenStorage_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwOAuthAppUser
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_CrtLeadOppMgmtApp_TerrasoftSchema : Terrasoft.Configuration.Lead_CoreLead_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateStatusColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("408b733a-332d-4fc7-a91d-6b37ecb1472e");
	...
	/// Lead.
	/// </summary>
	public class Lead_CrtLeadOppMgmtApp_Terrasoft : Terrasoft.Configuration.Lead_CoreLead_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Lead_CrtLeadOppMgmtApp_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Lead_CrtLeadOppMgmtApp_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Lead_CrtLeadOppMgmtApp_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Lead_CrtLeadOppMgmtApp_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Lead_CrtLeadOppMgmtApp_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Lead_CrtLeadOppMgmtApp_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Lead_CrtLeadOppMgmtApp_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Lead_CrtLeadOppMgmtAppEventsProcess<TEntity> : Terrasoft.Configuration.Lead_CoreLeadEventsProcess<TEntity> where TEntity : Lead_CrtLeadOppMgmtApp_Terrasoft
	{

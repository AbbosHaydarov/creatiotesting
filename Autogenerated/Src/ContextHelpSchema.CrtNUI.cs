namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContextHelp_CrtNUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ContextHelp
	{

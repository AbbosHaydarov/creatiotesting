namespace Terrasoft.Configuration
{
	...
	public class SysPrcHistoryLog : Terrasoft.Configuration.SysProcessLog
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("SysPrcHistoryLogDeleting", e);
			Inserted += (s, e) => ThrowEvent("SysPrcHistoryLogInserted", e);
			Saved += (s, e) => ThrowEvent("SysPrcHistoryLogSaved", e);
			Saving += (s, e) => ThrowEvent("SysPrcHistoryLogSaving", e);
	...
	/// <exclude/>
	public partial class SysPrcHistoryLog_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.SysProcessLog_CrtBaseEventsProcess<TEntity> where TEntity : SysPrcHistoryLog
	{

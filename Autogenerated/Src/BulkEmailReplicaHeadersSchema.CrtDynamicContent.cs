namespace Terrasoft.Configuration
{
	...
	public class BulkEmailReplicaHeadersSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BulkEmailReplicaHeaders_CrtDynamicContentEventsProcess(userConnection);
		}
	...
	public class BulkEmailReplicaHeaders : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new BulkEmailReplicaHeaders_CrtDynamicContentEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: BulkEmailReplicaHeaders_CrtDynamicContentEventsProcess

	/// <exclude/>
	public partial class BulkEmailReplicaHeaders_CrtDynamicContentEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BulkEmailReplicaHeaders
	{

		public BulkEmailReplicaHeaders_CrtDynamicContentEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "BulkEmailReplicaHeaders_CrtDynamicContentEventsProcess";
	...
	/// <exclude/>
	public class BulkEmailReplicaHeaders_CrtDynamicContentEventsProcess : BulkEmailReplicaHeaders_CrtDynamicContentEventsProcess<BulkEmailReplicaHeaders>
	{
	...
	public partial class BulkEmailReplicaHeaders_CrtDynamicContentEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class BulkEmailReplicaHeadersEventsProcess : BulkEmailReplicaHeaders_CrtDynamicContentEventsProcess
	{

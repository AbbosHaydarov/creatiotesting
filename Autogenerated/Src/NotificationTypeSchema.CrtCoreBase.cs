namespace Terrasoft.Configuration
{
	...
	public class NotificationTypeSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new NotificationType_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class NotificationType : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new NotificationType_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: NotificationType_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class NotificationType_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : NotificationType
	{

		public NotificationType_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "NotificationType_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class NotificationType_CrtCoreBaseEventsProcess : NotificationType_CrtCoreBaseEventsProcess<NotificationType>
	{
	...
	public partial class NotificationType_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class NotificationTypeEventsProcess : NotificationType_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebServiceV2File_ServiceDesignerEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : WebServiceV2File
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ReferrerName_CrtWebTrackingBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ReferrerName
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueItemStatus_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : QueueItemStatus
	{

namespace Terrasoft.Configuration
{
	...
	public class EmailMessageDataSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		private EntitySchemaIndex CreateInReplyTo_ParentMessageId_IdIndex() {
			EntitySchemaIndex index = new EntitySchemaIndex() {
				IsAutoName = false,
				IsClustered = false,
				IsUnique = false
			};
			index.UId = new Guid("a1fded2a-6a6c-4066-96fa-400b8c050099");
			index.Name = "InReplyTo_ParentMessageId_Id";
			index.CreatedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c");
			index.ModifiedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c");
			index.CreatedInPackageId = new Guid("95a133a1-cd5f-4df8-af8f-ad440775d7d1");
			EntitySchemaIndexColumn inReplyToIndexColumn = new EntitySchemaIndexColumn() {
				UId = new Guid("6c8a2691-1771-cac8-5b25-4f41d133f14f"),
				ColumnUId = new Guid("9b6128d9-24ed-44ce-afaf-3d9588221b50"),
				CreatedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				ModifiedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
			...
			index.Columns.Add(inReplyToIndexColumn);
			EntitySchemaIndexColumn parentMessageIdIndexColumn = new EntitySchemaIndexColumn() {
				UId = new Guid("bcd36aa4-a0e1-ad91-6d6b-d43653d7b331"),
				ColumnUId = new Guid("324cddd2-7eab-4838-9bb8-4d2eac6f84ad"),
				CreatedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				ModifiedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				CreatedInPackageId = new Guid("95a133a1-cd5f-4df8-af8f-ad440775d7d1"),
			...
			index.Columns.Add(parentMessageIdIndexColumn);
			EntitySchemaIndexColumn idIndexColumn = new EntitySchemaIndexColumn() {
				UId = new Guid("34360567-ed87-7373-e6cf-e643f01c0950"),
				ColumnUId = new Guid("ae0e45ca-c495-4fe7-a39d-3ab7278e1617"),
				CreatedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				ModifiedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				CreatedInPackageId = new Guid("95a133a1-cd5f-4df8-af8f-ad440775d7d1"),
		...
		private EntitySchemaIndex CreateConversationId_ActivityIdIndex() {
			EntitySchemaIndex index = new EntitySchemaIndex() {
				IsAutoName = false,
				IsClustered = false,
				IsUnique = false
			};
			index.UId = new Guid("427e84b2-21d1-4f81-b84a-f935b96c26d1");
			index.Name = "ConversationId_ActivityId";
			index.CreatedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c");
			index.ModifiedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c");
			index.CreatedInPackageId = new Guid("95a133a1-cd5f-4df8-af8f-ad440775d7d1");
			EntitySchemaIndexColumn conversationIdIndexColumn = new EntitySchemaIndexColumn() {
				UId = new Guid("e8299e96-3f32-ca95-5a37-7c0effc9c31e"),
				ColumnUId = new Guid("7ca7d624-5624-4414-8146-54d95b54e851"),
				CreatedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				ModifiedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				CreatedInPackageId = new Guid("95a133a1-cd5f-4df8-af8f-ad440775d7d1"),
				OrderDirection = OrderDirectionStrict.Ascending
			};
			index.Columns.Add(conversationIdIndexColumn);
			EntitySchemaIndexColumn activityIdIndexColumn = new EntitySchemaIndexColumn() {
				UId = new Guid("3a7055ae-38d4-c3ae-355c-c48e260355ae"),
				ColumnUId = new Guid("593747ea-b4c5-497b-8f1e-0aecc9ba023b"),
				CreatedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				ModifiedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				CreatedInPackageId = new Guid("95a133a1-cd5f-4df8-af8f-ad440775d7d1"),
		...
		private EntitySchemaIndex CreateMailboxSyncSettings_SendDateIndex() {
			EntitySchemaIndex index = new EntitySchemaIndex() {
				IsAutoName = false,
				IsClustered = false,
				IsUnique = false
			};
			index.UId = new Guid("61086d00-32da-4252-9899-58fac1c847dc");
			index.Name = "MailboxSyncSettings_SendDate";
			index.CreatedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c");
			index.ModifiedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c");
			index.CreatedInPackageId = new Guid("95a133a1-cd5f-4df8-af8f-ad440775d7d1");
			EntitySchemaIndexColumn mailboxSyncSettingsIndexColumn = new EntitySchemaIndexColumn() {
				UId = new Guid("81e00b4a-ea5e-e162-ce9b-e477c850fdbe"),
				ColumnUId = new Guid("d72d0bdd-f8f8-4a18-8812-fcd128bce85a"),
				CreatedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				ModifiedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				CreatedInPackageId = new Guid("95a133a1-cd5f-4df8-af8f-ad440775d7d1"),
				OrderDirection = OrderDirectionStrict.Ascending
			};
			index.Columns.Add(mailboxSyncSettingsIndexColumn);
			EntitySchemaIndexColumn sendDateIndexColumn = new EntitySchemaIndexColumn() {
				UId = new Guid("055d05fc-f6ba-def8-d9b2-10df79900331"),
				ColumnUId = new Guid("f8b6d415-7b35-4c3d-ab55-97f05f811d5c"),
				CreatedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				ModifiedInSchemaUId = new Guid("d586ebed-2570-4fc6-89b5-88f55402e04c"),
				CreatedInPackageId = new Guid("95a133a1-cd5f-4df8-af8f-ad440775d7d1"),
				OrderDirection = OrderDirectionStrict.Ascending
		...
		protected override void InitializeIndexes() {
			...
			Indexes.Add(CreateInReplyTo_ParentMessageId_IdIndex());
			Indexes.Add(CreateConversationId_ActivityIdIndex());
			Indexes.Add(CreateMailboxSyncSettings_SendDateIndex());
		}

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContractFolder_CrtContractEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ContractFolder
	{

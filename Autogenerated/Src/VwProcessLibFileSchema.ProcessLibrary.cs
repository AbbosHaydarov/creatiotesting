namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwProcessLibFile_ProcessLibraryEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : VwProcessLibFile
	{

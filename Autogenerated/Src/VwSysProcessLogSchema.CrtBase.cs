namespace Terrasoft.Configuration
{
	...
	public class VwSysProcessLog : Terrasoft.Configuration.SysProcessLog
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("VwSysProcessLogDeleting", e);
			Inserted += (s, e) => ThrowEvent("VwSysProcessLogInserted", e);
			Saved += (s, e) => ThrowEvent("VwSysProcessLogSaved", e);
			Saving += (s, e) => ThrowEvent("VwSysProcessLogSaving", e);
	...
	/// <exclude/>
	public partial class VwSysProcessLog_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.SysProcessLog_CrtBaseEventsProcess<TEntity> where TEntity : VwSysProcessLog
	{

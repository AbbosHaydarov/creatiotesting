namespace Terrasoft.Configuration
{
	...
	public class VwFolderInCampaignSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new VwFolderInCampaign_CrtCampaignEventsProcess(userConnection);
		}
	...
	public class VwFolderInCampaign : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new VwFolderInCampaign_CrtCampaignEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: VwFolderInCampaign_CrtCampaignEventsProcess

	/// <exclude/>
	public partial class VwFolderInCampaign_CrtCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwFolderInCampaign
	{

		public VwFolderInCampaign_CrtCampaignEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "VwFolderInCampaign_CrtCampaignEventsProcess";
	...
	/// <exclude/>
	public class VwFolderInCampaign_CrtCampaignEventsProcess : VwFolderInCampaign_CrtCampaignEventsProcess<VwFolderInCampaign>
	{
	...
	public partial class VwFolderInCampaign_CrtCampaignEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class VwFolderInCampaignEventsProcess : VwFolderInCampaign_CrtCampaignEventsProcess
	{

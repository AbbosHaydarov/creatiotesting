namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProductTypeInLeadType_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ProductTypeInLeadType
	{

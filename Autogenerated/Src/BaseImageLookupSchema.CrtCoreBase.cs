namespace Terrasoft.Configuration
{
	...
	public class BaseImageLookupSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BaseImageLookup_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class BaseImageLookup : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new BaseImageLookup_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: BaseImageLookup_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class BaseImageLookup_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BaseImageLookup
	{

		public BaseImageLookup_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "BaseImageLookup_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class BaseImageLookup_CrtCoreBaseEventsProcess : BaseImageLookup_CrtCoreBaseEventsProcess<BaseImageLookup>
	{
	...
	public partial class BaseImageLookup_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class BaseImageLookupEventsProcess : BaseImageLookup_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysProcessDisabled_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysProcessDisabled
	{

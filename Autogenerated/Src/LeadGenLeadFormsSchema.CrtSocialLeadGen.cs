namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenLeadForms_CrtSocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LeadGenLeadForms
	{

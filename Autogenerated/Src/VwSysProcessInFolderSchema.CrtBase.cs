namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysProcessInFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSysProcessInFolder
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadTypeDetails_CrtLeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LeadTypeDetails
	{

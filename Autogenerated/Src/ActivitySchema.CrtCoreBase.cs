namespace Terrasoft.Configuration
{
	...
	#region Class: Activity_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class Activity_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public Activity_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Activity_CrtCoreBase_TerrasoftSchema(Activity_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Activity_CrtCoreBase_TerrasoftSchema(Activity_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "Activity_CrtCoreBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Activity_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Activity_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new Activity_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Activity_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: Activity_CrtCoreBase_Terrasoft

	/// <summary>
	/// Activity.
	/// </summary>
	public class Activity_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public Activity_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Activity_CrtCoreBase_Terrasoft";
		}

		public Activity_CrtCoreBase_Terrasoft(Activity_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Activity_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Activity_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Activity_CrtCoreBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Activity_CrtCoreBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Activity_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Activity_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Activity_CrtCoreBase_TerrasoftSaving", e);
			Updated += (s, e) => ThrowEvent("Activity_CrtCoreBase_TerrasoftUpdated", e);
			Validating += (s, e) => ThrowEvent("Activity_CrtCoreBase_TerrasoftValidating", e);
			DefColumnValuesSet += (s, e) => ThrowEvent("Activity_CrtCoreBase_TerrasoftDefColumnValuesSet", e);
		...
		public override object Clone() {
			return new Activity_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: Activity_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class Activity_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Activity_CrtCoreBase_Terrasoft
	{
		...
		public class SynchronizeSubjectRemindingOwnerFlowElement : SynchronizeSubjectRemindingUserTask
		{
			...
			public SynchronizeSubjectRemindingOwnerFlowElement(UserConnection userConnection, Activity_CrtCoreBaseEventsProcess<TEntity> process)
				: base(userConnection) {
				UId = Guid.NewGuid();
				Owner = process;
		...
		public class SynchronizeSubjectRemindingAuthorFlowElement : SynchronizeSubjectRemindingUserTask
		{
			...
			public SynchronizeSubjectRemindingAuthorFlowElement(UserConnection userConnection, Activity_CrtCoreBaseEventsProcess<TEntity> process)
				: base(userConnection) {
				UId = Guid.NewGuid();
				Owner = process;
				Type = "ProcessSchemaUserTask";
		...
		public Activity_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Activity_CrtCoreBaseEventsProcess";
		...
		public override void ThrowEvent(ProcessExecutingContext context, string message) {
			switch(message) {
					...
					case "Activity_CrtCoreBase_TerrasoftUpdated":
						...
						break;
					case "Activity_CrtCoreBase_TerrasoftValidating":
	...
	/// <exclude/>
	public class Activity_CrtCoreBaseEventsProcess : Activity_CrtCoreBaseEventsProcess<Activity_CrtCoreBase_Terrasoft>
	{

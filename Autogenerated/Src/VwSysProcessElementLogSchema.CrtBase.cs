namespace Terrasoft.Configuration
{
	...
	public class VwSysProcessElementLog : Terrasoft.Configuration.SysBasePrcElLog
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("VwSysProcessElementLogDeleting", e);
			Inserted += (s, e) => ThrowEvent("VwSysProcessElementLogInserted", e);
			Inserting += (s, e) => ThrowEvent("VwSysProcessElementLogInserting", e);
			Saved += (s, e) => ThrowEvent("VwSysProcessElementLogSaved", e);
			Saving += (s, e) => ThrowEvent("VwSysProcessElementLogSaving", e);
			Validating += (s, e) => ThrowEvent("VwSysProcessElementLogValidating", e);

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContactFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ContactFolder_CrtBase_Terrasoft
	{

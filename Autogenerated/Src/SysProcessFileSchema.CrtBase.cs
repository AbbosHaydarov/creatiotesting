namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysProcessFile_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : SysProcessFile
	{

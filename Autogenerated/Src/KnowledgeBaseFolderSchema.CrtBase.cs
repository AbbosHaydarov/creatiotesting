namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class KnowledgeBaseFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : KnowledgeBaseFolder
	{

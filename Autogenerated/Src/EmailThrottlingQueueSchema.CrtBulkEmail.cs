namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailThrottlingQueue_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : EmailThrottlingQueue
	{

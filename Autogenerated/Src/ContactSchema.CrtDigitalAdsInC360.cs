namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Contact_CrtDigitalAdsInC360_TerrasoftSchema : Terrasoft.Configuration.Contact_Lead_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateNameColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("fbb0369e-af5f-484e-bb62-ba08c5b82a69");
	...
	/// Contact.
	/// </summary>
	public class Contact_CrtDigitalAdsInC360_Terrasoft : Terrasoft.Configuration.Contact_Lead_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Contact_CrtDigitalAdsInC360_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Contact_CrtDigitalAdsInC360_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Contact_CrtDigitalAdsInC360_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Contact_CrtDigitalAdsInC360_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Contact_CrtDigitalAdsInC360_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Contact_CrtDigitalAdsInC360_TerrasoftSaving", e);
			Updating += (s, e) => ThrowEvent("Contact_CrtDigitalAdsInC360_TerrasoftUpdating", e);
			Validating += (s, e) => ThrowEvent("Contact_CrtDigitalAdsInC360_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Contact_CrtDigitalAdsInC360EventsProcess<TEntity> : Terrasoft.Configuration.Contact_LeadEventsProcess<TEntity> where TEntity : Contact_CrtDigitalAdsInC360_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	public class SysModuleFolderSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysModuleFolder_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysModuleFolder : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysModuleFolder_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysModuleFolder_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysModuleFolder_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleFolder
	{

		public SysModuleFolder_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysModuleFolder_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysModuleFolder_CrtCoreBaseEventsProcess : SysModuleFolder_CrtCoreBaseEventsProcess<SysModuleFolder>
	{
	...
	public partial class SysModuleFolder_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysModuleFolderEventsProcess : SysModuleFolder_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysDcmLibFolder_DcmDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSysDcmLibFolder
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ConnectionType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ConnectionType
	{

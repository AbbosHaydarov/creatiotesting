namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Contact_RelationshipDesigner_TerrasoftSchema : Terrasoft.Configuration.Contact_CrtMobile7x_TerrasoftSchema
	{
	...
	/// Contact.
	/// </summary>
	public class Contact_RelationshipDesigner_Terrasoft : Terrasoft.Configuration.Contact_CrtMobile7x_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Contact_RelationshipDesignerEventsProcess<TEntity> : Terrasoft.Configuration.Contact_CrtMobile7xEventsProcess<TEntity> where TEntity : Contact_RelationshipDesigner_Terrasoft
	{

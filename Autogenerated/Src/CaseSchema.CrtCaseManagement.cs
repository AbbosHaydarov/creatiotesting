namespace Terrasoft.Configuration
{
	...
	#region Class: Case_CrtCaseManagement_TerrasoftSchema

	/// <exclude/>
	public class Case_CrtCaseManagement_TerrasoftSchema : Terrasoft.Configuration.Case_CrtCaseManagmentObject_TerrasoftSchema
	{

		#region Constructors: Public

		public Case_CrtCaseManagement_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Case_CrtCaseManagement_TerrasoftSchema(Case_CrtCaseManagement_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Case_CrtCaseManagement_TerrasoftSchema(Case_CrtCaseManagement_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			RealUId = new Guid("84ff934e-b055-8b3c-fd2f-dbeae62b30a4");
			Name = "Case_CrtCaseManagement_Terrasoft";
			ParentSchemaUId = new Guid("117d32f9-8275-4534-8411-1c66115ce9cd");
			ExtendParent = true;
			CreatedInPackageId = new Guid("c5f3a064-5eb8-4cd7-b28e-960863875dfd");
			IsDBView = false;
		...
		protected override EntitySchemaColumn CreateNumberColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("84ff934e-b055-8b3c-fd2f-dbeae62b30a4");
			return column;
		}
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Case_CrtCaseManagement_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Case_CrtCaseManagementEventsProcess(userConnection);
		}

		public override object Clone() {
			return new Case_CrtCaseManagement_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Case_CrtCaseManagement_TerrasoftSchema(this, true);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("84ff934e-b055-8b3c-fd2f-dbeae62b30a4"));
		}
	...
	#region Class: Case_CrtCaseManagement_Terrasoft

	/// <summary>
	/// Case.
	/// </summary>
	public class Case_CrtCaseManagement_Terrasoft : Terrasoft.Configuration.Case_CrtCaseManagmentObject_Terrasoft
	{

		#region Constructors: Public

		public Case_CrtCaseManagement_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Case_CrtCaseManagement_Terrasoft";
		}

		public Case_CrtCaseManagement_Terrasoft(Case_CrtCaseManagement_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Case_CrtCaseManagementEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Inserted += (s, e) => ThrowEvent("Case_CrtCaseManagement_TerrasoftInserted", e);
		...
		public override object Clone() {
			return new Case_CrtCaseManagement_Terrasoft(this);
		}
	...
	#region Class: Case_CrtCaseManagementEventsProcess

	/// <exclude/>
	public partial class Case_CrtCaseManagementEventsProcess<TEntity> : Terrasoft.Configuration.Case_CrtCaseManagmentObjectEventsProcess<TEntity> where TEntity : Case_CrtCaseManagement_Terrasoft
	{

		public Case_CrtCaseManagementEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Case_CrtCaseManagementEventsProcess";
		...
		private Guid InternalSchemaUId {
			get {
				return new Guid("84ff934e-b055-8b3c-fd2f-dbeae62b30a4");
			}
		}
	...
	/// <exclude/>
	public class Case_CrtCaseManagementEventsProcess : Case_CrtCaseManagementEventsProcess<Case_CrtCaseManagement_Terrasoft>
	{
	...
	public partial class Case_CrtCaseManagementEventsProcess<TEntity>
	{

namespace Terrasoft.Configuration
{
	...
	public class VwSysRoleSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new VwSysRole_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class VwSysRole : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new VwSysRole_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: VwSysRole_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class VwSysRole_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSysRole
	{

		public VwSysRole_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "VwSysRole_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class VwSysRole_CrtCoreBaseEventsProcess : VwSysRole_CrtCoreBaseEventsProcess<VwSysRole>
	{
	...
	public partial class VwSysRole_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class VwSysRoleEventsProcess : VwSysRole_CrtCoreBaseEventsProcess
	{

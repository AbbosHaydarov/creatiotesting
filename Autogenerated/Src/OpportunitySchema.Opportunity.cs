namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Opportunity_Opportunity_TerrasoftSchema : Terrasoft.Configuration.Opportunity_CrtFinservOpportunity_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateDueDateColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("2f7102db-6e5b-4d97-a4bc-9cc523fb19f8");
			return column;
		}
	...
	/// Opportunity.
	/// </summary>
	public class Opportunity_Opportunity_Terrasoft : Terrasoft.Configuration.Opportunity_CrtFinservOpportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Opportunity_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.Opportunity_CrtFinservOpportunityEventsProcess<TEntity> where TEntity : Opportunity_Opportunity_Terrasoft
	{
		...
		public virtual bool ScriptOpportunitySavingExecute(ProcessExecutingContext context) {
			...
			IsOwnerChanged = System.Linq.Enumerable.Any(columns, c => c.Name == ownerColumnName);
			string stageColumnName = Entity.Schema.Columns.GetByName("Stage").ColumnValueName;
			bool isTacticChanged = System.Linq.Enumerable.Any(columns, c => c.Name == "Tactic");
			bool isCheckDateChanged = System.Linq.Enumerable.Any(columns, c => c.Name == "CheckDate");

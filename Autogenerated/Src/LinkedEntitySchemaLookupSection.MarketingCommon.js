		...
		return {
			...
			methods: {
				...
				columnsFiltrationMethod: function(column) {
					...
					var allowedLookupType =[Terrasoft.DataValueType.LOOKUP];
					if (this.columnName === "EmailAddressColumn") {
						allowedTypes = allowedLookupType.concat(allowedTextTypes);
					}
					if (this.columnName === "ContactColumn") {
						allowedTypes = allowedLookupType;
					}
					if (this.columnName === "WebPageURLColumn") {

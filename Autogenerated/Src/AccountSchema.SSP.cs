namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Account_SSP_TerrasoftSchema : Terrasoft.Configuration.Account_Completeness_TerrasoftSchema
	{
	...
	/// Account.
	/// </summary>
	public class Account_SSP_Terrasoft : Terrasoft.Configuration.Account_Completeness_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Account_SSPEventsProcess<TEntity> : Terrasoft.Configuration.Account_CompletenessEventsProcess<TEntity> where TEntity : Account_SSP_Terrasoft
	{

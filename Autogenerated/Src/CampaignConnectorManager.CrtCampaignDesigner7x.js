define("CampaignConnectorManager", [], function() {
	...
	Ext.define("Terrasoft.CampaignConnectorManager", {
		...
		initMappingCollection: function() {
			var collection = this.connectorTypesMappingCollection || Ext.create("Terrasoft.Collection");
			collection.addIfNotExists("CampaignSplitGatewaySchema", "Terrasoft.ProcessSplitGatewayTransitionSchema");
			collection.addIfNotExists("CampaignWebPageSchema", "Terrasoft.BaseWebPageConditionalTransitionSchema");

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class LeadTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
	...
	/// Customer need.
	/// </summary>
	public class LeadType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Inserting += (s, e) => ThrowEvent("LeadTypeInserting", e);
	...
	/// <exclude/>
	public partial class LeadType_CrtTouchPointEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LeadType
	{
	...
	/// <exclude/>
	public class LeadType_CrtTouchPointEventsProcess : LeadType_CrtTouchPointEventsProcess<LeadType>
	{
	...
	/// <exclude/>
	public class LeadTypeEventsProcess : LeadType_CrtTouchPointEventsProcess
	{

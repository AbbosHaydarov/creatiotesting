namespace Terrasoft.Configuration
{
	...
	public class ProductFilter_CrtProductCatalogue_Terrasoft : Terrasoft.Configuration.BaseEntityWithPosition
	{
		...
		protected override void InitializeThrowEvents() {
			Deleting += (s, e) => ThrowEvent("ProductFilter_CrtProductCatalogue_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("ProductFilter_CrtProductCatalogue_TerrasoftInserted", e);
			Saved += (s, e) => ThrowEvent("ProductFilter_CrtProductCatalogue_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("ProductFilter_CrtProductCatalogue_TerrasoftSaving", e);
	...
	/// <exclude/>
	public partial class ProductFilter_CrtProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityWithPosition_CrtCoreBaseEventsProcess<TEntity> where TEntity : ProductFilter_CrtProductCatalogue_Terrasoft
	{

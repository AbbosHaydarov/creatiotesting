namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebhookEntity_WebhookServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : WebhookEntity
	{

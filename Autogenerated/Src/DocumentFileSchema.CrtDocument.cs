namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentFile_CrtDocumentEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : DocumentFile_CrtDocument_Terrasoft
	{

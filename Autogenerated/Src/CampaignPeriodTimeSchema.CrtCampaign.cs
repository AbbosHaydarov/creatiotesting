namespace Terrasoft.Configuration
{
	...
	public class CampaignPeriodTimeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CampaignPeriodTime_CrtCampaignEventsProcess(userConnection);
		}
	...
	public class CampaignPeriodTime : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new CampaignPeriodTime_CrtCampaignEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: CampaignPeriodTime_CrtCampaignEventsProcess

	/// <exclude/>
	public partial class CampaignPeriodTime_CrtCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CampaignPeriodTime
	{

		public CampaignPeriodTime_CrtCampaignEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "CampaignPeriodTime_CrtCampaignEventsProcess";
	...
	/// <exclude/>
	public class CampaignPeriodTime_CrtCampaignEventsProcess : CampaignPeriodTime_CrtCampaignEventsProcess<CampaignPeriodTime>
	{
	...
	public partial class CampaignPeriodTime_CrtCampaignEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class CampaignPeriodTimeEventsProcess : CampaignPeriodTime_CrtCampaignEventsProcess
	{

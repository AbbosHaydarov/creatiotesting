namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SelectorType_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SelectorType
	{

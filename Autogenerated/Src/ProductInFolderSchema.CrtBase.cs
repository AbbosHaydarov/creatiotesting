namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProductInFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ProductInFolder
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysOperationResult_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeImageLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysOperationResult
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MailboxSettingsFile_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : MailboxSettingsFile
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OpportunityStageSchema : Terrasoft.Configuration.OpportunityStage_CrtOpportunity_TerrasoftSchema
	{
	...
	/// Opportunity stage.
	/// </summary>
	public class OpportunityStage : Terrasoft.Configuration.OpportunityStage_CrtOpportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OpportunityStage_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.OpportunityStage_CrtOpportunityEventsProcess<TEntity> where TEntity : OpportunityStage
	{
	...
	/// <exclude/>
	public class OpportunityStage_OpportunityEventsProcess : OpportunityStage_OpportunityEventsProcess<OpportunityStage>
	{
	...
	/// <exclude/>
	public class OpportunityStageEventsProcess : OpportunityStage_OpportunityEventsProcess
	{

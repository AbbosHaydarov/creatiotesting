namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ProductSource_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseImageLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ProductSource
	{

/**
 * Schema of campaign Facebook form start element page.
 * Parent: CampaignStartFacebookFormPage => EntityCampaignSchemaElementPage
 */
define("CampaignStartFacebookFormPage", [], function() {
	return {
		mixins: {
		...
		methods: {
			...
			getContextHelpCode: function() {
				return "CampaignStartFacebookFormElement";
			},
			...
			getEntityLookupConfig: function() {
				...
				config.captionLookup = this.get("Resources.Strings.EntityLookupCaption");
				return config;
			},
			/**
			...
			getEntityLookupFilters: function() {
				...
				filters.addItem(Terrasoft.createColumnFilterWithParameter(
					Terrasoft.ComparisonType.EQUAL, "IsFbWebForm", true)
				);
				return filters;
			},
		...
		diff: /**SCHEMA_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"itemType": this.Terrasoft.ViewItemType.LABEL,
					"caption": {
						"bindTo": "Resources.Strings.WebPageNameCaption"
					},
					"classes": {
						"labelClass": ["label-small"]
					},

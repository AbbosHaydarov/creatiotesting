namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysAdminUnitInFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysAdminUnitInFolder
	{

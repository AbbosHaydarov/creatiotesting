define("ContentImageElementViewModel", ["ContentImageElementViewModelResources", "ContentBuilderConstants", "ContentElementBaseViewModel"],
	   function(resources, ContentBuilderConstants) {
	...
	Ext.define("Terrasoft.ContentBuilder.ContentImageElementViewModel", {
		...
		getToolsViewConfig: function() {
			return [{
				...
				fileUpload: true,
				fileTypeFilter: [ContentBuilderConstants.AllowedImageExtensions],

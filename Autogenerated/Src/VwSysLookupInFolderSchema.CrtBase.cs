namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysLookupInFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSysLookupInFolder
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_EventTracking_TerrasoftSchema : Terrasoft.Configuration.Lead_BankOnboarding_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_EventTracking_Terrasoft : Terrasoft.Configuration.Lead_BankOnboarding_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Lead_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.Lead_BankOnboardingEventsProcess<TEntity> where TEntity : Lead_EventTracking_Terrasoft
	{

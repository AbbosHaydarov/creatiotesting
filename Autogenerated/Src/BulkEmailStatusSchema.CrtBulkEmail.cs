namespace Terrasoft.Configuration
{
	...
	public class BulkEmailStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected virtual EntitySchemaColumn CreateColorColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Color")) {
				UId = new Guid("c353da44-d632-78d4-70c6-57d0cebc8886"),
				Name = @"Color",
				CreatedInSchemaUId = new Guid("6018ff01-89b1-4826-9173-9b38cb29b6f3"),
				ModifiedInSchemaUId = new Guid("6018ff01-89b1-4826-9173-9b38cb29b6f3"),
				CreatedInPackageId = new Guid("dc4186ba-ab27-4a9f-9a4a-75cc380aaad8")
			};
		}
	...
	/// <exclude/>
	public partial class BulkEmailStatus_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BulkEmailStatus
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Contact_CrtBulkEmail_TerrasoftSchema : Terrasoft.Configuration.Contact_CrtBaseFinserv_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateNameColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("1182f753-e867-4869-93a2-69d7a9eef7ae");
	...
	/// Contact.
	/// </summary>
	public class Contact_CrtBulkEmail_Terrasoft : Terrasoft.Configuration.Contact_CrtBaseFinserv_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Contact_CrtBulkEmail_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Contact_CrtBulkEmail_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Contact_CrtBulkEmail_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Contact_CrtBulkEmail_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Contact_CrtBulkEmail_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Contact_CrtBulkEmail_TerrasoftSaving", e);
			Updating += (s, e) => ThrowEvent("Contact_CrtBulkEmail_TerrasoftUpdating", e);
			Validating += (s, e) => ThrowEvent("Contact_CrtBulkEmail_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Contact_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.Contact_CrtBaseFinservEventsProcess<TEntity> where TEntity : Contact_CrtBulkEmail_Terrasoft
	{

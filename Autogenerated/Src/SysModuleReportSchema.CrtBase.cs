namespace Terrasoft.Configuration
{
	...
	public class SysModuleReportSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("d1dcebfb-925b-88f2-af6d-12939eb6283b")) == null) {
		...
		protected virtual EntitySchemaColumn CreateSysEntitySchemaColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Lookup")) {
				UId = new Guid("d1dcebfb-925b-88f2-af6d-12939eb6283b"),
				...
				CreatedInSchemaUId = new Guid("0a62cd3d-6541-4c5c-903f-e5b0fc665297"),
				ModifiedInSchemaUId = new Guid("0a62cd3d-6541-4c5c-903f-e5b0fc665297"),
				CreatedInPackageId = new Guid("871d2d0e-2699-4cfb-a3a5-2020f3c00088")
			};
		}
		...
		public VwEntityObjects SysEntitySchema {
			get {
				return _sysEntitySchema ??
					(_sysEntitySchema = LookupColumnEntities.GetEntity("SysEntitySchema") as VwEntityObjects);
			}
		}

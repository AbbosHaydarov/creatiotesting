namespace Terrasoft.Configuration
{
	...
	public class LookupInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new LookupInFolder_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class LookupInFolder : Terrasoft.Configuration.BaseItemInFolder
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new LookupInFolder_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: LookupInFolder_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class LookupInFolder_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : LookupInFolder
	{

		public LookupInFolder_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "LookupInFolder_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class LookupInFolder_CrtCoreBaseEventsProcess : LookupInFolder_CrtCoreBaseEventsProcess<LookupInFolder>
	{
	...
	public partial class LookupInFolder_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class LookupInFolderEventsProcess : LookupInFolder_CrtCoreBaseEventsProcess
	{

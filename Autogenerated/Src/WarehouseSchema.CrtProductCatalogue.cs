namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Warehouse_CrtProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : Warehouse
	{

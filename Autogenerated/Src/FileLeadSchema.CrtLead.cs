namespace Terrasoft.Configuration
{
	...
	public class FileLead_CrtLead_Terrasoft : Terrasoft.Configuration.File
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("FileLead_CrtLead_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("FileLead_CrtLead_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("FileLead_CrtLead_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("FileLead_CrtLead_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("FileLead_CrtLead_TerrasoftSaving", e);
			Updated += (s, e) => ThrowEvent("FileLead_CrtLead_TerrasoftUpdated", e);
			Validating += (s, e) => ThrowEvent("FileLead_CrtLead_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class FileLead_CrtLeadEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : FileLead_CrtLead_Terrasoft
	{

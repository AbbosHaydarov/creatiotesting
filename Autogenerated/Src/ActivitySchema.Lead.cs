namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_Lead_TerrasoftSchema : Terrasoft.Configuration.Activity_CrtOpportunity_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_Lead_Terrasoft : Terrasoft.Configuration.Activity_CrtOpportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_LeadEventsProcess<TEntity> : Terrasoft.Configuration.Activity_CrtOpportunityEventsProcess<TEntity> where TEntity : Activity_Lead_Terrasoft
	{

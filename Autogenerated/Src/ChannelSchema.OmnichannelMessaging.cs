namespace Terrasoft.Configuration
{
	...
	#region Class: Channel_OmnichannelMessaging_TerrasoftSchema

	/// <exclude/>
	public class Channel_OmnichannelMessaging_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public Channel_OmnichannelMessaging_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Channel_OmnichannelMessaging_TerrasoftSchema(Channel_OmnichannelMessaging_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Channel_OmnichannelMessaging_TerrasoftSchema(Channel_OmnichannelMessaging_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "Channel_OmnichannelMessaging_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Channel_OmnichannelMessaging_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new Channel_OmnichannelMessaging_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Channel_OmnichannelMessaging_TerrasoftSchema(this, true);
		}
	...
	#region Class: Channel_OmnichannelMessaging_Terrasoft

	/// <summary>
	/// Chat channel.
	/// </summary>
	public class Channel_OmnichannelMessaging_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public Channel_OmnichannelMessaging_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Channel_OmnichannelMessaging_Terrasoft";
		}

		public Channel_OmnichannelMessaging_Terrasoft(Channel_OmnichannelMessaging_Terrasoft source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new Channel_OmnichannelMessaging_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class Channel_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Channel_OmnichannelMessaging_Terrasoft
	{
	...
	/// <exclude/>
	public class Channel_OmnichannelMessagingEventsProcess : Channel_OmnichannelMessagingEventsProcess<Channel_OmnichannelMessaging_Terrasoft>
	{

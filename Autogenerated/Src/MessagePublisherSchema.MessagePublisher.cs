namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MessagePublisher_MessagePublisherEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : MessagePublisher
	{

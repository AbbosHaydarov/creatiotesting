namespace Terrasoft.Configuration
{
	...
	public class CampaignPlannerTag : Terrasoft.Configuration.BaseTag
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("CampaignPlannerTagDeleting", e);
			Inserted += (s, e) => ThrowEvent("CampaignPlannerTagInserted", e);
			Inserting += (s, e) => ThrowEvent("CampaignPlannerTagInserting", e);
			Saved += (s, e) => ThrowEvent("CampaignPlannerTagSaved", e);
			Saving += (s, e) => ThrowEvent("CampaignPlannerTagSaving", e);

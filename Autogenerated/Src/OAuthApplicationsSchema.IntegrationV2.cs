namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class OAuthApplicationsSchema : Terrasoft.Configuration.OAuthApplications_CrtCoreBase_TerrasoftSchema
	{
	...
	/// </summary>
	public class OAuthApplications : Terrasoft.Configuration.OAuthApplications_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class OAuthApplications_IntegrationV2EventsProcess<TEntity> : Terrasoft.Configuration.OAuthApplications_CrtCoreBaseEventsProcess<TEntity> where TEntity : OAuthApplications
	{

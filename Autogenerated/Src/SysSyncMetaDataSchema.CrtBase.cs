namespace Terrasoft.Configuration
{
	...
	public class SysSyncMetaDataSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		private EntitySchemaIndex CreateIX_SSMData_LocalId_CreatedByIdIndex() {
			EntitySchemaIndex index = new EntitySchemaIndex() {
				IsAutoName = false,
				IsClustered = false,
				IsUnique = false
			};
			index.UId = new Guid("90f4b8e9-9d46-43c8-829b-0dde8b4da7fe");
			index.Name = "IX_SSMData_LocalId_CreatedById";
			index.CreatedInSchemaUId = new Guid("909da302-de10-490e-8715-5b0f973f043d");
			index.ModifiedInSchemaUId = new Guid("909da302-de10-490e-8715-5b0f973f043d");
			index.CreatedInPackageId = new Guid("95a133a1-cd5f-4df8-af8f-ad440775d7d1");
			EntitySchemaIndexColumn localIdIndexColumn = new EntitySchemaIndexColumn() {
				UId = new Guid("9e46d4dd-7a94-4f2b-f977-4fe1901a7b4a"),
				ColumnUId = new Guid("93e6cc9b-2a32-4f5c-9e0f-5d9a1070d34d"),
				CreatedInSchemaUId = new Guid("909da302-de10-490e-8715-5b0f973f043d"),
				ModifiedInSchemaUId = new Guid("909da302-de10-490e-8715-5b0f973f043d"),
			...
			EntitySchemaIndexColumn createdByIdIndexColumn = new EntitySchemaIndexColumn() {
				UId = new Guid("6f900874-7958-bc55-00cb-0970cb277dff"),
		...
		protected override void InitializeIndexes() {
			...
			Indexes.Add(CreateIX_SSMData_LocalId_CreatedByIdIndex());
		}

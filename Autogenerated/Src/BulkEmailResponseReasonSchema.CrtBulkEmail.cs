namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailResponseReason_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BulkEmailResponseReason
	{

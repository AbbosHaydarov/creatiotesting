namespace Terrasoft.Configuration
{
	...
	public class EmailTypeSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EmailType_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class EmailType : Terrasoft.Configuration.BaseCodeLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new EmailType_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: EmailType_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class EmailType_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : EmailType
	{

		public EmailType_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "EmailType_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class EmailType_CrtCoreBaseEventsProcess : EmailType_CrtCoreBaseEventsProcess<EmailType>
	{
	...
	public partial class EmailType_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class EmailTypeEventsProcess : EmailType_CrtCoreBaseEventsProcess
	{

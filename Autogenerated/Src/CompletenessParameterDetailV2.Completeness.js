	...
	function(resources, BusinessRulesApplierV2) {
		...
		return {
			...
			methods: {
				 ...
				 * @private
				 */
				_getEntityStructureFromPage: function() {
					return this.sandbox.publish("GetEntityStructureFromPage", null, [this.sandbox.id]);
				},
				...
				getCardSchemaName: function(entitySchemaName, typeId) {
					var entityStructure = this._getEntityStructureFromPage();

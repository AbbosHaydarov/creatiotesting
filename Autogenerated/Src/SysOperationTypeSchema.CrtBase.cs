namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysOperationType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysOperationType
	{

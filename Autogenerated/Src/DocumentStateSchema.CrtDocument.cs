namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentState_CrtDocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : DocumentState
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysStartTimerType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.SysCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysStartTimerType
	{

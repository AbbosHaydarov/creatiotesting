namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysDcmLibInFolder_DcmDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSysDcmLibInFolder
	{

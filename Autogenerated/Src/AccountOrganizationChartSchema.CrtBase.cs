namespace Terrasoft.Configuration
{
	...
	#region Class: AccountOrganizationChart_CrtBase_TerrasoftSchema

	/// <exclude/>
	public class AccountOrganizationChart_CrtBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public AccountOrganizationChart_CrtBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public AccountOrganizationChart_CrtBase_TerrasoftSchema(AccountOrganizationChart_CrtBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public AccountOrganizationChart_CrtBase_TerrasoftSchema(AccountOrganizationChart_CrtBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "AccountOrganizationChart_CrtBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new AccountOrganizationChart_CrtBase_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new AccountOrganizationChart_CrtBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new AccountOrganizationChart_CrtBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: AccountOrganizationChart_CrtBase_Terrasoft

	/// <summary>
	/// Account organizational structure.
	/// </summary>
	public class AccountOrganizationChart_CrtBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public AccountOrganizationChart_CrtBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "AccountOrganizationChart_CrtBase_Terrasoft";
		}

		public AccountOrganizationChart_CrtBase_Terrasoft(AccountOrganizationChart_CrtBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("AccountOrganizationChart_CrtBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("AccountOrganizationChart_CrtBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("AccountOrganizationChart_CrtBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("AccountOrganizationChart_CrtBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("AccountOrganizationChart_CrtBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("AccountOrganizationChart_CrtBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("AccountOrganizationChart_CrtBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new AccountOrganizationChart_CrtBase_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class AccountOrganizationChart_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : AccountOrganizationChart_CrtBase_Terrasoft
	{
	...
	/// <exclude/>
	public class AccountOrganizationChart_CrtBaseEventsProcess : AccountOrganizationChart_CrtBaseEventsProcess<AccountOrganizationChart_CrtBase_Terrasoft>
	{

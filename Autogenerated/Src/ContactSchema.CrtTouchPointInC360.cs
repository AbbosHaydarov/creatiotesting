namespace Terrasoft.Configuration
{
	...
	public class Contact_CrtTouchPointInC360_TerrasoftSchema : Terrasoft.Configuration.Contact_CrtMLLeadConversion_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateNameColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("a95929a3-c41c-46f0-8188-9686d65e9cc5");
	...
	public class Contact_CrtTouchPointInC360_Terrasoft : Terrasoft.Configuration.Contact_CrtMLLeadConversion_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Contact_CrtTouchPointInC360_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Contact_CrtTouchPointInC360_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Contact_CrtTouchPointInC360_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Contact_CrtTouchPointInC360_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Contact_CrtTouchPointInC360_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Contact_CrtTouchPointInC360_TerrasoftSaving", e);
			Updating += (s, e) => ThrowEvent("Contact_CrtTouchPointInC360_TerrasoftUpdating", e);
			Validating += (s, e) => ThrowEvent("Contact_CrtTouchPointInC360_TerrasoftValidating", e);

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FileImportTemplate_FileImportEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : FileImportTemplate
	{

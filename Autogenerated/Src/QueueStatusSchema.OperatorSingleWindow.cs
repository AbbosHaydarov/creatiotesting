namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueStatus_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : QueueStatus
	{

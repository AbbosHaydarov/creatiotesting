namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SocialChannelFolder_CrtESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : SocialChannelFolder
	{

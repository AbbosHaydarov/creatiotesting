namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueInFolder_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : QueueInFolder
	{

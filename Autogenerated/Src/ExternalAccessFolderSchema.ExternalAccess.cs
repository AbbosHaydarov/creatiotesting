namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ExternalAccessFolder_ExternalAccessEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ExternalAccessFolder
	{

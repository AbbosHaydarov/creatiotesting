namespace Terrasoft.Configuration
{
	...
	/// </summary>
	[DefaultBinding(typeof(ITouchEventLogger))]
	public class TouchEventLogger : ITouchEventLogger
	{
		...
		public void Error(string eventName, DateTime startDate, Exception exception, Guid trackingId,
			...
			InternalLog(eventName, eventType, description, startDate, 0, trackingId, exception);

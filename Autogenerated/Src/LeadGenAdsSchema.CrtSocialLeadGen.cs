namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenAds_CrtSocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LeadGenAds
	{

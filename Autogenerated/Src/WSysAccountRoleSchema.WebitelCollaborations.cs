namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WSysAccountRole_WebitelCollaborationsEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : WSysAccountRole
	{

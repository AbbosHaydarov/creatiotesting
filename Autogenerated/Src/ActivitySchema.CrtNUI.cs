namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_CrtNUI_TerrasoftSchema : Terrasoft.Configuration.Activity_CrtCaseService_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_CrtNUI_Terrasoft : Terrasoft.Configuration.Activity_CrtCaseService_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_CrtNUIEventsProcess<TEntity> : Terrasoft.Configuration.Activity_CrtCaseServiceEventsProcess<TEntity> where TEntity : Activity_CrtNUI_Terrasoft
	{

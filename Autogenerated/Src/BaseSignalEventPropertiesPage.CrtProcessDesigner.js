	...
	function(BusinessRuleModule) {
		...
		return {
			...
			methods: {
				...
				/* Initializes EntitySchemaUId property.
				 * @protected
				 * @return {string[]} array of columns to clear
				 */
				...
				onEntitySchemaSelectChanged: function() {
					...
					this.clearAttributes(
						this.getClearAttributesOnEntitySchemaSelectChanged()
					);
				...
				/**
				 * Set EntityChangeType to allow silent mode
				 * @protected
				 * @param {Terrasoft.EntityChangeType} Entity change type.
				 * @param {Boolean} Is silent set column value EntityChangeType. Default is false.
				 */
				setEntityChangeType: function(entitySignal, silent = false) {
				...
				initEntityChangeTypeList: function() {
					...
					if (entitySignal !== entityChangeType.None) {
						this.setEntityChangeType(entitySignal, true);
					}

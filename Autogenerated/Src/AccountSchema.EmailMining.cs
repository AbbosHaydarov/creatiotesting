namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Account_EmailMining_TerrasoftSchema : Terrasoft.Configuration.Account_CrtProductCatalogue_TerrasoftSchema
	{
	...
	/// Account.
	/// </summary>
	public class Account_EmailMining_Terrasoft : Terrasoft.Configuration.Account_CrtProductCatalogue_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Account_EmailMiningEventsProcess<TEntity> : Terrasoft.Configuration.Account_CrtProductCatalogueEventsProcess<TEntity> where TEntity : Account_EmailMining_Terrasoft
	{

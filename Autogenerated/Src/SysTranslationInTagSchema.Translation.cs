namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysTranslationInTag_TranslationEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysTranslationInTag
	{

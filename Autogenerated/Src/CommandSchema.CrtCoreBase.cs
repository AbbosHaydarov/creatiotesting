namespace Terrasoft.Configuration
{
	...
	public class CommandSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Command_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class Command : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Command_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: Command_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class Command_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Command
	{

		public Command_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Command_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class Command_CrtCoreBaseEventsProcess : Command_CrtCoreBaseEventsProcess<Command>
	{
	...
	public partial class Command_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class CommandEventsProcess : Command_CrtCoreBaseEventsProcess
	{

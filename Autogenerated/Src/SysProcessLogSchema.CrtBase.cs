namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SysProcessLogSchema : Terrasoft.Configuration.BaseEntitySchema
	{
	...
	/// Process log (actual).
	/// </summary>
	public class SysProcessLog : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SysProcessLogDeleted", e);
			Inserting += (s, e) => ThrowEvent("SysProcessLogInserting", e);
			Validating += (s, e) => ThrowEvent("SysProcessLogValidating", e);
	...
	/// <exclude/>
	public partial class SysProcessLog_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysProcessLog
	{
	...
	/// <exclude/>
	public class SysProcessLog_CrtBaseEventsProcess : SysProcessLog_CrtBaseEventsProcess<SysProcessLog>
	{
	...
	/// <exclude/>
	public class SysProcessLogEventsProcess : SysProcessLog_CrtBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Contact_CrtMLLeadConversion_TerrasoftSchema : Terrasoft.Configuration.Contact_AddressFinance_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateNameColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("5c017eda-4814-4b75-ab70-ec320a300730");
	...
	/// Contact.
	/// </summary>
	public class Contact_CrtMLLeadConversion_Terrasoft : Terrasoft.Configuration.Contact_AddressFinance_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Contact_CrtMLLeadConversion_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Contact_CrtMLLeadConversion_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Contact_CrtMLLeadConversion_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Contact_CrtMLLeadConversion_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Contact_CrtMLLeadConversion_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Contact_CrtMLLeadConversion_TerrasoftSaving", e);
			Updating += (s, e) => ThrowEvent("Contact_CrtMLLeadConversion_TerrasoftUpdating", e);
			Validating += (s, e) => ThrowEvent("Contact_CrtMLLeadConversion_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Contact_CrtMLLeadConversionEventsProcess<TEntity> : Terrasoft.Configuration.Contact_AddressFinanceEventsProcess<TEntity> where TEntity : Contact_CrtMLLeadConversion_Terrasoft
	{

namespace Terrasoft.Configuration {
	...
	public static class CampaignConsts {
		...
		/// <summary>
		/// Campaign log item type: Element execution: Add from Web page signal.
		/// </summary>
		public static readonly Guid CampaignLogTypeAddFromWebPage = new Guid("EADEE5EF-97C0-4B78-9C6F-5CA441BEB93D");

		/// <summary>
		/// Campaign log item type: Element execution: Web page.
		/// </summary>
		public static readonly Guid CampaignLogTypeWebPage = new Guid("FAF1F9F8-621E-4D59-8DE3-C39D7DDC806F");
		...
		/// <summary>
		/// Campaign log item type: Element execution: Add from Facebook form.
		/// </summary>
		public static readonly Guid CampaignLogTypeAddFacebookFormAudience = new Guid("7C8B2F6A-05AD-4AAC-BB76-B95670A89BEB");

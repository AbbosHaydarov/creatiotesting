namespace Terrasoft.Configuration
{
	...
	public class MktgActivityTag : Terrasoft.Configuration.BaseTag
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("MktgActivityTagDeleting", e);
			Inserted += (s, e) => ThrowEvent("MktgActivityTagInserted", e);
			Inserting += (s, e) => ThrowEvent("MktgActivityTagInserting", e);
			Saved += (s, e) => ThrowEvent("MktgActivityTagSaved", e);
			Saving += (s, e) => ThrowEvent("MktgActivityTagSaving", e);

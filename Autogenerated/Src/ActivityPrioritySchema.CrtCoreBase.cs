namespace Terrasoft.Configuration
{
	...
	public class ActivityPrioritySchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ActivityPriority_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class ActivityPriority : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new ActivityPriority_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: ActivityPriority_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class ActivityPriority_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ActivityPriority
	{

		public ActivityPriority_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "ActivityPriority_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class ActivityPriority_CrtCoreBaseEventsProcess : ActivityPriority_CrtCoreBaseEventsProcess<ActivityPriority>
	{
	...
	public partial class ActivityPriority_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class ActivityPriorityEventsProcess : ActivityPriority_CrtCoreBaseEventsProcess
	{

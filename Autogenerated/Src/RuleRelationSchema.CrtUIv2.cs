namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class RuleRelation_CrtUIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : RuleRelation
	{

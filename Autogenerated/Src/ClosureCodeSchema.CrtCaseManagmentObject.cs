namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ClosureCode_CrtCaseManagmentObjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ClosureCode
	{

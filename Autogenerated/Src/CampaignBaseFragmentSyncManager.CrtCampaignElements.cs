namespace Terrasoft.Configuration
{
	...
	public abstract class CampaignBaseFragmentSyncManager : ICampaignFragmentSyncManager
	{
		...
		protected const string CampaignParticipantOpTableName = "CampaignParticipantOp";
		protected const string CampaignParticipantTableName = "CampaignParticipant";
		protected const string CampaignParticipantInfoTableName = "CampaignParticipantInfo";
		protected const string CampaignParticipantOpInfoTableName = "CampaignParticipantOpInfo";
		protected const string CampaignParticipantEmailTargetOpTableName = "CmpgnPrtcpntEmailTargetOp";
		protected const string CampaignParticipantEmailTargetTableName = "CmpgnPrtcpntEmailTarget";
		protected const string CampaignItemTableName = "CampaignItem";
		...
		/// <summary>
		/// Removes processed items from operational tables.
		/// </summary>
		/// <param name="userConnection">Instance of the <see cref="UserConnection"/></param>
		protected virtual void DeleteSynchronizedRelations(UserConnection userConnection) {
			var delete = GetDeleteSynchronizedRelationsQuery(userConnection);
			delete.Execute();
		}

		/// <summary>
		/// Describes possibility to process participant relations.
		/// </summary>
		/// <param name="userConnection">Instance of the <see cref="UserConnection"/></param>
		/// <returns>Checking result</returns>
		protected virtual bool CanProcessRelations(UserConnection userConnection) {
			var items = new ISchemaManagerItem[] {
				userConnection.EntitySchemaManager.FindItemByName(CampaignParticipantEmailTargetTableName),
				userConnection.EntitySchemaManager.FindItemByName(CampaignParticipantEmailTargetOpTableName),
				userConnection.EntitySchemaManager.FindItemByName(BulkEmailTableName),
				userConnection.EntitySchemaManager.FindItemByName(MandrillRecipientTableName)
			};
			return items.All(item => item != null);
		}

		/// <summary>
		/// Transfers participants' relations.
		/// </summary>
		/// <param name="userConnection">Instance of the <see cref="UserConnection"/></param>
		protected virtual void ProcessRelations(UserConnection userConnection) {
			if (CanProcessRelations(userConnection)) {

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AdPlatform_CrtDigitalAdsAppEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : AdPlatform
	{

		...
		return {
			...
			methods: {
				...
				openCard: function(operation, typeColumnValue, recordId) {
					...
					const miniPageConfig = { ...config, messageTags: this.getCardModuleResponseIds() }
					if (NetworkUtilities.tryNavigateTo8xMiniPage(miniPageConfig)) {
						return false;
					}
				...
				getOpenCardConfig: function(operation, typeColumnValue, recordId) {
					var editPages = this.getEditPages(Terrasoft.ConfigurationEnums.CardOperation.EDIT);

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysUser_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSysUser
	{

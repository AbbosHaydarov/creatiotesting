namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CaseSchema : Terrasoft.Configuration.Case_OBSW_TerrasoftSchema
	{
	...
	/// Case.
	/// </summary>
	public class Case : Terrasoft.Configuration.Case_OBSW_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("CaseDeleting", e);
			Inserted += (s, e) => ThrowEvent("CaseInserted", e);
			Inserting += (s, e) => ThrowEvent("CaseInserting", e);
			Saved += (s, e) => ThrowEvent("CaseSaved", e);
			Saving += (s, e) => ThrowEvent("CaseSaving", e);
			SaveError += (s, e) => ThrowEvent("CaseSaveError", e);
			Validating += (s, e) => ThrowEvent("CaseValidating", e);
			DefColumnValuesSet += (s, e) => ThrowEvent("CaseDefColumnValuesSet", e);
	...
	/// <exclude/>
	public partial class Case_SLMEventsProcess<TEntity> : Terrasoft.Configuration.Case_OBSWEventsProcess<TEntity> where TEntity : Case
	{
	...
	/// <exclude/>
	public class Case_SLMEventsProcess : Case_SLMEventsProcess<Case>
	{
	...
	/// <exclude/>
	public class CaseEventsProcess : Case_SLMEventsProcess
	{

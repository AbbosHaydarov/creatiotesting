namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class VwQueueItem_ServiceDefSettings_TerrasoftSchema : Terrasoft.Configuration.VwQueueItem_Lending_TerrasoftSchema
	{
	...
	/// Queue items (view).
	/// </summary>
	public class VwQueueItem_ServiceDefSettings_Terrasoft : Terrasoft.Configuration.VwQueueItem_Lending_Terrasoft
	{
	...
	/// <exclude/>
	public partial class VwQueueItem_ServiceDefSettingsEventsProcess<TEntity> : Terrasoft.Configuration.VwQueueItem_LendingEventsProcess<TEntity> where TEntity : VwQueueItem_ServiceDefSettings_Terrasoft
	{

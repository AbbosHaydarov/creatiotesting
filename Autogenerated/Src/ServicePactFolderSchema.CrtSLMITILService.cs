namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServicePactFolder_CrtSLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ServicePactFolder
	{

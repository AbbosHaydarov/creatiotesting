namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ReferrerTypeSchema : Terrasoft.Configuration.ReferrerType_CrtGoogleAnalytics_TerrasoftSchema
	{
	...
	/// Referrer type.
	/// </summary>
	public class ReferrerType : Terrasoft.Configuration.ReferrerType_CrtGoogleAnalytics_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("ReferrerTypeDeleted", e);
			Deleting += (s, e) => ThrowEvent("ReferrerTypeDeleting", e);
			Inserted += (s, e) => ThrowEvent("ReferrerTypeInserted", e);
			Inserting += (s, e) => ThrowEvent("ReferrerTypeInserting", e);
			Saved += (s, e) => ThrowEvent("ReferrerTypeSaved", e);
			Saving += (s, e) => ThrowEvent("ReferrerTypeSaving", e);
			Validating += (s, e) => ThrowEvent("ReferrerTypeValidating", e);
	...
	/// <exclude/>
	public partial class ReferrerType_CrtMatomoConnectorEventsProcess<TEntity> : Terrasoft.Configuration.ReferrerType_CrtGoogleAnalyticsEventsProcess<TEntity> where TEntity : ReferrerType
	{

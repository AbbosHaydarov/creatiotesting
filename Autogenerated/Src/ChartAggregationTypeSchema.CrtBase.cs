namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ChartAggregationType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ChartAggregationType
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MLModelInTag_MLEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : MLModelInTag
	{

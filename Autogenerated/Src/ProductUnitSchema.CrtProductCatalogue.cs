namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ProductUnitSchema : Terrasoft.Configuration.BaseEntitySchema
	{
	...
	/// </summary>
	public class ProductUnit : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("ProductUnitDeleted", e);
			Inserting += (s, e) => ThrowEvent("ProductUnitInserting", e);
			Validating += (s, e) => ThrowEvent("ProductUnitValidating", e);
	...
	/// <exclude/>
	public partial class ProductUnit_CrtProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : ProductUnit
	{
	...
	/// <exclude/>
	public class ProductUnit_CrtProductCatalogueEventsProcess : ProductUnit_CrtProductCatalogueEventsProcess<ProductUnit>
	{
	...
	/// <exclude/>
	public class ProductUnitEventsProcess : ProductUnit_CrtProductCatalogueEventsProcess
	{

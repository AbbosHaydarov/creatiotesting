namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleActionType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysModuleActionType
	{

	...
	return {
		...
		methods: {
			...
			loadEnrichmentData: function() {
				...
				this.log("loadEnrichmentData");
				this.selectExistingEnrichedData(function(response) {
					this.log("loadEnrichmentData: on selectExistingEnrichedData");
			...
			onLoadEnrichmentData: function(response) {
				...
				if (this.isNotEmpty(responseCollection)) {
					this.log("onLoadEnrichmentData: responseCollection is not empty");
					...
					this.log("onLoadEnrichmentData: responseCollection after filtering: " + responseCollection.getCount());
					collection.loadAll(responseCollection);
				} else {
					this.log("onLoadEnrichmentData. Collection is empty");
				}
			...
			selectExistingEnrichedData: function(callback, scope) {
				this.log("selectExistingEnrichedData");

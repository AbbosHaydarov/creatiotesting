namespace Terrasoft.Configuration
{
	...
	public class BpmonlineCloudEngine
	{
		...
		/// </summary>
		public virtual ICESApi ServiceApi => _serviceApi ?? (_serviceApi = new CESApi(GetAPIKey(UserConnection), ServiceUrl));
		...
		public virtual ISenderDomainCacheService SenderDomainCacheService =>
			...
			(_senderDomainCacheService = new SenderDomainCacheService(UserConnection, ServiceApi));
		...
		public virtual CloudSenderDomainsInfo AddSenderDomain(string domain) {
			...
			SenderDomainCacheService.AddDomainToCache(addSenderDomainsInfoRequest);
		...
		public CloudSenderDomainsInfo AddSenderDomain(AddSenderDomainsInfoRequest addSenderDomainsInfoRequest) {
			addSenderDomainsInfoRequest.ApiKey = ServiceApi.ApiKey;
			SenderDomainCacheService.AddDomainToCache(addSenderDomainsInfoRequest);

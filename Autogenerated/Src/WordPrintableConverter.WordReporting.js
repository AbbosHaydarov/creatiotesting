				...
				function(next, convertedData) {
					const entityDto = {
						...
						columnValues: {
							Id: dto.id,
							Caption: dto.caption,
							SysModule: dto.moduleId
								? {value: dto.moduleId, displayValue: dto.moduleName}
								: null,
							ModuleSchemaName: dto.moduleSchemaName,
							SysEntitySchema: dto.entitySchemaId
								? {value: dto.entitySchemaId, displayValue: dto.entitySchemaCaption}
								: null,
			...
			Terrasoft.chain(
				...
				function(next, convertedData) {
					const angularDto = {
						...
						entitySchemaId: columnValues.SysEntitySchema?.value,
						entitySchemaName: columnValues.SysEntitySchema?.displayValue,

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CallFolderSchema : Terrasoft.Configuration.CallFolder_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Call folder.
	/// </summary>
	public class CallFolder : Terrasoft.Configuration.CallFolder_CrtCoreBase_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("CallFolderDeleting", e);
			Inserted += (s, e) => ThrowEvent("CallFolderInserted", e);
			Inserting += (s, e) => ThrowEvent("CallFolderInserting", e);
			Saved += (s, e) => ThrowEvent("CallFolderSaved", e);
			Saving += (s, e) => ThrowEvent("CallFolderSaving", e);
	...
	/// <exclude/>
	public partial class CallFolder_CrtCaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.CallFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : CallFolder
	{

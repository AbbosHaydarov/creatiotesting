namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MailBoxType_CrtSLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : MailBoxType
	{

		...
		function(Terrasoft, resources, ModalBox, AcademyUtilities) {
			return {
				...
				methods: {
					 ...
					 * @private
					 */
					_getModalBoxCaption: function(mappingType) {
						const strings = resources.localizableStrings;
						switch (mappingType) {
							case Terrasoft.MappingEnums.MappingType.ALL:
								return strings.HeaderCaption;
							case Terrasoft.MappingEnums.MappingType.LOOKUP:
								return strings.HeaderCaptionLookupMapping;
							case Terrasoft.MappingEnums.MappingType.SYSTEM_SETTINGS:
								return strings.HeaderSysSettingsMappingCaption;
							case Terrasoft.MappingEnums.MappingType.COMPOSITE_OBJECT_CONFIGURATION:
								return strings.HeaderCompositeObjectMappingCaption;
							default:
								return strings.HeaderCaptionParametersMapping;
						}
					},
					...
					setModalBoxCaption: function(mappingType) {
						const caption = this._getModalBoxCaption(mappingType);

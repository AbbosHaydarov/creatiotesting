namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysLicPackage_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysLicPackage
	{

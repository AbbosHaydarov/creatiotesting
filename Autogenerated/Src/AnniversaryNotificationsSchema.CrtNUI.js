		...
		return {
			...
			methods: {
				...
				getSubjectCaptionTemplate: function() {
					const contactCaption = this.getIsFeatureEnabled("UseYearAndAgeInAnniversaryNotifications")
						? resources.localizableStrings.ContactCaption
						: resources.localizableStrings.ContactWithoutYearCaption;
				...
				getFormattedDate: function(date) {
					...
					return (this.getIsFeatureDisabled("UseYearAndAgeInAnniversaryNotifications") && this.getIsContactFilled())
						? this.Ext.Date.format(date, Terrasoft.Resources.CultureSettings.shortMonthDayPattern)
						: this.Terrasoft.getTypedStringValue(date, this.Terrasoft.DataValueType.DATE);
				},

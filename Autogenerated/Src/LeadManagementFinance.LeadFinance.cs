namespace Terrasoft.Core.Process
{
	...
	#region Class: LeadManagementFinanceSchema

	/// <exclude/>
	public class LeadManagementFinanceSchema : Terrasoft.Core.Process.ProcessSchema
	{

		#region Constructors: Public

		public LeadManagementFinanceSchema(ProcessSchemaManager processSchemaManager)
			: base(processSchemaManager) {
		}

		public LeadManagementFinanceSchema(LeadManagementFinanceSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "LeadManagementFinance";
			UId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4");
			...
			Tag = @"LeadManagementFinance";
			TaskFillDefColor = Color.FromArgb(-1);
			UsageType = ProcessSchemaUsageType.Advanced;
			ZipMethodsBody = new byte[] { 31,139,8,0,0,0,0,0,0,10,3,0,0,0,0,0,0,0,0,0 };
			ZipCompiledMethodsBody = new byte[] { 31,139,8,0,0,0,0,0,0,10,3,0,0,0,0,0,0,0,0,0 };
			RealUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4");
			Version = 0;
		...
		protected virtual ProcessSchemaParameter CreateLeadIdParameter() {
			...
			UId = new Guid("dcaf025e-49c8-42ea-8f2d-0ffad1fb7e33"),
				...
				CreatedInSchemaUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4"),
				...
				ModifiedInSchemaUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4"),
				Name = @"LeadId",
		...
		protected virtual void InitializeQualificationSubProcessParameters(IParametrizedProcessSchemaElement parametrizedElement) {
			...
			var leadSurnameParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("e4fccbd1-548b-4577-bbf5-0afd249fdd8f"),
				ContainerUId = new Guid("00173f2d-130c-458b-950c-ccbef1bc016e"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
			...
			leadSurnameParameter.SourceValue = new ProcessSchemaParameterValue(leadSurnameParameter) {
				Source = ProcessSchemaParameterValueSource.Script,
				Value = @"[#[IsOwnerSchema:false].[IsSchema:false].[Element:{71939dca-8599-4c6d-963d-6537e0a150d0}].[Parameter:{410ce1cd-f5a9-43a4-81dd-e3ddcc55020d}].[EntityColumn:{80a487af-920e-456e-8c99-2c7169e81e1e}]#]",
				MetaPath = null,
				ModifiedInSchemaUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4")
			};
			parametrizedElement.Parameters.Add(leadSurnameParameter);
			var leadGivenNameParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("8aeb4d49-55b5-4e24-9bd2-d372aa6e42a9"),
				ContainerUId = new Guid("00173f2d-130c-458b-950c-ccbef1bc016e"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("c4108abc-2fe9-4cff-9e55-11734837c9bf"),
			...
			leadGivenNameParameter.SourceValue = new ProcessSchemaParameterValue(leadGivenNameParameter) {
				Source = ProcessSchemaParameterValueSource.Script,
				Value = @"[#[IsOwnerSchema:false].[IsSchema:false].[Element:{71939dca-8599-4c6d-963d-6537e0a150d0}].[Parameter:{410ce1cd-f5a9-43a4-81dd-e3ddcc55020d}].[EntityColumn:{fa32ffce-a15e-4f8e-b094-02665656ded2}]#]",
				MetaPath = null,
				ModifiedInSchemaUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4")
			};
			parametrizedElement.Parameters.Add(leadGivenNameParameter);
			var leadMiddleNameParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("ba65d940-8c47-445c-9d4d-1def172a8588"),
				ContainerUId = new Guid("00173f2d-130c-458b-950c-ccbef1bc016e"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("c4108abc-2fe9-4cff-9e55-11734837c9bf"),
			...
			leadMiddleNameParameter.SourceValue = new ProcessSchemaParameterValue(leadMiddleNameParameter) {
				Source = ProcessSchemaParameterValueSource.Script,
				Value = @"[#[IsOwnerSchema:false].[IsSchema:false].[Element:{71939dca-8599-4c6d-963d-6537e0a150d0}].[Parameter:{410ce1cd-f5a9-43a4-81dd-e3ddcc55020d}].[EntityColumn:{19eea159-62cb-40d3-acae-ba71c50426f0}]#]",
				MetaPath = null,
				ModifiedInSchemaUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4")
			};
			parametrizedElement.Parameters.Add(leadMiddleNameParameter);
		}
		...
		protected virtual void InitializeReadLeadDataParameters(IParametrizedProcessSchemaElement parametrizedElement) {
			...
			var resultCompositeObjectListParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("7bd47fef-295a-4f67-8d48-40c0a3427f34"),
				ContainerUId = new Guid("71939dca-8599-4c6d-963d-6537e0a150d0"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("cb455b6f-78ff-4b1e-b241-c2bbc0b37e9f"),
			...
			var considerTimeInFilterParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("8403a008-75d5-4e5e-8b71-854d6c175947"),
				ContainerUId = new Guid("71939dca-8599-4c6d-963d-6537e0a150d0"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = Guid.Empty,
				CreatedInSchemaUId = new Guid("cb455b6f-78ff-4b1e-b241-c2bbc0b37e9f"),
		...
		protected virtual void InitializeChangeDataUserTask1Parameters(IParametrizedProcessSchemaElement parametrizedElement) {
			var entitySchemaUIdParameter = new ProcessSchemaParameter(this) {
				...
				UId = new Guid("2da7f1cb-99de-4b4c-853a-aa6633abe365"),
				ContainerUId = new Guid("a3e9ccac-4b48-4599-aa07-c2549f468242"),
				CreatedInOwnerSchemaUId = Guid.Empty,
			...
			var isMatchConditionsParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("5adced1a-511b-464d-899c-8a13cb6f1318"),
				ContainerUId = new Guid("a3e9ccac-4b48-4599-aa07-c2549f468242"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6"),
				CreatedInSchemaUId = new Guid("d3021ca7-7450-4678-a117-060171eb2976"),
			...
			var dataSourceFiltersParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("5117071c-e5b7-411d-99b7-d011e6e30348"),
				ContainerUId = new Guid("a3e9ccac-4b48-4599-aa07-c2549f468242"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6"),
				CreatedInSchemaUId = new Guid("d3021ca7-7450-4678-a117-060171eb2976"),
			...
			dataSourceFiltersParameter.SourceValue = new ProcessSchemaParameterValue(dataSourceFiltersParameter) {
				Source = ProcessSchemaParameterValueSource.ConstValue,
				Value = Encoding.UTF8.GetString(Compressor.UnZip(new byte[] { 31,139,8,0,0,0,0,0,0,10,213,83,77,107,220,48,20,252,47,58,244,100,21,219,146,44,201,61,46,219,178,80,210,64,211,82,72,150,240,36,61,101,5,254,216,216,50,77,48,251,223,43,175,179,41,228,80,74,111,5,29,158,158,52,163,153,225,105,190,15,227,199,208,68,28,106,15,205,136,217,180,115,53,201,25,230,70,10,78,77,85,74,202,117,206,168,17,66,80,239,144,9,171,1,139,202,145,172,131,22,107,178,162,183,46,68,146,133,136,237,88,223,206,191,73,227,48,97,118,239,207,155,175,246,128,45,124,91,30,224,5,120,165,81,83,41,114,67,57,26,67,149,5,75,189,103,218,84,92,241,2,45,89,181,48,33,165,229,37,167,10,77,65,57,115,130,170,156,115,234,181,45,42,81,128,84,12,73,214,160,143,219,167,227,128,227,24,250,174,158,241,181,190,121,62,38,149,235,219,155,190,153,218,142,100,45,70,184,134,120,168,9,96,142,92,88,160,150,107,65,185,71,73,129,105,71,25,24,89,74,149,140,22,146,100,22,142,113,161,37,187,100,219,65,132,239,208,76,120,102,158,67,210,88,178,188,80,162,74,216,130,217,164,177,204,169,170,148,76,121,85,94,35,171,180,54,175,121,125,154,66,170,195,120,53,181,56,4,251,18,59,166,252,250,161,158,109,223,197,161,111,22,234,171,243,245,27,124,138,107,184,47,71,63,86,67,49,245,23,16,57,101,211,136,155,38,96,23,183,157,237,93,232,30,86,206,211,41,65,218,35,12,97,188,164,176,125,156,160,33,217,16,30,14,127,76,107,51,141,177,111,255,35,171,89,178,153,56,210,144,157,229,46,51,232,194,120,108,224,249,188,175,201,187,199,169,143,31,62,35,184,181,34,111,16,53,185,35,206,130,207,75,129,105,224,173,162,188,68,160,202,151,142,230,222,131,43,188,145,200,216,29,73,42,254,129,251,118,55,126,249,217,93,254,192,170,122,255,62,117,223,52,174,47,200,122,254,27,57,167,253,34,104,127,74,235,23,151,226,157,164,202,3,0,0 })),
				MetaPath = null,
				ModifiedInSchemaUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4")
			};
			parametrizedElement.Parameters.Add(dataSourceFiltersParameter);
			var recordColumnValuesParameter = new ProcessSchemaParameter(this) {
				UId = new Guid("33bc620b-1409-421f-b254-dbdbe357c26b"),
				ContainerUId = new Guid("a3e9ccac-4b48-4599-aa07-c2549f468242"),
				CreatedInOwnerSchemaUId = Guid.Empty,
				CreatedInPackageId = new Guid("66e9e705-64b4-4dda-925e-d1e05a389eb6"),
				CreatedInSchemaUId = new Guid("d3021ca7-7450-4678-a117-060171eb2976"),
			...
			recordColumnValuesParameter.SourceValue = new ProcessSchemaParameterValue(recordColumnValuesParameter) {
				Source = ProcessSchemaParameterValueSource.ConstValue,
				Value = Encoding.UTF8.GetString(Compressor.UnZip(new byte[] { 31,139,8,0,0,0,0,0,0,10,213,84,81,79,219,48,16,254,43,149,225,1,164,186,178,99,199,113,242,10,76,66,130,13,1,227,133,246,225,98,159,33,82,154,160,196,221,196,170,254,247,93,211,118,20,180,105,26,123,217,18,41,81,236,251,190,239,238,114,254,150,236,48,62,63,33,43,216,45,118,29,244,109,136,147,147,182,195,201,85,215,58,236,251,201,69,235,160,174,190,65,89,227,21,116,48,199,136,221,29,212,11,236,47,170,62,142,71,175,97,108,204,14,191,12,187,172,184,95,178,243,136,243,207,231,158,216,149,211,153,205,148,225,174,76,45,215,144,40,94,122,109,184,76,130,206,81,121,155,165,142,192,174,173,23,243,230,18,35,92,65,124,100,197,146,13,108,68,96,77,138,101,146,6,174,114,45,185,78,84,224,160,157,224,46,179,74,43,99,33,131,192,86,99,214,187,71,156,195,32,250,2,214,18,130,205,49,231,89,42,74,174,177,44,185,117,224,120,8,42,47,141,182,90,162,91,131,183,241,47,192,155,216,85,205,3,149,214,56,136,71,247,7,247,231,253,167,175,13,118,55,131,74,17,160,238,113,54,161,213,55,11,103,53,206,177,137,197,50,147,185,202,189,3,110,211,60,231,218,25,207,115,163,60,55,169,202,80,128,76,133,23,43,2,252,232,109,177,212,82,56,148,206,243,144,2,65,20,104,110,165,247,156,186,228,157,75,83,145,8,191,134,156,53,177,138,207,39,67,199,138,165,21,160,45,245,128,231,137,64,174,83,131,84,34,73,38,46,147,38,71,43,81,226,106,118,48,27,143,166,108,202,198,163,127,185,150,0,42,9,193,33,39,78,170,37,88,228,165,200,53,23,137,49,41,221,30,125,242,191,212,34,115,68,162,203,185,73,28,141,158,240,138,131,3,42,8,50,233,82,161,19,19,72,232,96,118,60,185,237,170,249,209,241,122,12,125,213,63,213,240,124,247,187,105,188,70,240,163,122,253,240,16,97,242,161,234,250,56,170,232,204,141,218,48,234,176,95,212,145,226,71,116,168,106,116,177,106,155,201,5,80,68,67,21,237,55,239,207,105,54,33,127,207,115,89,121,95,227,150,104,191,3,79,175,172,102,191,7,203,233,198,177,166,172,152,254,202,179,182,239,205,191,127,237,90,111,13,139,50,159,178,155,118,209,185,53,163,90,127,236,12,100,80,16,219,139,255,228,177,187,54,28,3,236,18,26,120,192,238,35,41,14,240,97,235,148,186,49,136,223,82,222,59,98,239,75,5,18,145,139,12,201,16,189,73,120,153,209,92,121,129,70,218,82,136,80,82,32,161,175,49,96,135,141,195,119,38,54,40,191,36,179,243,86,90,105,22,117,61,8,244,67,253,107,179,222,38,190,221,57,221,155,195,61,134,214,87,161,66,127,222,188,39,163,21,91,173,102,171,239,24,127,212,239,119,6,0,0 })),
				MetaPath = null,
				ModifiedInSchemaUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4")
			};
		...
		protected override void InitializeBaseElements() {
			...
			ProcessSchemaLaneSet schemaLeadManagementFinanceLaneSet = CreateLeadManagementFinanceLaneSetLaneSet();
			LaneSets.Add(schemaLeadManagementFinanceLaneSet);
			ProcessSchemaLane schemaLeadManagementFinanceLane = CreateLeadManagementFinanceLaneLane();
			schemaLeadManagementFinanceLaneSet.Lanes.Add(schemaLeadManagementFinanceLane);
		...
		protected virtual ProcessSchemaSequenceFlow CreateSequenceFlow5SequenceFlow() {
			ProcessSchemaSequenceFlow schemaFlow = new ProcessSchemaSequenceFlow(this, ProcessSchemaEditSequenceFlowType.Sequence) {
				...
				TargetRefUId = new Guid("4e2dcc82-0308-4edd-9844-1ed0b1629ce3"),
		...
		protected virtual ProcessSchemaSequenceFlow CreateSequenceFlowAfterQualificationSequenceFlow() {
			...
			schemaFlow.PolylinePointPositions.Add(new Point(861, 434));
			schemaFlow.PolylinePointPositions.Add(new Point(314, 434));
			return schemaFlow;
		}
		...
		protected virtual ProcessSchemaSequenceFlow CreateSequenceFlowAfterDistributionSequenceFlow() {
			...
			schemaFlow.PolylinePointPositions.Add(new Point(987, 461));
			schemaFlow.PolylinePointPositions.Add(new Point(314, 461));
			return schemaFlow;
		}
		...
		protected virtual ProcessSchemaSequenceFlow CreateSequenceFlowAfterHandoffSequenceFlow() {
			...
			schemaFlow.PolylinePointPositions.Add(new Point(1113, 487));
			schemaFlow.PolylinePointPositions.Add(new Point(314, 487));
			return schemaFlow;
		}
		...
		protected virtual ProcessSchemaSequenceFlow CreateSequenceFlowAfterAwaitingSalesSequenceFlow() {
			...
			schemaFlow.PolylinePointPositions.Add(new Point(1239, 514));
			schemaFlow.PolylinePointPositions.Add(new Point(314, 514));
			return schemaFlow;
		}
		...
		protected virtual ProcessSchemaSequenceFlow CreateSequenceFlow1SequenceFlow() {
			ProcessSchemaSequenceFlow schemaFlow = new ProcessSchemaSequenceFlow(this, ProcessSchemaEditSequenceFlowType.Sequence) {
				Name = "SequenceFlow1",
				UId = new Guid("bff0a4e6-f8da-44e9-8228-c275bbcdf55e"),
				ContainerItemIndex = 0,
				ContainerUId = Guid.Empty,
				CreatedInOwnerSchemaUId = new Guid("bb4d6607-026b-4b27-b640-8f5c77c1e89d"),
				CreatedInPackageId = new Guid("dde4f4da-9d1e-43c2-84fa-4954487c1f6e"),
				...
				SequenceFlowStartPointPosition = new Point(0, 0),
				Size = new Size(0, 0),
				SourceRefUId = new Guid("4e2dcc82-0308-4edd-9844-1ed0b1629ce3"),
				SourceSequenceFlowPointLocalPosition = new Point(1, 0),
				StrokeColor = Color.FromArgb(-7105128),
		...
		protected virtual ProcessSchemaConditionalFlow CreateConditionalSequenceFlow1ConditionalFlow() {
			ProcessSchemaConditionalFlow schemaFlow = new ProcessSchemaConditionalFlow(this) {
				...
				UId = new Guid("913d2116-cf5e-4491-9c53-b903e8746983"),
				ConditionExpression = @"String.IsNullOrEmpty([#[IsOwnerSchema:false].[IsSchema:false].[Element:{71939dca-8599-4c6d-963d-6537e0a150d0}].[Parameter:{410ce1cd-f5a9-43a4-81dd-e3ddcc55020d}].[EntityColumn:{865eb25f-3941-423f-a4c0-c7834368a7af}]#])&&(!String.IsNullOrEmpty([#[IsOwnerSchema:false].[IsSchema:false].[Element:{71939dca-8599-4c6d-963d-6537e0a150d0}].[Parameter:{410ce1cd-f5a9-43a4-81dd-e3ddcc55020d}].[EntityColumn:{80a487af-920e-456e-8c99-2c7169e81e1e}]#]) || !String.IsNullOrEmpty([#[IsOwnerSchema:false].[IsSchema:false].[Element:{71939dca-8599-4c6d-963d-6537e0a150d0}].[Parameter:{410ce1cd-f5a9-43a4-81dd-e3ddcc55020d}].[EntityColumn:{fa32ffce-a15e-4f8e-b094-02665656ded2}]#]) || !String.IsNullOrEmpty([#[IsOwnerSchema:false].[IsSchema:false].[Element:{71939dca-8599-4c6d-963d-6537e0a150d0}].[Parameter:{410ce1cd-f5a9-43a4-81dd-e3ddcc55020d}].[EntityColumn:{19eea159-62cb-40d3-acae-ba71c50426f0}]#]))",
				ContainerItemIndex = 0,
				ContainerUId = Guid.Empty,
				CreatedInOwnerSchemaUId = new Guid("bb4d6607-026b-4b27-b640-8f5c77c1e89d"),
				CreatedInPackageId = new Guid("dde4f4da-9d1e-43c2-84fa-4954487c1f6e"),
				...
				SourceSequenceFlowPointLocalPosition = new Point(0, -1),
				StrokeColor = Color.FromArgb(-7105128),
				TargetRefUId = new Guid("a3e9ccac-4b48-4599-aa07-c2549f468242"),
				TargetSequenceFlowPointLocalPosition = new Point(-1, 0),
				UseBackgroundMode = false,
				VisualType = ProcessSchemaSequenceFlowVisualType.AutoPolyline,
			};
			schemaFlow.PolylinePointPositions.Add(new Point(437, 296));
			return schemaFlow;
		}
		...
		protected virtual ProcessSchemaSequenceFlow CreateSequenceFlow2SequenceFlow() {
			ProcessSchemaSequenceFlow schemaFlow = new ProcessSchemaSequenceFlow(this, ProcessSchemaEditSequenceFlowType.Sequence) {
				Name = "SequenceFlow2",
				UId = new Guid("04141af4-5874-4505-aa81-5648ecc76e93"),
				ContainerItemIndex = 0,
				ContainerUId = Guid.Empty,
				CreatedInOwnerSchemaUId = new Guid("bb4d6607-026b-4b27-b640-8f5c77c1e89d"),
				CreatedInPackageId = new Guid("dde4f4da-9d1e-43c2-84fa-4954487c1f6e"),
				...
				SequenceFlowStartPointPosition = new Point(0, 0),
				Size = new Size(0, 0),
				SourceRefUId = new Guid("a3e9ccac-4b48-4599-aa07-c2549f468242"),
				SourceSequenceFlowPointLocalPosition = new Point(0, 1),
				StrokeColor = Color.FromArgb(-7105128),
				TargetRefUId = new Guid("1730fd69-e909-49b4-bee7-2e358d794c12"),
				TargetSequenceFlowPointLocalPosition = new Point(-1, 0),
			...
			schemaFlow.PolylinePointPositions.Add(new Point(542, 155));
			return schemaFlow;
		}

		protected virtual ProcessSchemaLaneSet CreateLeadManagementFinanceLaneSetLaneSet() {
			ProcessSchemaLaneSet schemaLeadManagementFinanceLaneSet = new ProcessSchemaLaneSet(this) {
				...
				ModifiedInSchemaUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4"),
				Name = @"LeadManagementFinanceLaneSet",
				Position = new Point(5, 5),
				Size = new Size(1318, 402),
				UseBackgroundMode = false
			};
			return schemaLeadManagementFinanceLaneSet;
		}

		protected virtual ProcessSchemaLane CreateLeadManagementFinanceLaneLane() {
			ProcessSchemaLane schemaLeadManagementFinanceLane = new ProcessSchemaLane(this) {
				...
				ModifiedInSchemaUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4"),
				Name = @"LeadManagementFinanceLane",
				Position = new Point(29, 0),
				Size = new Size(1289, 402),
				UseBackgroundMode = false
			};
			return schemaLeadManagementFinanceLane;
		}
		...
		protected virtual ProcessSchemaExclusiveGateway CreateExclusiveGateway1ExclusiveGateway() {
			ProcessSchemaExclusiveGateway gateway = new ProcessSchemaExclusiveGateway(this) {
				UId = new Guid("4e2dcc82-0308-4edd-9844-1ed0b1629ce3"),
				ContainerItemIndex = 0,
				ContainerUId = new Guid("2dff3312-98bc-4d7a-a7b0-f854e675b32a"),
				CreatedInOwnerSchemaUId = new Guid("bb4d6607-026b-4b27-b640-8f5c77c1e89d"),
				CreatedInPackageId = new Guid("dde4f4da-9d1e-43c2-84fa-4954487c1f6e"),
		...
		protected virtual ProcessSchemaUserTask CreateChangeDataUserTask1UserTask() {
			ProcessSchemaUserTask schemaTask = new ProcessSchemaUserTask(this) {
				UId = new Guid("a3e9ccac-4b48-4599-aa07-c2549f468242"),
				ContainerItemIndex = 0,
				ContainerUId = new Guid("2dff3312-98bc-4d7a-a7b0-f854e675b32a"),
				CreatedInOwnerSchemaUId = new Guid("bb4d6607-026b-4b27-b640-8f5c77c1e89d"),
				CreatedInPackageId = new Guid("dde4f4da-9d1e-43c2-84fa-4954487c1f6e"),
		...
		public override Process CreateProcess(UserConnection userConnection) {
			return new LeadManagementFinance(userConnection);
		}

		public override object Clone() {
			return new LeadManagementFinanceSchema(this);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4"));
		}
	...
	#region Class: LeadManagementFinance

	/// <exclude/>
	public class LeadManagementFinance : Terrasoft.Core.Process.Process
	{

		#region Class: ProcessLeadManagementFinanceLane

		/// <exclude/>
		public class ProcessLeadManagementFinanceLane : ProcessLane
		{

			public ProcessLeadManagementFinanceLane(UserConnection userConnection, LeadManagementFinance process)
				: base(userConnection) {
				Owner = process;
		...
		public class ReadLeadDataFlowElement : ReadDataUserTask
		{
			...
			public ReadLeadDataFlowElement(UserConnection userConnection, LeadManagementFinance process)
				: base(userConnection) {
				UId = Guid.NewGuid();
				Owner = process;
			...
			public override string DataSourceFilters {
				get {
					return _dataSourceFilters ?? (_dataSourceFilters = Encoding.UTF8.GetString(Compressor.UnZip(new byte[] { 31,139,8,0,0,0,0,0,0,10,213,147,79,107,220,48,16,197,191,139,14,61,89,69,178,100,75,118,143,203,182,44,148,52,208,180,20,146,37,140,165,81,86,224,63,27,75,166,9,102,191,123,229,117,54,133,28,74,233,173,224,195,104,164,247,244,155,135,60,223,251,240,209,183,17,199,218,65,27,48,155,118,182,38,194,72,208,162,40,168,229,218,82,233,114,69,117,14,21,149,10,10,198,92,46,81,84,36,235,161,195,154,172,234,173,245,145,100,62,98,23,234,219,249,183,105,28,39,204,238,221,121,241,213,28,176,131,111,203,5,146,131,211,21,86,84,21,172,161,18,155,134,106,3,134,58,39,170,166,148,90,114,52,100,101,145,37,103,92,57,78,11,151,39,2,135,154,54,156,105,138,214,49,81,230,150,149,170,33,89,139,46,110,159,142,35,134,224,135,190,158,241,181,190,121,62,38,202,245,238,205,208,78,93,79,178,14,35,92,67,60,212,4,144,161,44,12,80,35,171,98,113,87,20,68,101,169,128,70,229,74,35,47,185,34,153,129,99,92,108,201,206,146,204,66,132,239,208,78,120,118,158,125,98,204,5,227,186,40,147,150,11,67,165,200,25,213,165,86,212,217,210,85,40,202,170,106,236,37,175,79,147,79,181,15,87,83,135,163,55,47,177,99,202,111,24,235,217,12,125,28,135,118,177,190,58,31,191,193,167,184,134,251,178,245,99,29,40,166,254,34,34,167,108,10,184,105,61,246,113,219,155,193,250,254,97,245,60,157,146,164,59,194,232,195,37,133,237,227,4,45,201,70,255,112,248,99,90,155,41,196,161,251,143,70,205,210,152,201,35,61,178,51,238,242,6,173,15,199,22,158,207,235,154,188,123,156,134,248,225,51,130,93,43,242,70,81,147,59,98,13,56,150,23,72,101,101,52,149,57,2,213,46,183,148,57,7,150,187,70,161,16,119,36,81,252,131,247,237,46,124,249,217,95,254,129,149,122,255,62,117,223,52,174,47,202,122,254,27,156,211,126,1,218,159,210,247,11,49,170,147,157,202,3,0,0 })));
				}
				set {
		...
		public class QualificationSubProcessFlowElement : SubProcessProxy
		{
			...
			public QualificationSubProcessFlowElement(UserConnection userConnection, LeadManagementFinance process)
				: base(userConnection, process) {
				InitialSchemaUId = new Guid("c4108abc-2fe9-4cff-9e55-11734837c9bf");
			}
			...
			public string LeadSurname {
				get {
					return GetParameterValue<string>("LeadSurname");
				}
				set {
					SetParameterValue("LeadSurname", value);
				}
			}

			public string LeadGivenName {
				get {
					return GetParameterValue<string>("LeadGivenName");
				}
				set {
					SetParameterValue("LeadGivenName", value);
				}
			}

			public string LeadMiddleName {
				get {
					return GetParameterValue<string>("LeadMiddleName");
				}
				set {
					SetParameterValue("LeadMiddleName", value);
				}
			}
			...
			protected override void InitializeOwnProperties(Process owner) {
				...
				var process = (LeadManagementFinance)owner;
				Name = "QualificationSubProcess";
				SerializeToDB = true;
				IsLogging = true;
				SchemaElementUId = new Guid("00173f2d-130c-458b-950c-ccbef1bc016e");
				CreatedInSchemaUId = process.InternalSchemaUId;
				ProcessLane = process.LeadManagementFinanceLane;
			}
			...
			protected override void InitializeParameterValues() {
				...
				SetParameterValue("LeadSurname", new LocalizableString(((process.ReadLeadData.ResultEntity.IsColumnValueLoaded(process.ReadLeadData.ResultEntity.Schema.Columns.GetByName("Surname").ColumnValueName) ? process.ReadLeadData.ResultEntity.GetTypedColumnValue<string>("Surname") : null))));
				SetParameterValue("LeadGivenName", new LocalizableString(((process.ReadLeadData.ResultEntity.IsColumnValueLoaded(process.ReadLeadData.ResultEntity.Schema.Columns.GetByName("GivenName").ColumnValueName) ? process.ReadLeadData.ResultEntity.GetTypedColumnValue<string>("GivenName") : null))));
				SetParameterValue("LeadMiddleName", new LocalizableString(((process.ReadLeadData.ResultEntity.IsColumnValueLoaded(process.ReadLeadData.ResultEntity.Schema.Columns.GetByName("MiddleName").ColumnValueName) ? process.ReadLeadData.ResultEntity.GetTypedColumnValue<string>("MiddleName") : null))));
			}
		...
		public class DistributionSubProcessFlowElement : SubProcessProxy
		{
			...
			public DistributionSubProcessFlowElement(UserConnection userConnection, LeadManagementFinance process)
				: base(userConnection, process) {
				InitialSchemaUId = new Guid("753374fe-fdb2-4c4d-9a02-7f8fc6ec273a");
			}
		...
		public class HandoffSubProcessFlowElement : SubProcessProxy
		{
			...
			public HandoffSubProcessFlowElement(UserConnection userConnection, LeadManagementFinance process)
				: base(userConnection, process) {
				InitialSchemaUId = new Guid("604808a6-567a-468c-889a-a25a7223d7e4");
			}
		...
		public class AwaitingSalesSubProcessFlowElement : SubProcessProxy
		{
			...
			public AwaitingSalesSubProcessFlowElement(UserConnection userConnection, LeadManagementFinance process)
				: base(userConnection, process) {
		...
		public class ChangeDataUserTask1FlowElement : ChangeDataUserTask
		{
			...
			public ChangeDataUserTask1FlowElement(UserConnection userConnection, LeadManagementFinance process)
				: base(userConnection) {
				UId = Guid.NewGuid();
				Owner = process;
				Type = "ProcessSchemaUserTask";
				Name = "ChangeDataUserTask1";
				IsLogging = true;
				SchemaElementUId = new Guid("a3e9ccac-4b48-4599-aa07-c2549f468242");
				CreatedInSchemaUId = process.InternalSchemaUId;
				_recordColumnValues_Contact = () => new LocalizableString(String.Concat(((process.ReadLeadData.ResultEntity.IsColumnValueLoaded(process.ReadLeadData.ResultEntity.Schema.Columns.GetByName("Surname").ColumnValueName) ? process.ReadLeadData.ResultEntity.GetTypedColumnValue<string>("Surname") : null)), "", ((process.ReadLeadData.ResultEntity.IsColumnValueLoaded(process.ReadLeadData.ResultEntity.Schema.Columns.GetByName("GivenName").ColumnValueName) ? process.ReadLeadData.ResultEntity.GetTypedColumnValue<string>("GivenName") : null)), "", ((process.ReadLeadData.ResultEntity.IsColumnValueLoaded(process.ReadLeadData.ResultEntity.Schema.Columns.GetByName("MiddleName").ColumnValueName) ? process.ReadLeadData.ResultEntity.GetTypedColumnValue<string>("MiddleName") : null))).Trim());
			}
			...
			internal Func<string> _recordColumnValues_Contact;
			...
			public override string DataSourceFilters {
				get {
					return _dataSourceFilters ?? (_dataSourceFilters = Encoding.UTF8.GetString(Compressor.UnZip(new byte[] { 31,139,8,0,0,0,0,0,0,10,213,83,77,107,220,48,20,252,47,58,244,100,21,219,146,44,201,61,46,219,178,80,210,64,211,82,72,150,240,36,61,101,5,254,216,216,50,77,48,251,223,43,175,179,41,228,80,74,111,5,29,158,158,52,163,153,225,105,190,15,227,199,208,68,28,106,15,205,136,217,180,115,53,201,25,230,70,10,78,77,85,74,202,117,206,168,17,66,80,239,144,9,171,1,139,202,145,172,131,22,107,178,162,183,46,68,146,133,136,237,88,223,206,191,73,227,48,97,118,239,207,155,175,246,128,45,124,91,30,224,5,120,165,81,83,41,114,67,57,26,67,149,5,75,189,103,218,84,92,241,2,45,89,181,48,33,165,229,37,167,10,77,65,57,115,130,170,156,115,234,181,45,42,81,128,84,12,73,214,160,143,219,167,227,128,227,24,250,174,158,241,181,190,121,62,38,149,235,219,155,190,153,218,142,100,45,70,184,134,120,168,9,96,142,92,88,160,150,107,65,185,71,73,129,105,71,25,24,89,74,149,140,22,146,100,22,142,113,161,37,187,100,219,65,132,239,208,76,120,102,158,67,210,88,178,188,80,162,74,216,130,217,164,177,204,169,170,148,76,121,85,94,35,171,180,54,175,121,125,154,66,170,195,120,53,181,56,4,251,18,59,166,252,250,161,158,109,223,197,161,111,22,234,171,243,245,27,124,138,107,184,47,71,63,86,67,49,245,23,16,57,101,211,136,155,38,96,23,183,157,237,93,232,30,86,206,211,41,65,218,35,12,97,188,164,176,125,156,160,33,217,16,30,14,127,76,107,51,141,177,111,255,35,171,89,178,153,56,210,144,157,229,46,51,232,194,120,108,224,249,188,175,201,187,199,169,143,31,62,35,184,181,34,111,16,53,185,35,206,130,207,75,129,105,224,173,162,188,68,160,202,151,142,230,222,131,43,188,145,200,216,29,73,42,254,129,251,118,55,126,249,217,93,254,192,170,122,255,62,117,223,52,174,47,200,122,254,27,57,167,253,34,104,127,74,235,23,151,226,157,164,202,3,0,0 })));
				}
				set {
					_dataSourceFilters = value;
				}
			...
			public override EntityColumnMappingValues RecordColumnValues {
				get {
					if (_recordColumnValues == null) {
						var zippedData = new byte[] { 31,139,8,0,0,0,0,0,0,10,213,84,81,79,219,48,16,254,43,149,225,1,164,186,178,99,199,113,242,10,76,66,130,13,1,227,133,246,225,98,159,33,82,154,160,196,221,196,170,254,247,93,211,118,20,180,105,26,123,217,18,41,81,236,251,190,239,238,114,254,150,236,48,62,63,33,43,216,45,118,29,244,109,136,147,147,182,195,201,85,215,58,236,251,201,69,235,160,174,190,65,89,227,21,116,48,199,136,221,29,212,11,236,47,170,62,142,71,175,97,108,204,14,191,12,187,172,184,95,178,243,136,243,207,231,158,216,149,211,153,205,148,225,174,76,45,215,144,40,94,122,109,184,76,130,206,81,121,155,165,142,192,174,173,23,243,230,18,35,92,65,124,100,197,146,13,108,68,96,77,138,101,146,6,174,114,45,185,78,84,224,160,157,224,46,179,74,43,99,33,131,192,86,99,214,187,71,156,195,32,250,2,214,18,130,205,49,231,89,42,74,174,177,44,185,117,224,120,8,42,47,141,182,90,162,91,131,183,241,47,192,155,216,85,205,3,149,214,56,136,71,247,7,247,231,253,167,175,13,118,55,131,74,17,160,238,113,54,161,213,55,11,103,53,206,177,137,197,50,147,185,202,189,3,110,211,60,231,218,25,207,115,163,60,55,169,202,80,128,76,133,23,43,2,252,232,109,177,212,82,56,148,206,243,144,2,65,20,104,110,165,247,156,186,228,157,75,83,145,8,191,134,156,53,177,138,207,39,67,199,138,165,21,160,45,245,128,231,137,64,174,83,131,84,34,73,38,46,147,38,71,43,81,226,106,118,48,27,143,166,108,202,198,163,127,185,150,0,42,9,193,33,39,78,170,37,88,228,165,200,53,23,137,49,41,221,30,125,242,191,212,34,115,68,162,203,185,73,28,141,158,240,138,131,3,42,8,50,233,82,161,19,19,72,232,96,118,60,185,237,170,249,209,241,122,12,125,213,63,213,240,124,247,187,105,188,70,240,163,122,253,240,16,97,242,161,234,250,56,170,232,204,141,218,48,234,176,95,212,145,226,71,116,168,106,116,177,106,155,201,5,80,68,67,21,237,55,239,207,105,54,33,127,207,115,89,121,95,227,150,104,191,3,79,175,172,102,191,7,203,233,198,177,166,172,152,254,202,179,182,239,205,191,127,237,90,111,13,139,50,159,178,155,118,209,185,53,163,90,127,236,12,100,80,16,219,139,255,228,177,187,54,28,3,236,18,26,120,192,238,35,41,14,240,97,235,148,186,49,136,223,82,222,59,98,239,75,5,18,145,139,12,201,16,189,73,120,153,209,92,121,129,70,218,82,136,80,82,32,161,175,49,96,135,141,195,119,38,54,40,191,36,179,243,86,90,105,22,117,61,8,244,67,253,107,179,222,38,190,221,57,221,155,195,61,134,214,87,161,66,127,222,188,39,163,21,91,173,102,171,239,24,127,212,239,119,6,0,0 };
						string serializedData =
							Encoding.UTF8.GetString(Compressor.UnZip(zippedData));
						LocalizableParameterValuesList dataList =
							LocalizableParameterValuesList.DeserializeData(serializedData);
						dataList.InitializeLocalizableValues(Storage, "9128415ea81f4c7ca9bd143ed39eb5b4",
		...
		public LeadManagementFinance(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "LeadManagementFinance";
			SchemaUId = new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4");
		...
		private Guid InternalSchemaUId {
			get {
				return new Guid("9128415e-a81f-4c7c-a9bd-143ed39eb5b4");
			}
		}

		private string ConditionalExpressionLogMessage {
			get {
				return "Process: LeadManagementFinance, Source element: {0}, Conditional flow: {1}, Expression: {2}, Result: {3}";
			}
		}

		private string DeadEndGatewayLogMessage {
			get {
				return "Process: LeadManagementFinance, Source element: {0}, None of the exclusive gateway conditions are met!";
			}
		}
		...
		private ProcessLeadManagementFinanceLane _leadManagementFinanceLane;
		public ProcessLeadManagementFinanceLane LeadManagementFinanceLane {
			get {
				return _leadManagementFinanceLane ?? ((_leadManagementFinanceLane) = new ProcessLeadManagementFinanceLane(UserConnection, this));
			}
		}
		...
		public ProcessExclusiveGateway ExclusiveGateway1 {
			get {
				return _exclusiveGateway1 ?? (_exclusiveGateway1 = new ProcessExclusiveGateway() {
					...
					Type = "ProcessSchemaExclusiveGateway",
					Name = "ExclusiveGateway1",
					SchemaElementUId = new Guid("4e2dcc82-0308-4edd-9844-1ed0b1629ce3"),
					CreatedInSchemaUId = InternalSchemaUId,
					ExecutedEventHandler = OnExecuted,
						Question = GetLocalizableString(Schema.GetResourceManagerName(),
		...
		public ProcessConditionalFlow ConditionalSequenceFlow1 {
			get {
				return _conditionalSequenceFlow1 ?? (_conditionalSequenceFlow1 = new ProcessConditionalFlow() {
					...
					Type = "ProcessSchemaConditionalFlow",
					Name = "ConditionalSequenceFlow1",
					SchemaElementUId = new Guid("913d2116-cf5e-4491-9c53-b903e8746983"),
					CreatedInSchemaUId = InternalSchemaUId,
					ExecutedEventHandler = OnExecuted,
						MatchBranchingDecisions = new BranchingDecisionCollection() {
				},
		...
		public ProcessToken ExclusiveGatewayStageQualificationSubProcessToken {
			get {
				return _exclusiveGatewayStageQualificationSubProcessToken ?? (_exclusiveGatewayStageQualificationSubProcessToken = new ProcessToken(UserConnection) {
					...
					SchemaElementUId = new Guid("acc27427-909d-4145-a990-33cff9d1e59d"),
					CreatedInSchemaUId = InternalSchemaUId,
					ExecutedEventHandler = OnExecuted,
				});
			}
		...
		public ProcessToken ExclusiveGatewayStageDistributionSubProcessToken {
			get {
				return _exclusiveGatewayStageDistributionSubProcessToken ?? (_exclusiveGatewayStageDistributionSubProcessToken = new ProcessToken(UserConnection) {
					...
					SchemaElementUId = new Guid("46016924-4e80-42b4-95c3-e9d47b87f3fb"),
					CreatedInSchemaUId = InternalSchemaUId,
					ExecutedEventHandler = OnExecuted,
				});
			}
		...
		public ProcessToken ExclusiveGatewayStageHandoffSubProcessToken {
			get {
				return _exclusiveGatewayStageHandoffSubProcessToken ?? (_exclusiveGatewayStageHandoffSubProcessToken = new ProcessToken(UserConnection) {
					...
					SchemaElementUId = new Guid("7d2d6414-cff6-4323-918e-50a9d602ef5a"),
					CreatedInSchemaUId = InternalSchemaUId,
					ExecutedEventHandler = OnExecuted,
				});
			}
		...
		public ProcessToken ExclusiveGatewayStageAwaitingSalesSubProcessToken {
			get {
				return _exclusiveGatewayStageAwaitingSalesSubProcessToken ?? (_exclusiveGatewayStageAwaitingSalesSubProcessToken = new ProcessToken(UserConnection) {
					...
					SchemaElementUId = new Guid("03a84f82-11a1-4574-bd0b-ce8abd86e58f"),
					CreatedInSchemaUId = InternalSchemaUId,
					ExecutedEventHandler = OnExecuted,
				});
			}
		...
		private bool ConditionalSequenceFlow1ExpressionExecute() {
			bool result = Convert.ToBoolean(String.IsNullOrEmpty(((ReadLeadData.ResultEntity.IsColumnValueLoaded(ReadLeadData.ResultEntity.Schema.Columns.GetByName("Contact").ColumnValueName) ? ReadLeadData.ResultEntity.GetTypedColumnValue<string>("Contact") : null)))&&(!String.IsNullOrEmpty(((ReadLeadData.ResultEntity.IsColumnValueLoaded(ReadLeadData.ResultEntity.Schema.Columns.GetByName("Surname").ColumnValueName) ? ReadLeadData.ResultEntity.GetTypedColumnValue<string>("Surname") : null))) || !String.IsNullOrEmpty(((ReadLeadData.ResultEntity.IsColumnValueLoaded(ReadLeadData.ResultEntity.Schema.Columns.GetByName("GivenName").ColumnValueName) ? ReadLeadData.ResultEntity.GetTypedColumnValue<string>("GivenName") : null))) || !String.IsNullOrEmpty(((ReadLeadData.ResultEntity.IsColumnValueLoaded(ReadLeadData.ResultEntity.Schema.Columns.GetByName("MiddleName").ColumnValueName) ? ReadLeadData.ResultEntity.GetTypedColumnValue<string>("MiddleName") : null)))));
			Log.InfoFormat(ConditionalExpressionLogMessage, "ExclusiveGateway1", "ConditionalSequenceFlow1", "String.IsNullOrEmpty(((ReadLeadData.ResultEntity.IsColumnValueLoaded(ReadLeadData.ResultEntity.Schema.Columns.GetByName(\"Contact\").ColumnValueName) ? ReadLeadData.ResultEntity.GetTypedColumnValue<string>(\"Contact\") : null)))&&(!String.IsNullOrEmpty(((ReadLeadData.ResultEntity.IsColumnValueLoaded(ReadLeadData.ResultEntity.Schema.Columns.GetByName(\"Surname\").ColumnValueName) ? ReadLeadData.ResultEntity.GetTypedColumnValue<string>(\"Surname\") : null))) || !String.IsNullOrEmpty(((ReadLeadData.ResultEntity.IsColumnValueLoaded(ReadLeadData.ResultEntity.Schema.Columns.GetByName(\"GivenName\").ColumnValueName) ? ReadLeadData.ResultEntity.GetTypedColumnValue<string>(\"GivenName\") : null))) || !String.IsNullOrEmpty(((ReadLeadData.ResultEntity.IsColumnValueLoaded(ReadLeadData.ResultEntity.Schema.Columns.GetByName(\"MiddleName\").ColumnValueName) ? ReadLeadData.ResultEntity.GetTypedColumnValue<string>(\"MiddleName\") : null))))", result);
			return result;
		}
		...
		protected override void InitializeMetaPathParameterValues() {
			...
			MetaPathParameterValues.Add("7bd47fef-295a-4f67-8d48-40c0a3427f34", () => ReadLeadData.ResultCompositeObjectList);
			MetaPathParameterValues.Add("8403a008-75d5-4e5e-8b71-854d6c175947", () => ReadLeadData.ConsiderTimeInFilter);
			...
			MetaPathParameterValues.Add("e4fccbd1-548b-4577-bbf5-0afd249fdd8f", () => QualificationSubProcess.LeadSurname);
			MetaPathParameterValues.Add("8aeb4d49-55b5-4e24-9bd2-d372aa6e42a9", () => QualificationSubProcess.LeadGivenName);
			MetaPathParameterValues.Add("ba65d940-8c47-445c-9d4d-1def172a8588", () => QualificationSubProcess.LeadMiddleName);
			...
			MetaPathParameterValues.Add("2da7f1cb-99de-4b4c-853a-aa6633abe365", () => ChangeDataUserTask1.EntitySchemaUId);
			MetaPathParameterValues.Add("5adced1a-511b-464d-899c-8a13cb6f1318", () => ChangeDataUserTask1.IsMatchConditions);
			MetaPathParameterValues.Add("5117071c-e5b7-411d-99b7-d011e6e30348", () => ChangeDataUserTask1.DataSourceFilters);
			MetaPathParameterValues.Add("33bc620b-1409-421f-b254-dbdbe357c26b", () => ChangeDataUserTask1.RecordColumnValues);
		}
		...
		public override object CloneShallow() {
			var cloneItem = (LeadManagementFinance)base.CloneShallow();

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class FormSubmit_CrtTouchInWebForm_TerrasoftSchema : Terrasoft.Configuration.FormSubmit_CrtEventInTouchPoint_TerrasoftSchema
	{
	...
	/// Submitted form.
	/// </summary>
	public class FormSubmit_CrtTouchInWebForm_Terrasoft : Terrasoft.Configuration.FormSubmit_CrtEventInTouchPoint_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("FormSubmit_CrtTouchInWebForm_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("FormSubmit_CrtTouchInWebForm_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("FormSubmit_CrtTouchInWebForm_TerrasoftInserted", e);
			Saved += (s, e) => ThrowEvent("FormSubmit_CrtTouchInWebForm_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("FormSubmit_CrtTouchInWebForm_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("FormSubmit_CrtTouchInWebForm_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class FormSubmit_CrtTouchInWebFormEventsProcess<TEntity> : Terrasoft.Configuration.FormSubmit_CrtEventInTouchPointEventsProcess<TEntity> where TEntity : FormSubmit_CrtTouchInWebForm_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	public class AdCampaign_CrtDigitalAdsApp_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("dcd99808-d7ba-5735-e3a4-0563ef4bd39f")) == null) {
				Columns.Add(CreateConversionsColumn());
			}
			if (Columns.FindByUId(new Guid("50b1e0bc-392e-0335-959a-2c0d87442a76")) == null) {
		...
		protected virtual EntitySchemaColumn CreateConversionsColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Float2")) {
				UId = new Guid("dcd99808-d7ba-5735-e3a4-0563ef4bd39f"),
				Name = @"Conversions",
				CreatedInSchemaUId = new Guid("0b416432-4385-432a-94ad-c30262cd14da"),
				ModifiedInSchemaUId = new Guid("0b416432-4385-432a-94ad-c30262cd14da"),
		...
		protected virtual EntitySchemaColumn CreateAllConversionsColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Float2")) {
				UId = new Guid("50b1e0bc-392e-0335-959a-2c0d87442a76"),
				Name = @"AllConversions",
				CreatedInSchemaUId = new Guid("0b416432-4385-432a-94ad-c30262cd14da"),
				ModifiedInSchemaUId = new Guid("0b416432-4385-432a-94ad-c30262cd14da"),
				CreatedInPackageId = new Guid("abf715ae-fc66-421f-87dc-256931a52a49")

namespace Terrasoft.Configuration
{
	...
	public class SysModuleReportLczOldSchema : Terrasoft.Configuration.BaseLczEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysModuleReportLczOld_CrtBaseEventsProcess(userConnection);
		}
	...
	public class SysModuleReportLczOld : Terrasoft.Configuration.BaseLczEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysModuleReportLczOld_CrtBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysModuleReportLczOld_CrtBaseEventsProcess

	/// <exclude/>
	public partial class SysModuleReportLczOld_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLczEntity_CrtBaseEventsProcess<TEntity> where TEntity : SysModuleReportLczOld
	{

		public SysModuleReportLczOld_CrtBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysModuleReportLczOld_CrtBaseEventsProcess";
	...
	/// <exclude/>
	public class SysModuleReportLczOld_CrtBaseEventsProcess : SysModuleReportLczOld_CrtBaseEventsProcess<SysModuleReportLczOld>
	{
	...
	public partial class SysModuleReportLczOld_CrtBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysModuleReportLczOldEventsProcess : SysModuleReportLczOld_CrtBaseEventsProcess
	{

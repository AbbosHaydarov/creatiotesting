namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class AddressType_SSP_TerrasoftSchema : Terrasoft.Configuration.AddressType_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Address type.
	/// </summary>
	public class AddressType_SSP_Terrasoft : Terrasoft.Configuration.AddressType_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class AddressType_SSPEventsProcess<TEntity> : Terrasoft.Configuration.AddressType_CrtCoreBaseEventsProcess<TEntity> where TEntity : AddressType_SSP_Terrasoft
	{

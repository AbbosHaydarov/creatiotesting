namespace Terrasoft.Configuration
{
	...
	public class EventInTagSchema : Terrasoft.Configuration.BaseEntityInTagSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EventInTag_CrtEventEventsProcess(userConnection);
		}
	...
	public class EventInTag : Terrasoft.Configuration.BaseEntityInTag
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new EventInTag_CrtEventEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("EventInTagDeleting", e);
			Inserted += (s, e) => ThrowEvent("EventInTagInserted", e);
			Inserting += (s, e) => ThrowEvent("EventInTagInserting", e);
			Saved += (s, e) => ThrowEvent("EventInTagSaved", e);
			Saving += (s, e) => ThrowEvent("EventInTagSaving", e);
	...
	#region Class: EventInTag_CrtEventEventsProcess

	/// <exclude/>
	public partial class EventInTag_CrtEventEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : EventInTag
	{

		public EventInTag_CrtEventEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "EventInTag_CrtEventEventsProcess";
	...
	/// <exclude/>
	public class EventInTag_CrtEventEventsProcess : EventInTag_CrtEventEventsProcess<EventInTag>
	{
	...
	public partial class EventInTag_CrtEventEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class EventInTagEventsProcess : EventInTag_CrtEventEventsProcess
	{

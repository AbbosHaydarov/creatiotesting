namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_MarketingCampaign_TerrasoftSchema : Terrasoft.Configuration.Lead_OpportunityManagement_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateTitleColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("5c06dbee-b035-41e6-a7c7-df3fc2c8297f");
	...
	/// Lead.
	/// </summary>
	public class Lead_MarketingCampaign_Terrasoft : Terrasoft.Configuration.Lead_OpportunityManagement_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Lead_MarketingCampaign_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Lead_MarketingCampaign_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Lead_MarketingCampaign_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Lead_MarketingCampaign_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Lead_MarketingCampaign_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Lead_MarketingCampaign_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Lead_MarketingCampaign_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Lead_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.Lead_OpportunityManagementEventsProcess<TEntity> where TEntity : Lead_MarketingCampaign_Terrasoft
	{

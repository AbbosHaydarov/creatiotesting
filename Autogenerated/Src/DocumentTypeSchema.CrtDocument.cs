namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentType_CrtDocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : DocumentType
	{

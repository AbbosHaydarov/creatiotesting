namespace Terrasoft.Configuration
{
	...
	public class VwSysAdminUnit_WebitelCollaborations_TerrasoftSchema : Terrasoft.Configuration.VwSysAdminUnit_Translation_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateLDAPEntryColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("8b7a054d-e633-4373-8d37-249a9920694e");
			column.CreatedInPackageId = new Guid("b7fb6e74-77cf-499f-8e71-7072f74ac64a");
			return column;
		}
	...
	public class VwSysAdminUnit_WebitelCollaborations_Terrasoft : Terrasoft.Configuration.VwSysAdminUnit_Translation_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("VwSysAdminUnit_WebitelCollaborations_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("VwSysAdminUnit_WebitelCollaborations_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("VwSysAdminUnit_WebitelCollaborations_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("VwSysAdminUnit_WebitelCollaborations_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("VwSysAdminUnit_WebitelCollaborations_TerrasoftSaved", e);
			Updated += (s, e) => ThrowEvent("VwSysAdminUnit_WebitelCollaborations_TerrasoftUpdated", e);

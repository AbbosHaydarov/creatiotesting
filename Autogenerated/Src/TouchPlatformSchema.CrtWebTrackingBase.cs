namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TouchPlatform_CrtWebTrackingBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : TouchPlatform
	{

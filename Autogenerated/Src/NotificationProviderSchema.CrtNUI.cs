namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class NotificationProvider_CrtNUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : NotificationProvider
	{

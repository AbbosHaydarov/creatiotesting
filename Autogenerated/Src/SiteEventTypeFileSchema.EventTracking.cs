namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SiteEventTypeFile_EventTrackingEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : SiteEventTypeFile
	{

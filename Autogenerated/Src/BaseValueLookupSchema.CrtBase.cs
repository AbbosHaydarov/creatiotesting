namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BaseValueLookup_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BaseValueLookup
	{

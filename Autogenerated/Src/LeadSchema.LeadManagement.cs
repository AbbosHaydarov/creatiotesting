namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_LeadManagement_TerrasoftSchema : Terrasoft.Configuration.Lead_CrtFinservLead_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_LeadManagement_Terrasoft : Terrasoft.Configuration.Lead_CrtFinservLead_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Inserted += (s, e) => ThrowEvent("Lead_LeadManagement_TerrasoftInserted", e);
			Saved += (s, e) => ThrowEvent("Lead_LeadManagement_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Lead_LeadManagement_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Lead_LeadManagement_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Lead_LeadManagementEventsProcess<TEntity> : Terrasoft.Configuration.Lead_CrtFinservLeadEventsProcess<TEntity> where TEntity : Lead_LeadManagement_Terrasoft
	{

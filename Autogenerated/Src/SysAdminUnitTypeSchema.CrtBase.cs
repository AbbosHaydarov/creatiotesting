namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysAdminUnitType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysAdminUnitType
	{

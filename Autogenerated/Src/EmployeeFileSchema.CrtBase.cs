namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmployeeFile_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : EmployeeFile
	{

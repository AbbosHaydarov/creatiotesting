namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DayType_CalendarEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : DayType_Calendar_Terrasoft
	{

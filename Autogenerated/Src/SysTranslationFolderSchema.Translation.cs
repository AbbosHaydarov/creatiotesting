namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysTranslationFolder_TranslationEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysTranslationFolder
	{

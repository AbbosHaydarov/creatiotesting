namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class NonActualReason_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : NonActualReason
	{

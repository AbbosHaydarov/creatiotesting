namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class GeneratedWebFormInTag_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : GeneratedWebFormInTag
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContentBlockInTag_ContentBuilderEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : ContentBlockInTag
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class RoleInServiceTeam_CrtSLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : RoleInServiceTeam
	{

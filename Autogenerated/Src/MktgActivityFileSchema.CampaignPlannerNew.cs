namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class MktgActivityFileSchema : Terrasoft.Configuration.FileSchema
	{
	...
	/// </summary>
	public class MktgActivityFile : Terrasoft.Configuration.File
	{
	...
	/// <exclude/>
	public partial class MktgActivityFile_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : MktgActivityFile
	{
	...
	/// <exclude/>
	public class MktgActivityFile_CampaignPlannerNewEventsProcess : MktgActivityFile_CampaignPlannerNewEventsProcess<MktgActivityFile>
	{
	...
	/// <exclude/>
	public class MktgActivityFileEventsProcess : MktgActivityFile_CampaignPlannerNewEventsProcess
	{

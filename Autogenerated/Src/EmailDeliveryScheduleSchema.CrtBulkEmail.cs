namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmailDeliverySchedule_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : EmailDeliverySchedule
	{

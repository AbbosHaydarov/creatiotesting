namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SupportLevel_CrtCaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SupportLevel
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_CoreContracts_TerrasoftSchema : Terrasoft.Configuration.Activity_CrtContract_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_CoreContracts_Terrasoft : Terrasoft.Configuration.Activity_CrtContract_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_CoreContractsEventsProcess<TEntity> : Terrasoft.Configuration.Activity_CrtContractEventsProcess<TEntity> where TEntity : Activity_CoreContracts_Terrasoft
	{

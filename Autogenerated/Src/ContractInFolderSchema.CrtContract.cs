namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContractInFolder_CrtContractEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ContractInFolder
	{

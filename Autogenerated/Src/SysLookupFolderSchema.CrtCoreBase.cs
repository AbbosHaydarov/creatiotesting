namespace Terrasoft.Configuration
{
	...
	public class SysLookupFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysLookupFolder_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysLookupFolder : Terrasoft.Configuration.BaseFolder
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysLookupFolder_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysLookupFolder_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysLookupFolder_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysLookupFolder
	{

		public SysLookupFolder_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysLookupFolder_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysLookupFolder_CrtCoreBaseEventsProcess : SysLookupFolder_CrtCoreBaseEventsProcess<SysLookupFolder>
	{
	...
	public partial class SysLookupFolder_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysLookupFolderEventsProcess : SysLookupFolder_CrtCoreBaseEventsProcess
	{

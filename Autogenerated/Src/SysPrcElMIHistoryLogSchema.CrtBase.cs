namespace Terrasoft.Configuration
{
	...
	public class SysPrcElMIHistoryLog : Terrasoft.Configuration.SysPrcElMILog
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SysPrcElMIHistoryLogDeleted", e);
			Deleting += (s, e) => ThrowEvent("SysPrcElMIHistoryLogDeleting", e);
			Inserted += (s, e) => ThrowEvent("SysPrcElMIHistoryLogInserted", e);
			Inserting += (s, e) => ThrowEvent("SysPrcElMIHistoryLogInserting", e);
			Saved += (s, e) => ThrowEvent("SysPrcElMIHistoryLogSaved", e);
			Saving += (s, e) => ThrowEvent("SysPrcElMIHistoryLogSaving", e);
			Validating += (s, e) => ThrowEvent("SysPrcElMIHistoryLogValidating", e);

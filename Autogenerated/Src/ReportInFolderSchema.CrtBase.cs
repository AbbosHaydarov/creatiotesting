namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ReportInFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ReportInFolder
	{

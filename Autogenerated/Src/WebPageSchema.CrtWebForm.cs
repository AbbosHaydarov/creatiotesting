namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebPage_CrtWebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : WebPage
	{

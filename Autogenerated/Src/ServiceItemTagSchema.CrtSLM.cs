namespace Terrasoft.Configuration
{
	...
	public class ServiceItemTag : Terrasoft.Configuration.BaseTag
	{
		...
		protected override void InitializeThrowEvents() {
			Deleting += (s, e) => ThrowEvent("ServiceItemTagDeleting", e);
			Inserted += (s, e) => ThrowEvent("ServiceItemTagInserted", e);
			Inserting += (s, e) => ThrowEvent("ServiceItemTagInserting", e);
			Saved += (s, e) => ThrowEvent("ServiceItemTagSaved", e);
			Saving += (s, e) => ThrowEvent("ServiceItemTagSaving", e);

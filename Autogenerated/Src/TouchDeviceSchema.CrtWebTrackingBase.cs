namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TouchDevice_CrtWebTrackingBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : TouchDevice
	{

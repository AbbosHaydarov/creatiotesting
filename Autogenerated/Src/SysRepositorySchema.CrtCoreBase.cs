namespace Terrasoft.Configuration
{
	...
	public class SysRepositorySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysRepository_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysRepository : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysRepository_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysRepository_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysRepository_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysRepository
	{

		public SysRepository_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysRepository_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysRepository_CrtCoreBaseEventsProcess : SysRepository_CrtCoreBaseEventsProcess<SysRepository>
	{
	...
	public partial class SysRepository_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysRepositoryEventsProcess : SysRepository_CrtCoreBaseEventsProcess
	{

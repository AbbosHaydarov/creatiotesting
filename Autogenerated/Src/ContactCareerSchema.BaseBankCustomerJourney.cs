namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ContactCareerSchema : Terrasoft.Configuration.ContactCareer_CrtBaseFinserv_TerrasoftSchema
	{
		...
		protected override void InitializeProperties() {
			...
			RealUId = new Guid("660cfa45-eba0-4281-8476-e181102aa203");
			Name = "ContactCareer";
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ContactCareer_BaseBankCustomerJourneyEventsProcess(userConnection);
		}
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("660cfa45-eba0-4281-8476-e181102aa203"));
		}
	...
	/// </summary>
	public class ContactCareer : Terrasoft.Configuration.ContactCareer_CrtBaseFinserv_Terrasoft
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new ContactCareer_BaseBankCustomerJourneyEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("ContactCareerDeleted", e);
			Deleting += (s, e) => ThrowEvent("ContactCareerDeleting", e);
			Inserted += (s, e) => ThrowEvent("ContactCareerInserted", e);
			Inserting += (s, e) => ThrowEvent("ContactCareerInserting", e);
			Saved += (s, e) => ThrowEvent("ContactCareerSaved", e);
			Saving += (s, e) => ThrowEvent("ContactCareerSaving", e);
			Validating += (s, e) => ThrowEvent("ContactCareerValidating", e);
	...
	/// <exclude/>
	public partial class ContactCareer_BaseBankCustomerJourneyEventsProcess<TEntity> : Terrasoft.Configuration.ContactCareer_CrtBaseFinservEventsProcess<TEntity> where TEntity : ContactCareer
	{

		public ContactCareer_BaseBankCustomerJourneyEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "ContactCareer_BaseBankCustomerJourneyEventsProcess";
		...
		private Guid InternalSchemaUId {
			get {
				return new Guid("660cfa45-eba0-4281-8476-e181102aa203");
			}
		}
	...
	/// <exclude/>
	public class ContactCareer_BaseBankCustomerJourneyEventsProcess : ContactCareer_BaseBankCustomerJourneyEventsProcess<ContactCareer>
	{
	...
	/// <exclude/>
	public class ContactCareerEventsProcess : ContactCareer_BaseBankCustomerJourneyEventsProcess
	{

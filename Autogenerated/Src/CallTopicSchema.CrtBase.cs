namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CallTopic_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CallTopic
	{

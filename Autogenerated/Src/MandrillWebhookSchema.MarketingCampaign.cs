namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MandrillWebhook_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : MandrillWebhook
	{

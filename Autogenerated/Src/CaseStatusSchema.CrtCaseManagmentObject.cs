namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CaseStatus_CrtCaseManagmentObjectEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CaseStatus
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContractFile_CrtContractEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : ContractFile
	{

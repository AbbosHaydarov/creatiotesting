namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MapService_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : MapService
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SpecificationInObjectSchema : Terrasoft.Configuration.SpecificationInObject_CrtFinservSpecification_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateStringValueColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("b1c1b584-6646-4697-8351-147120056217");
	...
	/// Feature in object.
	/// </summary>
	public class SpecificationInObject : Terrasoft.Configuration.SpecificationInObject_CrtFinservSpecification_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("SpecificationInObjectDeleting", e);
			Inserted += (s, e) => ThrowEvent("SpecificationInObjectInserted", e);
			Inserting += (s, e) => ThrowEvent("SpecificationInObjectInserting", e);
			Saved += (s, e) => ThrowEvent("SpecificationInObjectSaved", e);
	...
	/// <exclude/>
	public partial class SpecificationInObject_SpecificationEventsProcess<TEntity> : Terrasoft.Configuration.SpecificationInObject_CrtFinservSpecificationEventsProcess<TEntity> where TEntity : SpecificationInObject
	{

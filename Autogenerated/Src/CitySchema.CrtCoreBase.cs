namespace Terrasoft.Configuration
{
	...
	#region Class: City_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class City_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{

		#region Constructors: Public

		public City_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public City_CrtCoreBase_TerrasoftSchema(City_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public City_CrtCoreBase_TerrasoftSchema(City_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "City_CrtCoreBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new City_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new City_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new City_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new City_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: City_CrtCoreBase_Terrasoft

	/// <summary>
	/// City.
	/// </summary>
	public class City_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseLookup
	{

		#region Constructors: Public

		public City_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "City_CrtCoreBase_Terrasoft";
		}

		public City_CrtCoreBase_Terrasoft(City_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new City_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("City_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("City_CrtCoreBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("City_CrtCoreBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("City_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("City_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("City_CrtCoreBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("City_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new City_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: City_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class City_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : City_CrtCoreBase_Terrasoft
	{

		public City_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "City_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class City_CrtCoreBaseEventsProcess : City_CrtCoreBaseEventsProcess<City_CrtCoreBase_Terrasoft>
	{
	...
	public partial class City_CrtCoreBaseEventsProcess<TEntity>
	{

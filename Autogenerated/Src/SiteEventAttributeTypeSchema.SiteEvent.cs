namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SiteEventAttributeType_SiteEventEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SiteEventAttributeType
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VisaStatus_CrtNUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : VisaStatus
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LendingState_CrtWebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LendingState
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ActivityInTag_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : ActivityInTag
	{

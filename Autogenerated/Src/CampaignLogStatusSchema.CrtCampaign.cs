namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignLogStatus_CrtCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CampaignLogStatus
	{

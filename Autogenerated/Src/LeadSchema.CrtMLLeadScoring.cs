namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_CrtMLLeadScoring_TerrasoftSchema : Terrasoft.Configuration.Lead_CrtLeadWebForm_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_CrtMLLeadScoring_Terrasoft : Terrasoft.Configuration.Lead_CrtLeadWebForm_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Lead_CrtMLLeadScoring_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Lead_CrtMLLeadScoring_TerrasoftDeleting", e);
	...
	/// <exclude/>
	public partial class Lead_CrtMLLeadScoringEventsProcess<TEntity> : Terrasoft.Configuration.Lead_CrtLeadWebFormEventsProcess<TEntity> where TEntity : Lead_CrtMLLeadScoring_Terrasoft
	{

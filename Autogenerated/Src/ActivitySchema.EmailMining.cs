namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_EmailMining_TerrasoftSchema : Terrasoft.Configuration.Activity_Exchange_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_EmailMining_Terrasoft : Terrasoft.Configuration.Activity_Exchange_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_EmailMiningEventsProcess<TEntity> : Terrasoft.Configuration.Activity_ExchangeEventsProcess<TEntity> where TEntity : Activity_EmailMining_Terrasoft
	{

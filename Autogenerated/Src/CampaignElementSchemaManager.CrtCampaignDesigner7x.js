define("CampaignElementSchemaManager", ["CampaignBaseAudienceSchema", "ProcessCampaignSequenceFlowSchema",
		...
		"CampaignSplitGatewaySchema", "CampaignDeduplicatorSchema","AddFromWebPageSignalSchema",
		"CampaignWebPageSchema", "ProcessSplitGatewayTransitionSchema", "BaseWebPageConditionalTransitionSchema"],
	function() {
		Ext.define("Terrasoft.manager.CampaignElementSchemaManager", {
			...
			_initCoreElementClassNames: function() {
				this.coreElementClassNames = _.union([
					...
					{ itemType: "Terrasoft.BaseWebPageConditionalTransitionSchema" },
					...
					{ itemType: "Terrasoft.AddFromWebPageSignalSchema" },
					{ itemType: "Terrasoft.CampaignWebPageSchema" }

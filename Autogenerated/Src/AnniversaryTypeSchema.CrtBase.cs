namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AnniversaryType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : AnniversaryType
	{

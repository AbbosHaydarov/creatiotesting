namespace Terrasoft.Configuration
{
	...
	#region Class: SysDashboard_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class SysDashboard_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public SysDashboard_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public SysDashboard_CrtCoreBase_TerrasoftSchema(SysDashboard_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public SysDashboard_CrtCoreBase_TerrasoftSchema(SysDashboard_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "SysDashboard_CrtCoreBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new SysDashboard_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysDashboard_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new SysDashboard_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new SysDashboard_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: SysDashboard_CrtCoreBase_Terrasoft

	/// <summary>
	/// Dashboard.
	/// </summary>
	public class SysDashboard_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public SysDashboard_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "SysDashboard_CrtCoreBase_Terrasoft";
		}

		public SysDashboard_CrtCoreBase_Terrasoft(SysDashboard_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysDashboard_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SysDashboard_CrtCoreBase_TerrasoftDeleted", e);
			Inserting += (s, e) => ThrowEvent("SysDashboard_CrtCoreBase_TerrasoftInserting", e);
			Validating += (s, e) => ThrowEvent("SysDashboard_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new SysDashboard_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: SysDashboard_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysDashboard_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysDashboard_CrtCoreBase_Terrasoft
	{

		public SysDashboard_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysDashboard_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysDashboard_CrtCoreBaseEventsProcess : SysDashboard_CrtCoreBaseEventsProcess<SysDashboard_CrtCoreBase_Terrasoft>
	{
	...
	public partial class SysDashboard_CrtCoreBaseEventsProcess<TEntity>
	{

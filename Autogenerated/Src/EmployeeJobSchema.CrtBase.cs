namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EmployeeJob_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : EmployeeJob
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OpportunityProbability_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : OpportunityProbability
	{

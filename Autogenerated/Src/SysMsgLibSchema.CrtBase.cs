namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysMsgLib_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysMsgLib
	{

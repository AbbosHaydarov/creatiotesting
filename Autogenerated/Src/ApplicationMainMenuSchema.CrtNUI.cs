namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ApplicationMainMenu_CrtNUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ApplicationMainMenu
	{

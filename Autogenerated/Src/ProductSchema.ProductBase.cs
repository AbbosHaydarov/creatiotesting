namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Product_ProductBase_TerrasoftSchema : Terrasoft.Configuration.Product_CrtProductCatalogue_TerrasoftSchema
	{
	...
	/// Product.
	/// </summary>
	public class Product_ProductBase_Terrasoft : Terrasoft.Configuration.Product_CrtProductCatalogue_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Product_ProductBaseEventsProcess<TEntity> : Terrasoft.Configuration.Product_CrtProductCatalogueEventsProcess<TEntity> where TEntity : Product_ProductBase_Terrasoft
	{

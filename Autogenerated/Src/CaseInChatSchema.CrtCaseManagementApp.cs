namespace Terrasoft.Configuration
{
	...
	public class CaseInChatSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CaseInChat_CrtCaseManagementAppEventsProcess(userConnection);
		}
	...
	public class CaseInChat : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new CaseInChat_CrtCaseManagementAppEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: CaseInChat_CrtCaseManagementAppEventsProcess

	/// <exclude/>
	public partial class CaseInChat_CrtCaseManagementAppEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : CaseInChat
	{

		public CaseInChat_CrtCaseManagementAppEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "CaseInChat_CrtCaseManagementAppEventsProcess";
	...
	/// <exclude/>
	public class CaseInChat_CrtCaseManagementAppEventsProcess : CaseInChat_CrtCaseManagementAppEventsProcess<CaseInChat>
	{
	...
	public partial class CaseInChat_CrtCaseManagementAppEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class CaseInChatEventsProcess : CaseInChat_CrtCaseManagementAppEventsProcess
	{

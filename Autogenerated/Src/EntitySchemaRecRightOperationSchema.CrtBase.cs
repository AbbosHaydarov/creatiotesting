namespace Terrasoft.Configuration
{
	...
	public class EntitySchemaRecRightOperationSchema : Terrasoft.Configuration.BaseValueLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EntitySchemaRecRightOperation_CrtBaseEventsProcess(userConnection);
		}
	...
	public class EntitySchemaRecRightOperation : Terrasoft.Configuration.BaseValueLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new EntitySchemaRecRightOperation_CrtBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: EntitySchemaRecRightOperation_CrtBaseEventsProcess

	/// <exclude/>
	public partial class EntitySchemaRecRightOperation_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseValueLookup_CrtBaseEventsProcess<TEntity> where TEntity : EntitySchemaRecRightOperation
	{

		public EntitySchemaRecRightOperation_CrtBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "EntitySchemaRecRightOperation_CrtBaseEventsProcess";
	...
	/// <exclude/>
	public class EntitySchemaRecRightOperation_CrtBaseEventsProcess : EntitySchemaRecRightOperation_CrtBaseEventsProcess<EntitySchemaRecRightOperation>
	{
	...
	public partial class EntitySchemaRecRightOperation_CrtBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class EntitySchemaRecRightOperationEventsProcess : EntitySchemaRecRightOperation_CrtBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class VwSysAdminUnit_LDAP_TerrasoftSchema : Terrasoft.Configuration.VwSysAdminUnit_CrtBase_TerrasoftSchema
	{
	...
	/// Users/roles (view).
	/// </summary>
	public class VwSysAdminUnit_LDAP_Terrasoft : Terrasoft.Configuration.VwSysAdminUnit_CrtBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class VwSysAdminUnit_LDAPEventsProcess<TEntity> : Terrasoft.Configuration.VwSysAdminUnit_CrtBaseEventsProcess<TEntity> where TEntity : VwSysAdminUnit_LDAP_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	public class SysWorkplace_CrtNUI_Terrasoft : Terrasoft.Configuration.BaseEntityWithPosition
	{
		...
		protected override void InitializeThrowEvents() {
			Deleting += (s, e) => ThrowEvent("SysWorkplace_CrtNUI_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("SysWorkplace_CrtNUI_TerrasoftInserted", e);
			Saved += (s, e) => ThrowEvent("SysWorkplace_CrtNUI_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("SysWorkplace_CrtNUI_TerrasoftSaving", e);
	...
	/// <exclude/>
	public partial class SysWorkplace_CrtNUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityWithPosition_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysWorkplace_CrtNUI_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ContactFolderSchema : Terrasoft.Configuration.ContactFolder_CrtBaseFinserv_TerrasoftSchema
	{
	...
	/// Contact folder.
	/// </summary>
	public class ContactFolder : Terrasoft.Configuration.ContactFolder_CrtBaseFinserv_Terrasoft
	{
	...
	/// <exclude/>
	public partial class ContactFolder_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.ContactFolder_CrtBaseFinservEventsProcess<TEntity> where TEntity : ContactFolder
	{

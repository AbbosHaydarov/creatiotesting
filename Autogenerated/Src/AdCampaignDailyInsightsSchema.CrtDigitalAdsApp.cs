namespace Terrasoft.Configuration
{
	...
	public class AdCampaignDailyInsights_CrtDigitalAdsApp_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("e9c7b12d-0e48-9757-f377-b0682136c878")) == null) {
				Columns.Add(CreateConversionsColumn());
			}
			if (Columns.FindByUId(new Guid("3a4dd8b9-4ca5-5830-8f15-952b0c5d7e68")) == null) {
				Columns.Add(CreateAllConversionsColumn());
			}
		}
		...
		protected virtual EntitySchemaColumn CreateConversionsColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Float2")) {
				UId = new Guid("e9c7b12d-0e48-9757-f377-b0682136c878"),
				Name = @"Conversions",
				CreatedInSchemaUId = new Guid("cfb6f45d-cba1-4654-a569-26706df96805"),
				ModifiedInSchemaUId = new Guid("cfb6f45d-cba1-4654-a569-26706df96805"),
		...
		protected virtual EntitySchemaColumn CreateAllConversionsColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Float2")) {
				UId = new Guid("3a4dd8b9-4ca5-5830-8f15-952b0c5d7e68"),
				Name = @"AllConversions",
				CreatedInSchemaUId = new Guid("cfb6f45d-cba1-4654-a569-26706df96805"),
				ModifiedInSchemaUId = new Guid("cfb6f45d-cba1-4654-a569-26706df96805"),
				CreatedInPackageId = new Guid("abf715ae-fc66-421f-87dc-256931a52a49")
	...
	public class AdCampaignDailyInsights_CrtDigitalAdsApp_Terrasoft : Terrasoft.Configuration.BaseEntity
	{
		...
		public Decimal Conversions {
			get {
				return GetTypedColumnValue<Decimal>("Conversions");
			}
			set {
				SetColumnValue("Conversions", value);
			}
		}
		...
		/// All conversions.
		/// </summary>
		public Decimal AllConversions {
			get {
				return GetTypedColumnValue<Decimal>("AllConversions");
			}
			set {
				SetColumnValue("AllConversions", value);
			}
		}

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceItemFolder_CrtSLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ServiceItemFolder
	{

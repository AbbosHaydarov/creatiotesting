namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class QuickAddMenuSettingsSchema : Terrasoft.Configuration.QuickAddMenuSettings_CrtCoreBase_TerrasoftSchema
	{
	...
	/// </summary>
	public class QuickAddMenuSettings : Terrasoft.Configuration.QuickAddMenuSettings_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class QuickAddMenuSettings_SSPEventsProcess<TEntity> : Terrasoft.Configuration.QuickAddMenuSettings_CrtCoreBaseEventsProcess<TEntity> where TEntity : QuickAddMenuSettings
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebhookStatus_WebhookServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : WebhookStatus
	{

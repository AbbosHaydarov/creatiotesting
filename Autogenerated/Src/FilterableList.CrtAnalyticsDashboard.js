define("FilterableList", ["FilterableListResources", ...(Terrasoft.UseMfForAngularElements
		? ["mf!AnalyticsDashboard", "css-ltr!AnalyticsDashboardStyles"]
		: ["AnalyticsDashboardOld"]), "css!FilterableList"],
		function(resources) {
	/**

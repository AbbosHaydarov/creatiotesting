			...
			return {
				...
				methods: {
					...
					processDeleteRequest: function() {
						const processAlreadyFinished = !Boolean(localStorage.getItem(ConfigurationConstants.MultiDelete.MultiDeleteLocalStorageKey));
						if (!this.$RequestContext || processAlreadyFinished) {
							return;
						}

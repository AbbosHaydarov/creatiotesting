namespace Terrasoft.Configuration
{
	...
	public class OpportunityCloseReasonSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new OpportunityCloseReason_CrtOpportunityEventsProcess(userConnection);
		}
	...
	public class OpportunityCloseReason : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new OpportunityCloseReason_CrtOpportunityEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: OpportunityCloseReason_CrtOpportunityEventsProcess

	/// <exclude/>
	public partial class OpportunityCloseReason_CrtOpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : OpportunityCloseReason
	{

		public OpportunityCloseReason_CrtOpportunityEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "OpportunityCloseReason_CrtOpportunityEventsProcess";
	...
	/// <exclude/>
	public class OpportunityCloseReason_CrtOpportunityEventsProcess : OpportunityCloseReason_CrtOpportunityEventsProcess<OpportunityCloseReason>
	{
	...
	public partial class OpportunityCloseReason_CrtOpportunityEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class OpportunityCloseReasonEventsProcess : OpportunityCloseReason_CrtOpportunityEventsProcess
	{

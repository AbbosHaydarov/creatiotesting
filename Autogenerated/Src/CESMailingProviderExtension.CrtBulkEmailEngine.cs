namespace Terrasoft.Configuration
{
	...
	public static class CESMailingProviderExtension
	{
		...
		private static CloudSenderDomainsInfo GetSenderDomainsInfo(
			...
			var senderDomainCacheService = new SenderDomainCacheService(provider.UserConnection, provider.ServiceApi);
			return senderDomainCacheService.GetSenderDomainsInfo(senderDomainsInfoRequest);
		}

namespace Terrasoft.Configuration
{
	...
	#region Class: RelationType_RelationshipDesigner_TerrasoftSchema

	/// <exclude/>
	public class RelationType_RelationshipDesigner_TerrasoftSchema : Terrasoft.Configuration.RelationType_CrtBase_TerrasoftSchema
	{

		#region Constructors: Public

		public RelationType_RelationshipDesigner_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public RelationType_RelationshipDesigner_TerrasoftSchema(RelationType_RelationshipDesigner_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public RelationType_RelationshipDesigner_TerrasoftSchema(RelationType_RelationshipDesigner_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "RelationType_RelationshipDesigner_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new RelationType_RelationshipDesigner_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new RelationType_RelationshipDesigner_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new RelationType_RelationshipDesigner_TerrasoftSchema(this, true);
		}
	...
	#region Class: RelationType_RelationshipDesigner_Terrasoft

	/// <summary>
	/// Relationship type.
	/// </summary>
	public class RelationType_RelationshipDesigner_Terrasoft : Terrasoft.Configuration.RelationType_CrtBase_Terrasoft
	{

		#region Constructors: Public

		public RelationType_RelationshipDesigner_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "RelationType_RelationshipDesigner_Terrasoft";
		}

		public RelationType_RelationshipDesigner_Terrasoft(RelationType_RelationshipDesigner_Terrasoft source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new RelationType_RelationshipDesigner_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class RelationType_RelationshipDesignerEventsProcess<TEntity> : Terrasoft.Configuration.RelationType_CrtBaseEventsProcess<TEntity> where TEntity : RelationType_RelationshipDesigner_Terrasoft
	{
	...
	/// <exclude/>
	public class RelationType_RelationshipDesignerEventsProcess : RelationType_RelationshipDesignerEventsProcess<RelationType_RelationshipDesigner_Terrasoft>
	{

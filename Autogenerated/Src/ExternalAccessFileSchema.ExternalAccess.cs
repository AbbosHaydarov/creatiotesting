namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ExternalAccessFile_ExternalAccessEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : ExternalAccessFile
	{

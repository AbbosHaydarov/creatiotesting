namespace Terrasoft.Configuration
{
	...
	public class SysBaseSchemaOperationRightSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysBaseSchemaOperationRight_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysBaseSchemaOperationRight : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysBaseSchemaOperationRight_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysBaseSchemaOperationRight_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysBaseSchemaOperationRight_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysBaseSchemaOperationRight
	{

		public SysBaseSchemaOperationRight_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysBaseSchemaOperationRight_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysBaseSchemaOperationRight_CrtCoreBaseEventsProcess : SysBaseSchemaOperationRight_CrtCoreBaseEventsProcess<SysBaseSchemaOperationRight>
	{
	...
	public partial class SysBaseSchemaOperationRight_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysBaseSchemaOperationRightEventsProcess : SysBaseSchemaOperationRight_CrtCoreBaseEventsProcess
	{

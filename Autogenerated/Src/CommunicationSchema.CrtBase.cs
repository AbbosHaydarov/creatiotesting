namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Communication_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : Communication
	{

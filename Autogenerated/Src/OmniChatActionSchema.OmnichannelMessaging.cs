namespace Terrasoft.Configuration
{
	...
	public class OmniChatActionSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("0fa75e38-4723-4b35-1c9e-c5f0583afd10")) == null) {
				Columns.Add(CreateBusinessProcessColumn());
			}
		}
		...
		protected virtual EntitySchemaColumn CreateBusinessProcessColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Lookup")) {
				UId = new Guid("0fa75e38-4723-4b35-1c9e-c5f0583afd10"),
		...
		public VwProcessLib BusinessProcess {
			get {
				return _businessProcess ??
					(_businessProcess = LookupColumnEntities.GetEntity("BusinessProcess") as VwProcessLib);
			}
		}

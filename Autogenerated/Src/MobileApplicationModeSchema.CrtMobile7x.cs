namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MobileApplicationMode_CrtMobile7xEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : MobileApplicationMode
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Call_CrtCaseService_TerrasoftSchema : Terrasoft.Configuration.Call_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Call.
	/// </summary>
	public class Call_CrtCaseService_Terrasoft : Terrasoft.Configuration.Call_CrtCoreBase_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Call_CrtCaseService_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Call_CrtCaseService_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Call_CrtCaseService_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Call_CrtCaseService_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Call_CrtCaseService_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Call_CrtCaseService_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Call_CrtCaseService_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Call_CrtCaseServiceEventsProcess<TEntity> : Terrasoft.Configuration.Call_CrtCoreBaseEventsProcess<TEntity> where TEntity : Call_CrtCaseService_Terrasoft
	{

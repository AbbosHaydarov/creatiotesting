namespace Terrasoft.Configuration
{
	...
	#region Class: VwAccountModuleHistory_CrtUIv2_TerrasoftSchema

	/// <exclude/>
	public class VwAccountModuleHistory_CrtUIv2_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public VwAccountModuleHistory_CrtUIv2_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public VwAccountModuleHistory_CrtUIv2_TerrasoftSchema(VwAccountModuleHistory_CrtUIv2_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public VwAccountModuleHistory_CrtUIv2_TerrasoftSchema(VwAccountModuleHistory_CrtUIv2_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "VwAccountModuleHistory_CrtUIv2_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new VwAccountModuleHistory_CrtUIv2_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new VwAccountModuleHistory_CrtUIv2_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new VwAccountModuleHistory_CrtUIv2_TerrasoftSchema(this, true);
		}
	...
	#region Class: VwAccountModuleHistory_CrtUIv2_Terrasoft

	/// <summary>
	/// Accounts section history (view).
	/// </summary>
	public class VwAccountModuleHistory_CrtUIv2_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public VwAccountModuleHistory_CrtUIv2_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "VwAccountModuleHistory_CrtUIv2_Terrasoft";
		}

		public VwAccountModuleHistory_CrtUIv2_Terrasoft(VwAccountModuleHistory_CrtUIv2_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("VwAccountModuleHistory_CrtUIv2_TerrasoftDeleted", e);
			Inserting += (s, e) => ThrowEvent("VwAccountModuleHistory_CrtUIv2_TerrasoftInserting", e);
			Validating += (s, e) => ThrowEvent("VwAccountModuleHistory_CrtUIv2_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new VwAccountModuleHistory_CrtUIv2_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class VwAccountModuleHistory_CrtUIv2EventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : VwAccountModuleHistory_CrtUIv2_Terrasoft
	{
	...
	/// <exclude/>
	public class VwAccountModuleHistory_CrtUIv2EventsProcess : VwAccountModuleHistory_CrtUIv2EventsProcess<VwAccountModuleHistory_CrtUIv2_Terrasoft>
	{

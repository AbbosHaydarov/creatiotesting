namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContentBlockFile_ContentBuilderEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : ContentBlockFile
	{

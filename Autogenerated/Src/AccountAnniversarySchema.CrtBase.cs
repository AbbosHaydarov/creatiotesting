namespace Terrasoft.Configuration
{
	...
	#region Class: AccountAnniversary_CrtBase_TerrasoftSchema

	/// <exclude/>
	public class AccountAnniversary_CrtBase_TerrasoftSchema : Terrasoft.Configuration.BaseAnniversarySchema
	{

		#region Constructors: Public

		public AccountAnniversary_CrtBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public AccountAnniversary_CrtBase_TerrasoftSchema(AccountAnniversary_CrtBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public AccountAnniversary_CrtBase_TerrasoftSchema(AccountAnniversary_CrtBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "AccountAnniversary_CrtBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new AccountAnniversary_CrtBase_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new AccountAnniversary_CrtBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new AccountAnniversary_CrtBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: AccountAnniversary_CrtBase_Terrasoft

	/// <summary>
	/// Noteworthy event of account.
	/// </summary>
	public class AccountAnniversary_CrtBase_Terrasoft : Terrasoft.Configuration.BaseAnniversary
	{

		#region Constructors: Public

		public AccountAnniversary_CrtBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "AccountAnniversary_CrtBase_Terrasoft";
		}

		public AccountAnniversary_CrtBase_Terrasoft(AccountAnniversary_CrtBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("AccountAnniversary_CrtBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("AccountAnniversary_CrtBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("AccountAnniversary_CrtBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("AccountAnniversary_CrtBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("AccountAnniversary_CrtBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("AccountAnniversary_CrtBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("AccountAnniversary_CrtBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new AccountAnniversary_CrtBase_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class AccountAnniversary_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseAnniversary_CrtBaseEventsProcess<TEntity> where TEntity : AccountAnniversary_CrtBase_Terrasoft
	{
	...
	/// <exclude/>
	public class AccountAnniversary_CrtBaseEventsProcess : AccountAnniversary_CrtBaseEventsProcess<AccountAnniversary_CrtBase_Terrasoft>
	{

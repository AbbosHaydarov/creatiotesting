namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadFolder_CrtLeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : LeadFolder_CrtLead_Terrasoft
	{

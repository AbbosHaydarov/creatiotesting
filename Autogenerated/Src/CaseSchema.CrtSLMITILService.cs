namespace Terrasoft.Configuration
{
	...
	#region Class: Case_CrtSLMITILService_TerrasoftSchema

	/// <exclude/>
	public class Case_CrtSLMITILService_TerrasoftSchema : Terrasoft.Configuration.Case_CrtSLM_TerrasoftSchema
	{

		#region Constructors: Public

		public Case_CrtSLMITILService_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Case_CrtSLMITILService_TerrasoftSchema(Case_CrtSLMITILService_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Case_CrtSLMITILService_TerrasoftSchema(Case_CrtSLMITILService_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "Case_CrtSLMITILService_Terrasoft";
		...
		protected override EntitySchemaColumn CreateNumberColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("8568d092-83e6-4a24-8ab8-391fca7f750d");
			return column;
		}
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Case_CrtSLMITILService_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Case_CrtSLMITILServiceEventsProcess(userConnection);
		}

		public override object Clone() {
			return new Case_CrtSLMITILService_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Case_CrtSLMITILService_TerrasoftSchema(this, true);
		}
	...
	#region Class: Case_CrtSLMITILService_Terrasoft

	/// <summary>
	/// Case.
	/// </summary>
	public class Case_CrtSLMITILService_Terrasoft : Terrasoft.Configuration.Case_CrtSLM_Terrasoft
	{

		#region Constructors: Public

		public Case_CrtSLMITILService_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Case_CrtSLMITILService_Terrasoft";
		}

		public Case_CrtSLMITILService_Terrasoft(Case_CrtSLMITILService_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Case_CrtSLMITILServiceEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Case_CrtSLMITILService_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Case_CrtSLMITILService_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Case_CrtSLMITILService_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Case_CrtSLMITILService_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Case_CrtSLMITILService_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Case_CrtSLMITILService_TerrasoftSaving", e);
			SaveError += (s, e) => ThrowEvent("Case_CrtSLMITILService_TerrasoftSaveError", e);
			Validating += (s, e) => ThrowEvent("Case_CrtSLMITILService_TerrasoftValidating", e);
			DefColumnValuesSet += (s, e) => ThrowEvent("Case_CrtSLMITILService_TerrasoftDefColumnValuesSet", e);
		...
		public override object Clone() {
			return new Case_CrtSLMITILService_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class Case_CrtSLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.Case_CrtSLMEventsProcess<TEntity> where TEntity : Case_CrtSLMITILService_Terrasoft
	{

		public Case_CrtSLMITILServiceEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Case_CrtSLMITILServiceEventsProcess";
	...
	/// <exclude/>
	public class Case_CrtSLMITILServiceEventsProcess : Case_CrtSLMITILServiceEventsProcess<Case_CrtSLMITILService_Terrasoft>
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class QueueInTag_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : QueueInTag
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenLogType_CrtSocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LeadGenLogType
	{

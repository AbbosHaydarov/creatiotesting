namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailSplitFile_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : BulkEmailSplitFile
	{

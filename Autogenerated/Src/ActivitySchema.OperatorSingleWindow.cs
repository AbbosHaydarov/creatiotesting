namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_OperatorSingleWindow_TerrasoftSchema : Terrasoft.Configuration.Activity_EmailMessage_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_OperatorSingleWindow_Terrasoft : Terrasoft.Configuration.Activity_EmailMessage_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_OperatorSingleWindowEventsProcess<TEntity> : Terrasoft.Configuration.Activity_EmailMessageEventsProcess<TEntity> where TEntity : Activity_OperatorSingleWindow_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	public class BulkEmailTag : Terrasoft.Configuration.BaseTag
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("BulkEmailTagDeleting", e);
			Inserted += (s, e) => ThrowEvent("BulkEmailTagInserted", e);
			Inserting += (s, e) => ThrowEvent("BulkEmailTagInserting", e);
			Saved += (s, e) => ThrowEvent("BulkEmailTagSaved", e);
			Saving += (s, e) => ThrowEvent("BulkEmailTagSaving", e);

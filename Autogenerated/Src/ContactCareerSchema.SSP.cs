namespace Terrasoft.Configuration
{
	...
	#region Class: ContactCareer_SSP_TerrasoftSchema

	/// <exclude/>
	public class ContactCareer_SSP_TerrasoftSchema : Terrasoft.Configuration.ContactCareer_CrtBase_TerrasoftSchema
	{

		#region Constructors: Public

		public ContactCareer_SSP_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public ContactCareer_SSP_TerrasoftSchema(ContactCareer_SSP_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public ContactCareer_SSP_TerrasoftSchema(ContactCareer_SSP_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "ContactCareer_SSP_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new ContactCareer_SSP_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new ContactCareer_SSP_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new ContactCareer_SSP_TerrasoftSchema(this, true);
		}
	...
	#region Class: ContactCareer_SSP_Terrasoft

	/// <summary>
	/// Job experience of contact.
	/// </summary>
	public class ContactCareer_SSP_Terrasoft : Terrasoft.Configuration.ContactCareer_CrtBase_Terrasoft
	{

		#region Constructors: Public

		public ContactCareer_SSP_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "ContactCareer_SSP_Terrasoft";
		}

		public ContactCareer_SSP_Terrasoft(ContactCareer_SSP_Terrasoft source)
			: base(source) {
		}
		...
		public override object Clone() {
			return new ContactCareer_SSP_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class ContactCareer_SSPEventsProcess<TEntity> : Terrasoft.Configuration.ContactCareer_CrtBaseEventsProcess<TEntity> where TEntity : ContactCareer_SSP_Terrasoft
	{
	...
	/// <exclude/>
	public class ContactCareer_SSPEventsProcess : ContactCareer_SSPEventsProcess<ContactCareer_SSP_Terrasoft>
	{

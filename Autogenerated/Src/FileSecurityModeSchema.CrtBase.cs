namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FileSecurityMode_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.Lookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : FileSecurityMode
	{

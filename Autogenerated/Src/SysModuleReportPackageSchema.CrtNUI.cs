namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysModuleReportPackage_CrtNUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysModuleReportPackage
	{

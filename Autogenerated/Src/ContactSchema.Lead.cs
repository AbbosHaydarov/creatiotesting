namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Contact_Lead_TerrasoftSchema : Terrasoft.Configuration.Contact_CrtTouchPointInC360_TerrasoftSchema
	{
	...
	/// Contact.
	/// </summary>
	public class Contact_Lead_Terrasoft : Terrasoft.Configuration.Contact_CrtTouchPointInC360_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Contact_LeadEventsProcess<TEntity> : Terrasoft.Configuration.Contact_CrtTouchPointInC360EventsProcess<TEntity> where TEntity : Contact_Lead_Terrasoft
	{

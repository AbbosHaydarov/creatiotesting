namespace Terrasoft.Configuration
{
	...
	public class CampaignInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CampaignInFolder_CrtCampaignEventsProcess(userConnection);
		}
	...
	public class CampaignInFolder : Terrasoft.Configuration.BaseItemInFolder
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new CampaignInFolder_CrtCampaignEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: CampaignInFolder_CrtCampaignEventsProcess

	/// <exclude/>
	public partial class CampaignInFolder_CrtCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : CampaignInFolder
	{

		public CampaignInFolder_CrtCampaignEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "CampaignInFolder_CrtCampaignEventsProcess";
	...
	/// <exclude/>
	public class CampaignInFolder_CrtCampaignEventsProcess : CampaignInFolder_CrtCampaignEventsProcess<CampaignInFolder>
	{
	...
	public partial class CampaignInFolder_CrtCampaignEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class CampaignInFolderEventsProcess : CampaignInFolder_CrtCampaignEventsProcess
	{

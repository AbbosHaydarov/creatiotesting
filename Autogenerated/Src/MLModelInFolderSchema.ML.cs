namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MLModelInFolder_MLEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : MLModelInFolder
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Case_Case_TerrasoftSchema : Terrasoft.Configuration.Case_CrtCaseManagementApp_TerrasoftSchema
	{
		...
		protected override EntitySchemaColumn CreateNumberColumn() {
			...
			column.CreatedInPackageId = new Guid("4bc36079-7dbb-41e6-9a4e-b85039bf2a70");
			return column;
		}
	...
	/// Case.
	/// </summary>
	public class Case_Case_Terrasoft : Terrasoft.Configuration.Case_CrtCaseManagementApp_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Inserted += (s, e) => ThrowEvent("Case_Case_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Case_Case_TerrasoftInserting", e);
			Saving += (s, e) => ThrowEvent("Case_Case_TerrasoftSaving", e);
			SaveError += (s, e) => ThrowEvent("Case_Case_TerrasoftSaveError", e);
	...
	/// <exclude/>
	public partial class Case_CaseEventsProcess<TEntity> : Terrasoft.Configuration.Case_CrtCaseManagementAppEventsProcess<TEntity> where TEntity : Case_Case_Terrasoft
	{

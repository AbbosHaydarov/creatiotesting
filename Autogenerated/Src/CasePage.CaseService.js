define("CasePage", [
		"BusinessRuleModule",
		"ServiceDeskConstants",
		"ConfigurationConstants",
		"EmailMessageConstants",
		"EmailHelper",
		"CaseMessageHistoryUtility",
		"BaseFiltersGenerateModule",
		"CasesEstimateLabel",
		"css!CaseProcessingCSS",
		"RelationshipsRecordsUtilities",
		"CaseTermCalculationDescribeUtilities",
		"TermCalculationInformation",
		...(Terrasoft.UseMfForAngularElements && Terrasoft.UseMfForAngularElements_8_1_3 ? ["mf!TermCalculationComponent", "css-ltr!TermCalculationComponentStyles"] : ["TermCalculationComponentOld"]),

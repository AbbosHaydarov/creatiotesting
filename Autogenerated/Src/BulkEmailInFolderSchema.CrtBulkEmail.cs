namespace Terrasoft.Configuration
{
	...
	public class BulkEmailInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BulkEmailInFolder_CrtBulkEmailEventsProcess(userConnection);
		}
	...
	public class BulkEmailInFolder : Terrasoft.Configuration.BaseItemInFolder
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new BulkEmailInFolder_CrtBulkEmailEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: BulkEmailInFolder_CrtBulkEmailEventsProcess

	/// <exclude/>
	public partial class BulkEmailInFolder_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : BulkEmailInFolder
	{

		public BulkEmailInFolder_CrtBulkEmailEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "BulkEmailInFolder_CrtBulkEmailEventsProcess";
	...
	/// <exclude/>
	public class BulkEmailInFolder_CrtBulkEmailEventsProcess : BulkEmailInFolder_CrtBulkEmailEventsProcess<BulkEmailInFolder>
	{
	...
	public partial class BulkEmailInFolder_CrtBulkEmailEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class BulkEmailInFolderEventsProcess : BulkEmailInFolder_CrtBulkEmailEventsProcess
	{

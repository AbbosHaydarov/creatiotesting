namespace Terrasoft.Configuration
{
	...
	#region Class: SysAdminUnit_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class SysAdminUnit_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{

		#region Constructors: Public

		public SysAdminUnit_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public SysAdminUnit_CrtCoreBase_TerrasoftSchema(SysAdminUnit_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public SysAdminUnit_CrtCoreBase_TerrasoftSchema(SysAdminUnit_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "SysAdminUnit_CrtCoreBase_Terrasoft";
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("138395e7-8528-67d3-bf4b-21cb6bd7ffb1")) == null) {
				Columns.Add(CreateNumberFormatColumn());
			}
		}
		...
		protected virtual EntitySchemaColumn CreateNumberFormatColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Lookup")) {
				UId = new Guid("138395e7-8528-67d3-bf4b-21cb6bd7ffb1"),
				Name = @"NumberFormat",
				ReferenceSchemaUId = new Guid("8a9a3dc6-1537-427f-bf7e-e18ee638d21f"),
				IsIndexed = true,
				CreatedInSchemaUId = new Guid("84f44b9a-4bc3-4cbf-a1a8-cec02c1c029c"),
				ModifiedInSchemaUId = new Guid("84f44b9a-4bc3-4cbf-a1a8-cec02c1c029c"),
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new SysAdminUnit_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysAdminUnit_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new SysAdminUnit_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new SysAdminUnit_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: SysAdminUnit_CrtCoreBase_Terrasoft

	/// <summary>
	/// System administration object.
	/// </summary>
	public class SysAdminUnit_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseLookup
	{

		#region Constructors: Public

		public SysAdminUnit_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "SysAdminUnit_CrtCoreBase_Terrasoft";
		}

		public SysAdminUnit_CrtCoreBase_Terrasoft(SysAdminUnit_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		/// <exclude/>
		public Guid NumberFormatId {
			get {
				return GetTypedColumnValue<Guid>("NumberFormatId");
			}
			set {
				SetColumnValue("NumberFormatId", value);
				_numberFormat = null;
			}
		}
		...
		public string NumberFormatName {
			get {
				return GetTypedColumnValue<string>("NumberFormatName");
			}
			set {
				SetColumnValue("NumberFormatName", value);
				if (_numberFormat != null) {
					_numberFormat.Name = value;
				}
			}
		}

		private SysNumberFormat _numberFormat;
		/// <summary>
		/// Number format.
		/// </summary>
		public SysNumberFormat NumberFormat {
			get {
				return _numberFormat ??
					(_numberFormat = LookupColumnEntities.GetEntity("NumberFormat") as SysNumberFormat);
			}
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysAdminUnit_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SysAdminUnit_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("SysAdminUnit_CrtCoreBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("SysAdminUnit_CrtCoreBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("SysAdminUnit_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("SysAdminUnit_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("SysAdminUnit_CrtCoreBase_TerrasoftSaving", e);
			Updated += (s, e) => ThrowEvent("SysAdminUnit_CrtCoreBase_TerrasoftUpdated", e);
			Validating += (s, e) => ThrowEvent("SysAdminUnit_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new SysAdminUnit_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: SysAdminUnit_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysAdminUnit_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysAdminUnit_CrtCoreBase_Terrasoft
	{

		public SysAdminUnit_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysAdminUnit_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysAdminUnit_CrtCoreBaseEventsProcess : SysAdminUnit_CrtCoreBaseEventsProcess<SysAdminUnit_CrtCoreBase_Terrasoft>
	{

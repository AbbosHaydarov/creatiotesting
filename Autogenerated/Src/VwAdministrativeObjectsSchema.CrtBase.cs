namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwAdministrativeObjects_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwAdministrativeObjects
	{

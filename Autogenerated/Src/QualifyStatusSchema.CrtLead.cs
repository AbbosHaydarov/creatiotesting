namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class QualifyStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
	...
	/// Lead stage.
	/// </summary>
	public class QualifyStatus : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Inserting += (s, e) => ThrowEvent("QualifyStatusInserting", e);
	...
	/// <exclude/>
	public partial class QualifyStatus_CrtLeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : QualifyStatus
	{
	...
	/// <exclude/>
	public class QualifyStatus_CrtLeadEventsProcess : QualifyStatus_CrtLeadEventsProcess<QualifyStatus>
	{
	...
	/// <exclude/>
	public class QualifyStatusEventsProcess : QualifyStatus_CrtLeadEventsProcess
	{

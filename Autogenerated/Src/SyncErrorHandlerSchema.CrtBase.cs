namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SyncErrorHandler_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SyncErrorHandler
	{

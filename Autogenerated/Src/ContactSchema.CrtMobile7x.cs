namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Contact_CrtMobile7x_TerrasoftSchema : Terrasoft.Configuration.Contact_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Contact.
	/// </summary>
	public class Contact_CrtMobile7x_Terrasoft : Terrasoft.Configuration.Contact_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Contact_CrtMobile7xEventsProcess<TEntity> : Terrasoft.Configuration.Contact_CrtCoreBaseEventsProcess<TEntity> where TEntity : Contact_CrtMobile7x_Terrasoft
	{

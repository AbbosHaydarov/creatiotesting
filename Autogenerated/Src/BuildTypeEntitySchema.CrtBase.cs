namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BuildTypeEntity_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BuildTypeEntity
	{

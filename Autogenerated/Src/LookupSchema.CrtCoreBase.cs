namespace Terrasoft.Configuration
{
	...
	public class LookupSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Lookup_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class Lookup : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Lookup_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: Lookup_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class Lookup_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Lookup
	{

		public Lookup_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Lookup_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class Lookup_CrtCoreBaseEventsProcess : Lookup_CrtCoreBaseEventsProcess<Lookup>
	{
	...
	public partial class Lookup_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class LookupEventsProcess : Lookup_CrtCoreBaseEventsProcess
	{

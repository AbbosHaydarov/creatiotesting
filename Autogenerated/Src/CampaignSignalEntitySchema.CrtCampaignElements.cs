namespace Terrasoft.Configuration
{
	...
	public class CampaignSignalEntitySchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("6b0f76f3-ab07-3f39-3f3b-b2118486bf7b")) == null) {
				Columns.Add(CreateWebPageURLColumnColumn());
			}
		}
		...
		protected virtual EntitySchemaColumn CreateWebPageURLColumnColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("MaxSizeText")) {
				UId = new Guid("6b0f76f3-ab07-3f39-3f3b-b2118486bf7b"),
				Name = @"WebPageURLColumn",
				CreatedInSchemaUId = new Guid("9cfc5a8a-fcc9-4634-a7a9-84500c8ccb14"),
				ModifiedInSchemaUId = new Guid("9cfc5a8a-fcc9-4634-a7a9-84500c8ccb14"),
	...
	public class CampaignSignalEntity : Terrasoft.Configuration.BaseEntity
	{
		...
		/// Web page URL path.
		/// </summary>
		public string WebPageURLColumn {
			get {
				return GetTypedColumnValue<string>("WebPageURLColumn");
			}
			set {
				SetColumnValue("WebPageURLColumn", value);
			}
		}

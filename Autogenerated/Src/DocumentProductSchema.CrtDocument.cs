namespace Terrasoft.Configuration
{
	...
	#region Class: DocumentProduct_CrtDocument_TerrasoftSchema

	/// <exclude/>
	public class DocumentProduct_CrtDocument_TerrasoftSchema : Terrasoft.Configuration.BaseProductEntrySchema
	{

		#region Constructors: Public

		public DocumentProduct_CrtDocument_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public DocumentProduct_CrtDocument_TerrasoftSchema(DocumentProduct_CrtDocument_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public DocumentProduct_CrtDocument_TerrasoftSchema(DocumentProduct_CrtDocument_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "DocumentProduct_CrtDocument_Terrasoft";
		...
		protected override EntitySchemaColumn CreateIdColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("5bab82ce-a828-4259-8ed9-5416ea3a0113");
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new DocumentProduct_CrtDocument_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new DocumentProduct_CrtDocumentEventsProcess(userConnection);
		}

		public override object Clone() {
			return new DocumentProduct_CrtDocument_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new DocumentProduct_CrtDocument_TerrasoftSchema(this, true);
		}
	...
	#region Class: DocumentProduct_CrtDocument_Terrasoft

	/// <summary>
	/// Product in document.
	/// </summary>
	public class DocumentProduct_CrtDocument_Terrasoft : Terrasoft.Configuration.BaseProductEntry
	{

		#region Constructors: Public

		public DocumentProduct_CrtDocument_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "DocumentProduct_CrtDocument_Terrasoft";
		}

		public DocumentProduct_CrtDocument_Terrasoft(DocumentProduct_CrtDocument_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new DocumentProduct_CrtDocumentEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("DocumentProduct_CrtDocument_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("DocumentProduct_CrtDocument_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("DocumentProduct_CrtDocument_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("DocumentProduct_CrtDocument_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("DocumentProduct_CrtDocument_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("DocumentProduct_CrtDocument_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("DocumentProduct_CrtDocument_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new DocumentProduct_CrtDocument_Terrasoft(this);
		}
	...
	#region Class: DocumentProduct_CrtDocumentEventsProcess

	/// <exclude/>
	public partial class DocumentProduct_CrtDocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseProductEntry_CrtProductCatalogueEventsProcess<TEntity> where TEntity : DocumentProduct_CrtDocument_Terrasoft
	{

		public DocumentProduct_CrtDocumentEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "DocumentProduct_CrtDocumentEventsProcess";
	...
	/// <exclude/>
	public class DocumentProduct_CrtDocumentEventsProcess : DocumentProduct_CrtDocumentEventsProcess<DocumentProduct_CrtDocument_Terrasoft>
	{

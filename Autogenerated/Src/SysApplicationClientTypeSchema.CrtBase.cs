namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysApplicationClientType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysApplicationClientType
	{

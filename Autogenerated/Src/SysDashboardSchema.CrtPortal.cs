namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SysDashboardSchema : Terrasoft.Configuration.SysDashboard_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Dashboard.
	/// </summary>
	public class SysDashboard : Terrasoft.Configuration.SysDashboard_CrtCoreBase_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("SysDashboardDeleting", e);
			Inserted += (s, e) => ThrowEvent("SysDashboardInserted", e);
			Saved += (s, e) => ThrowEvent("SysDashboardSaved", e);
			Saving += (s, e) => ThrowEvent("SysDashboardSaving", e);
	...
	/// <exclude/>
	public partial class SysDashboard_CrtPortalEventsProcess<TEntity> : Terrasoft.Configuration.SysDashboard_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysDashboard
	{

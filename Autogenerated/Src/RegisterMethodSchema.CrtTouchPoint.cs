namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class RegisterMethod_CrtTouchPointEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : RegisterMethod
	{

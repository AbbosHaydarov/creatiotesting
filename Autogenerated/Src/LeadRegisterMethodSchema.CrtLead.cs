namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadRegisterMethod_CrtLeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LeadRegisterMethod
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class VwSysDcmLibSchema : Terrasoft.Core.Entities.EntitySchema
	{
	...
	/// <exclude/>
	public partial class VwSysDcmLib_DcmDesignerEventsProcess<TEntity> : Terrasoft.Core.Process.EmbeddedProcess where TEntity : VwSysDcmLib
	{
	...
	/// <exclude/>
	public class VwSysDcmLib_DcmDesignerEventsProcess : VwSysDcmLib_DcmDesignerEventsProcess<VwSysDcmLib>
	{
	...
	/// <exclude/>
	public class VwSysDcmLibEventsProcess : VwSysDcmLib_DcmDesignerEventsProcess
	{

define("DuplicatesWidget", [
	...(Terrasoft.UseMfForAngularElements ? ["mf!DuplicatesWidgetComponent", "css-ltr!DuplicatesWidgetComponentStyles"] : ["DuplicatesWidgetComponentOld"])
], function() {
	/**

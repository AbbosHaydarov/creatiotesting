namespace Terrasoft.Configuration
{
	...
	public class EmailSendStatusSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EmailSendStatus_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class EmailSendStatus : Terrasoft.Configuration.BaseCodeLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new EmailSendStatus_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: EmailSendStatus_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class EmailSendStatus_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : EmailSendStatus
	{

		public EmailSendStatus_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "EmailSendStatus_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class EmailSendStatus_CrtCoreBaseEventsProcess : EmailSendStatus_CrtCoreBaseEventsProcess<EmailSendStatus>
	{
	...
	public partial class EmailSendStatus_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class EmailSendStatusEventsProcess : EmailSendStatus_CrtCoreBaseEventsProcess
	{

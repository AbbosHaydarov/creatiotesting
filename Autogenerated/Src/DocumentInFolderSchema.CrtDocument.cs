namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentInFolder_CrtDocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : DocumentInFolder
	{

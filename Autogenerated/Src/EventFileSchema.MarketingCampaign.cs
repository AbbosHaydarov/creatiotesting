namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class EventFile_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : EventFile
	{

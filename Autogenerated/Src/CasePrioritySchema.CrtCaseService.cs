namespace Terrasoft.Configuration
{
	...
	public class CasePriority : Terrasoft.Configuration.CasePriority_CrtCaseManagmentObject_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("CasePriorityDeleting", e);
			Inserted += (s, e) => ThrowEvent("CasePriorityInserted", e);
			Inserting += (s, e) => ThrowEvent("CasePriorityInserting", e);
			Saved += (s, e) => ThrowEvent("CasePrioritySaved", e);
			Saving += (s, e) => ThrowEvent("CasePrioritySaving", e);

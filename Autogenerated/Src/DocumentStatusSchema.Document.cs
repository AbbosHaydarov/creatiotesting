namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentStatus_DocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : DocumentStatus
	{

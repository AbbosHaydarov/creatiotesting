namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OpportunityChannel_CrtOpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : OpportunityChannel
	{

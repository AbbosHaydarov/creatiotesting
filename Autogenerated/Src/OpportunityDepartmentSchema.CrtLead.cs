namespace Terrasoft.Configuration
{
	...
	#region Class: OpportunityDepartment_CrtLead_TerrasoftSchema

	/// <exclude/>
	public class OpportunityDepartment_CrtLead_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{

		#region Constructors: Public

		public OpportunityDepartment_CrtLead_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public OpportunityDepartment_CrtLead_TerrasoftSchema(OpportunityDepartment_CrtLead_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public OpportunityDepartment_CrtLead_TerrasoftSchema(OpportunityDepartment_CrtLead_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "OpportunityDepartment_CrtLead_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new OpportunityDepartment_CrtLead_Terrasoft(userConnection) {Schema = this};
		}
		...
		public override object Clone() {
			return new OpportunityDepartment_CrtLead_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new OpportunityDepartment_CrtLead_TerrasoftSchema(this, true);
		}
	...
	#region Class: OpportunityDepartment_CrtLead_Terrasoft

	/// <summary>
	/// Sales division.
	/// </summary>
	public class OpportunityDepartment_CrtLead_Terrasoft : Terrasoft.Configuration.BaseLookup
	{

		#region Constructors: Public

		public OpportunityDepartment_CrtLead_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "OpportunityDepartment_CrtLead_Terrasoft";
		}

		public OpportunityDepartment_CrtLead_Terrasoft(OpportunityDepartment_CrtLead_Terrasoft source)
			: base(source) {
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("OpportunityDepartment_CrtLead_TerrasoftDeleted", e);
			Inserting += (s, e) => ThrowEvent("OpportunityDepartment_CrtLead_TerrasoftInserting", e);
			Validating += (s, e) => ThrowEvent("OpportunityDepartment_CrtLead_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new OpportunityDepartment_CrtLead_Terrasoft(this);
		}
	...
	/// <exclude/>
	public partial class OpportunityDepartment_CrtLeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : OpportunityDepartment_CrtLead_Terrasoft
	{
	...
	/// <exclude/>
	public class OpportunityDepartment_CrtLeadEventsProcess : OpportunityDepartment_CrtLeadEventsProcess<OpportunityDepartment_CrtLead_Terrasoft>
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Product_CrtProductCatalogue_TerrasoftSchema : Terrasoft.Configuration.Product_CrtProductBase_TerrasoftSchema
	{
	...
	/// Product.
	/// </summary>
	public class Product_CrtProductCatalogue_Terrasoft : Terrasoft.Configuration.Product_CrtProductBase_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("Product_CrtProductCatalogue_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Product_CrtProductCatalogue_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Product_CrtProductCatalogue_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Product_CrtProductCatalogue_TerrasoftSaved", e);
			Updating += (s, e) => ThrowEvent("Product_CrtProductCatalogue_TerrasoftUpdating", e);
	...
	/// <exclude/>
	public partial class Product_CrtProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.Product_CrtProductBaseEventsProcess<TEntity> where TEntity : Product_CrtProductCatalogue_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysCulture_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysCulture_CrtCoreBase_Terrasoft
	{

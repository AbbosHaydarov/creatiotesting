namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OpportunityFlags_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseImageLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : OpportunityFlags
	{

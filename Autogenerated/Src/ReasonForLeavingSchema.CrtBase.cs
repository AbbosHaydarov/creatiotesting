namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ReasonForLeaving_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ReasonForLeaving
	{

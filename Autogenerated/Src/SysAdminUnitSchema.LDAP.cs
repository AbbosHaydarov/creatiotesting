namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class SysAdminUnit_LDAP_TerrasoftSchema : Terrasoft.Configuration.SysAdminUnit_CrtCoreBase_TerrasoftSchema
	{
	...
	/// </summary>
	public class SysAdminUnit_LDAP_Terrasoft : Terrasoft.Configuration.SysAdminUnit_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class SysAdminUnit_LDAPEventsProcess<TEntity> : Terrasoft.Configuration.SysAdminUnit_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysAdminUnit_LDAP_Terrasoft
	{

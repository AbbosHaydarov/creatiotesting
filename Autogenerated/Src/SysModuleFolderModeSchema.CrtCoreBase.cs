namespace Terrasoft.Configuration
{
	...
	public class SysModuleFolderModeSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysModuleFolderMode_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysModuleFolderMode : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysModuleFolderMode_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysModuleFolderMode_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysModuleFolderMode_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleFolderMode
	{

		public SysModuleFolderMode_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysModuleFolderMode_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysModuleFolderMode_CrtCoreBaseEventsProcess : SysModuleFolderMode_CrtCoreBaseEventsProcess<SysModuleFolderMode>
	{
	...
	public partial class SysModuleFolderMode_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysModuleFolderModeEventsProcess : SysModuleFolderMode_CrtCoreBaseEventsProcess
	{

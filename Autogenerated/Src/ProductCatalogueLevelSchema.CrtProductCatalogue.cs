namespace Terrasoft.Configuration
{
	...
	public class ProductCatalogueLevel_CrtProductCatalogue_Terrasoft : Terrasoft.Configuration.BaseEntityWithPosition
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Inserted += (s, e) => ThrowEvent("ProductCatalogueLevel_CrtProductCatalogue_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("ProductCatalogueLevel_CrtProductCatalogue_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("ProductCatalogueLevel_CrtProductCatalogue_TerrasoftSaved", e);
	...
	/// <exclude/>
	public partial class ProductCatalogueLevel_CrtProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityWithPosition_CrtCoreBaseEventsProcess<TEntity> where TEntity : ProductCatalogueLevel_CrtProductCatalogue_Terrasoft
	{

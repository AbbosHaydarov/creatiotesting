namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenErrorType_CrtSocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LeadGenErrorType
	{

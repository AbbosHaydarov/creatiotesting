namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailType_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BulkEmailType
	{

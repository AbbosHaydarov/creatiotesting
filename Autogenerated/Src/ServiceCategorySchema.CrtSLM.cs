namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceCategory_CrtSLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ServiceCategory
	{

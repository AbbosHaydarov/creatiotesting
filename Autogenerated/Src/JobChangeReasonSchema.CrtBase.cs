namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class JobChangeReason_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : JobChangeReason
	{

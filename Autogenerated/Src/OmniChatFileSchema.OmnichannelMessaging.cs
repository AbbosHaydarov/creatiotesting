namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OmniChatFile_OmnichannelMessagingEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : OmniChatFile
	{

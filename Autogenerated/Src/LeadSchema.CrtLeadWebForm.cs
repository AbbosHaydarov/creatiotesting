namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_CrtLeadWebForm_TerrasoftSchema : Terrasoft.Configuration.Lead_CrtLead_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_CrtLeadWebForm_Terrasoft : Terrasoft.Configuration.Lead_CrtLead_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Lead_CrtLeadWebForm_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Lead_CrtLeadWebForm_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Lead_CrtLeadWebForm_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Lead_CrtLeadWebForm_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Lead_CrtLeadWebForm_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Lead_CrtLeadWebForm_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Lead_CrtLeadWebForm_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Lead_CrtLeadWebFormEventsProcess<TEntity> : Terrasoft.Configuration.Lead_CrtLeadEventsProcess<TEntity> where TEntity : Lead_CrtLeadWebForm_Terrasoft
	{

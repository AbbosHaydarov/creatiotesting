namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Account_RelationshipDesigner_TerrasoftSchema : Terrasoft.Configuration.Account_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Account.
	/// </summary>
	public class Account_RelationshipDesigner_Terrasoft : Terrasoft.Configuration.Account_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Account_RelationshipDesignerEventsProcess<TEntity> : Terrasoft.Configuration.Account_CrtCoreBaseEventsProcess<TEntity> where TEntity : Account_RelationshipDesigner_Terrasoft
	{

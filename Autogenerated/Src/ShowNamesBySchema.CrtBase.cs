namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ShowNamesBy_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ShowNamesBy
	{

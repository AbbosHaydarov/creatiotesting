namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CampaignSchema : Terrasoft.Configuration.Campaign_CrtMarketingCampaignsApp_TerrasoftSchema
	{
	...
	/// Campaign.
	/// </summary>
	public class Campaign : Terrasoft.Configuration.Campaign_CrtMarketingCampaignsApp_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Campaign_CampaignsEventsProcess<TEntity> : Terrasoft.Configuration.Campaign_CrtMarketingCampaignsAppEventsProcess<TEntity> where TEntity : Campaign
	{

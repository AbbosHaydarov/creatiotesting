namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ESNNotificationType_CrtESNEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ESNNotificationType
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Blacklist_CrtJunkFilterEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : Blacklist
	{

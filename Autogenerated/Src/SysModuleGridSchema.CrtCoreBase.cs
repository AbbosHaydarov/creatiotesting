namespace Terrasoft.Configuration
{
	...
	public class SysModuleGridSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysModuleGrid_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysModuleGrid : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysModuleGrid_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysModuleGrid_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysModuleGrid_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : SysModuleGrid
	{

		public SysModuleGrid_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysModuleGrid_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysModuleGrid_CrtCoreBaseEventsProcess : SysModuleGrid_CrtCoreBaseEventsProcess<SysModuleGrid>
	{
	...
	public partial class SysModuleGrid_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysModuleGridEventsProcess : SysModuleGrid_CrtCoreBaseEventsProcess
	{

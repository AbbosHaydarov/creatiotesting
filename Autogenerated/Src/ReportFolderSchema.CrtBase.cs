namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ReportFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : ReportFolder
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysProcessFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSysProcessFolder
	{

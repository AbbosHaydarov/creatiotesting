namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CallInFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : CallInFolder
	{

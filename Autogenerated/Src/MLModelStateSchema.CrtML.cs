namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MLModelState_CrtMLEventsProcess<TEntity> : Terrasoft.Configuration.SysCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : MLModelState
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadDisqualifyReason_CrtLeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LeadDisqualifyReason
	{

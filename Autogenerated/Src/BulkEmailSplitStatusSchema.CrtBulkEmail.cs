namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailSplitStatus_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BulkEmailSplitStatus
	{

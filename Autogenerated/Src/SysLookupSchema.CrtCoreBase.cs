namespace Terrasoft.Configuration
{
	...
	public class SysLookupSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysLookup_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysLookup : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysLookup_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysLookup_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysLookup_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysLookup
	{

		public SysLookup_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysLookup_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysLookup_CrtCoreBaseEventsProcess : SysLookup_CrtCoreBaseEventsProcess<SysLookup>
	{
	...
	public partial class SysLookup_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysLookupEventsProcess : SysLookup_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	[IsVirtual]
	public class BaseTagSchema : Terrasoft.Configuration.BaseTag_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Base tag.
	/// </summary>
	public class BaseTag : Terrasoft.Configuration.BaseTag_CrtCoreBase_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Inserted += (s, e) => ThrowEvent("BaseTagInserted", e);
	...
	/// <exclude/>
	public partial class BaseTag_SSPEventsProcess<TEntity> : Terrasoft.Configuration.BaseTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : BaseTag
	{

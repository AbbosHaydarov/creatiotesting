namespace Terrasoft.Configuration
{
	...
	public class SimilarLeadSchema : Terrasoft.Configuration.LeadSchema
	{
		...
		protected override EntitySchemaColumn CreateIdColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("80a0ce86-21bf-48e5-ad90-015baf5e0564");
		...
		protected override EntitySchemaColumn CreateLeadDisqualifyReasonColumn() {
			EntitySchemaColumn column = base.CreateLeadDisqualifyReasonColumn();
			column.ModifiedInSchemaUId = new Guid("80a0ce86-21bf-48e5-ad90-015baf5e0564");
			column.CreatedInPackageId = new Guid("1800af83-2123-40e8-b79f-0e68449a9687");
			return column;
		}

		protected override EntitySchemaColumn CreateDepartmentColumn() {
			EntitySchemaColumn column = base.CreateDepartmentColumn();
			column.ModifiedInSchemaUId = new Guid("80a0ce86-21bf-48e5-ad90-015baf5e0564");
			column.CreatedInPackageId = new Guid("1800af83-2123-40e8-b79f-0e68449a9687");
			return column;
		}

		protected override EntitySchemaColumn CreateDecisionRoleColumn() {
			EntitySchemaColumn column = base.CreateDecisionRoleColumn();
			column.ModifiedInSchemaUId = new Guid("80a0ce86-21bf-48e5-ad90-015baf5e0564");
			column.CreatedInPackageId = new Guid("1800af83-2123-40e8-b79f-0e68449a9687");
			return column;
		}
		...
		protected override EntitySchemaColumn CreateSalesOwnerColumn() {
			EntitySchemaColumn column = base.CreateSalesOwnerColumn();
			column.ModifiedInSchemaUId = new Guid("80a0ce86-21bf-48e5-ad90-015baf5e0564");
			column.CreatedInPackageId = new Guid("1800af83-2123-40e8-b79f-0e68449a9687");
			return column;
		}
	...
	public class SimilarLead : Terrasoft.Configuration.Lead
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SimilarLeadDeleted", e);
			Deleting += (s, e) => ThrowEvent("SimilarLeadDeleting", e);
			Inserted += (s, e) => ThrowEvent("SimilarLeadInserted", e);
			Inserting += (s, e) => ThrowEvent("SimilarLeadInserting", e);
			Saved += (s, e) => ThrowEvent("SimilarLeadSaved", e);
			Saving += (s, e) => ThrowEvent("SimilarLeadSaving", e);
			Validating += (s, e) => ThrowEvent("SimilarLeadValidating", e);
	...
	/// <exclude/>
	public partial class SimilarLead_CrtSimilarLeadEventsProcess<TEntity> : Terrasoft.Configuration.Lead_BankSales_BCJ_Lending_MarketingEventsProcess<TEntity> where TEntity : SimilarLead
	{

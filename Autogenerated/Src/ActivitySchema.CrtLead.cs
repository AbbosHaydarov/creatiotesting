namespace Terrasoft.Configuration
{
	...
	#region Class: Activity_CrtLead_TerrasoftSchema

	/// <exclude/>
	public class Activity_CrtLead_TerrasoftSchema : Terrasoft.Configuration.Activity_CrtBaseFinserv_TerrasoftSchema
	{

		#region Constructors: Public

		public Activity_CrtLead_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Activity_CrtLead_TerrasoftSchema(Activity_CrtLead_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Activity_CrtLead_TerrasoftSchema(Activity_CrtLead_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			RealUId = new Guid("0fd420b4-0616-4aba-b268-a370995ef846");
			Name = "Activity_CrtLead_Terrasoft";
			ParentSchemaUId = new Guid("c449d832-a4cc-4b01-b9d5-8a12c42a9f89");
			ExtendParent = true;
			CreatedInPackageId = new Guid("55f47f2b-5635-48ad-aa37-f2e214d25537");
			IsDBView = false;
		...
		protected virtual EntitySchemaColumn CreateLeadColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Lookup")) {
				...
				IsIndexed = true,
				CreatedInSchemaUId = new Guid("0fd420b4-0616-4aba-b268-a370995ef846"),
				ModifiedInSchemaUId = new Guid("0fd420b4-0616-4aba-b268-a370995ef846"),
				CreatedInPackageId = new Guid("55f47f2b-5635-48ad-aa37-f2e214d25537")
			};
		}
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Activity_CrtLead_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Activity_CrtLeadEventsProcess(userConnection);
		}

		public override object Clone() {
			return new Activity_CrtLead_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Activity_CrtLead_TerrasoftSchema(this, true);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("0fd420b4-0616-4aba-b268-a370995ef846"));
		}
	...
	#region Class: Activity_CrtLead_Terrasoft

	/// <summary>
	/// Activity.
	/// </summary>
	public class Activity_CrtLead_Terrasoft : Terrasoft.Configuration.Activity_CrtBaseFinserv_Terrasoft
	{

		#region Constructors: Public

		public Activity_CrtLead_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Activity_CrtLead_Terrasoft";
		}

		public Activity_CrtLead_Terrasoft(Activity_CrtLead_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Activity_CrtLeadEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		public override object Clone() {
			return new Activity_CrtLead_Terrasoft(this);
		}
	...
	#region Class: Activity_CrtLeadEventsProcess

	/// <exclude/>
	public partial class Activity_CrtLeadEventsProcess<TEntity> : Terrasoft.Configuration.Activity_CrtBaseFinservEventsProcess<TEntity> where TEntity : Activity_CrtLead_Terrasoft
	{

		public Activity_CrtLeadEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Activity_CrtLeadEventsProcess";
		...
		private Guid InternalSchemaUId {
			get {
				return new Guid("0fd420b4-0616-4aba-b268-a370995ef846");
			}
		}
	...
	/// <exclude/>
	public class Activity_CrtLeadEventsProcess : Activity_CrtLeadEventsProcess<Activity_CrtLead_Terrasoft>
	{
	...
	public partial class Activity_CrtLeadEventsProcess<TEntity>
	{

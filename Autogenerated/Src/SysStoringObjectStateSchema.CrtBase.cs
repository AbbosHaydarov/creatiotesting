namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysStoringObjectState_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysStoringObjectState
	{

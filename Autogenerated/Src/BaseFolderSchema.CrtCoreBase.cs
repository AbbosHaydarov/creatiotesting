namespace Terrasoft.Configuration
{
	...
	public class BaseFolderSchema : Terrasoft.Configuration.BaseHierarchicalLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BaseFolder_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class BaseFolder : Terrasoft.Configuration.BaseHierarchicalLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new BaseFolder_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: BaseFolder_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class BaseFolder_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseHierarchicalLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BaseFolder
	{

		public BaseFolder_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "BaseFolder_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class BaseFolder_CrtCoreBaseEventsProcess : BaseFolder_CrtCoreBaseEventsProcess<BaseFolder>
	{
	...
	public partial class BaseFolder_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class BaseFolderEventsProcess : BaseFolder_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SubjectResult_CTIBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SubjectResult
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysChartSeriesKind_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeImageLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysChartSeriesKind
	{

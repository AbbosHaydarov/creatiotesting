namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ContactSalutationTypeSchema : Terrasoft.Configuration.ContactSalutationType_CrtCoreBase_TerrasoftSchema
	{
	...
	/// Contact title.
	/// </summary>
	public class ContactSalutationType : Terrasoft.Configuration.ContactSalutationType_CrtCoreBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class ContactSalutationType_SSPEventsProcess<TEntity> : Terrasoft.Configuration.ContactSalutationType_CrtCoreBaseEventsProcess<TEntity> where TEntity : ContactSalutationType
	{

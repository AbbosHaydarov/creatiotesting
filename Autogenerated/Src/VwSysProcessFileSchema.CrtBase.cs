namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysProcessFile_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : VwSysProcessFile
	{

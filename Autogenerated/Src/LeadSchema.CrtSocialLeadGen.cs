namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_CrtSocialLeadGen_TerrasoftSchema : Terrasoft.Configuration.Lead_CrtOpportunityManagement_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_CrtSocialLeadGen_Terrasoft : Terrasoft.Configuration.Lead_CrtOpportunityManagement_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Lead_CrtSocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.Lead_CrtOpportunityManagementEventsProcess<TEntity> where TEntity : Lead_CrtSocialLeadGen_Terrasoft
	{

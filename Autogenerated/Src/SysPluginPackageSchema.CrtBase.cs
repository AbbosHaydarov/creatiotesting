namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysPluginPackage_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysPluginPackage
	{

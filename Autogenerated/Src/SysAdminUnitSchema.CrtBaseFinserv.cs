namespace Terrasoft.Configuration
{
	...
	public class SysAdminUnitSchema : Terrasoft.Configuration.SysAdminUnit_SSP_TerrasoftSchema
	{
		...
		protected override void InitializeProperties() {
			...
			RealUId = new Guid("ff504668-d2cc-499f-bc39-5248349191da");
			Name = "SysAdminUnit";
		...
		protected override EntitySchemaColumn CreateNameColumn() {
			...
			column.ModifiedInSchemaUId = new Guid("ff504668-d2cc-499f-bc39-5248349191da");
			return column;
		}
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysAdminUnit_CrtBaseFinservEventsProcess(userConnection);
		}
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("ff504668-d2cc-499f-bc39-5248349191da"));
		}
	...
	public class SysAdminUnit : Terrasoft.Configuration.SysAdminUnit_SSP_Terrasoft
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysAdminUnit_CrtBaseFinservEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("SysAdminUnitDeleted", e);
			Deleting += (s, e) => ThrowEvent("SysAdminUnitDeleting", e);
			Inserted += (s, e) => ThrowEvent("SysAdminUnitInserted", e);
			Inserting += (s, e) => ThrowEvent("SysAdminUnitInserting", e);
			Saved += (s, e) => ThrowEvent("SysAdminUnitSaved", e);
	...
	#region Class: SysAdminUnit_CrtBaseFinservEventsProcess

	/// <exclude/>
	public partial class SysAdminUnit_CrtBaseFinservEventsProcess<TEntity> : Terrasoft.Configuration.SysAdminUnit_SSPEventsProcess<TEntity> where TEntity : SysAdminUnit
	{

		public SysAdminUnit_CrtBaseFinservEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysAdminUnit_CrtBaseFinservEventsProcess";
		...
		private Guid InternalSchemaUId {
			get {
				return new Guid("ff504668-d2cc-499f-bc39-5248349191da");
			}
		}
	...
	/// <exclude/>
	public class SysAdminUnit_CrtBaseFinservEventsProcess : SysAdminUnit_CrtBaseFinservEventsProcess<SysAdminUnit>
	{
	...
	public partial class SysAdminUnit_CrtBaseFinservEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysAdminUnitEventsProcess : SysAdminUnit_CrtBaseFinservEventsProcess
	{

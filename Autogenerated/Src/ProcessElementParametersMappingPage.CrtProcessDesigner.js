				...
				methods: {
					...
					_directionValidator: function(item) {
						return item.direction !== Terrasoft.ProcessSchemaParameterDirection.IN &&
							item.direction !== Terrasoft.ProcessSchemaParameterDirection.INTERNAL;
					},
					...
					getSelectedData: function() {
						...
						return this.getParameterSelectedValue(elementRow, parameterRow);
					},
					 ...
					 */
					getParameterSelectedValue: function(elementRow, parameterRow) {

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Attribute_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : Attribute
	{

namespace Terrasoft.Core.Process
{
	...
	#region Class: Copilot_GetOpportunityFeedMessagesMethodsWrapper

	/// <exclude/>
	public class Copilot_GetOpportunityFeedMessagesMethodsWrapper : ProcessModel
	{

		public Copilot_GetOpportunityFeedMessagesMethodsWrapper(Process process)
			: base(process) {

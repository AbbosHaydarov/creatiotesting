namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TradeMark_CrtProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : TradeMark
	{

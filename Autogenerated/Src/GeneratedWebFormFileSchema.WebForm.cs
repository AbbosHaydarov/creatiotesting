namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class GeneratedWebFormFile_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : GeneratedWebFormFile
	{

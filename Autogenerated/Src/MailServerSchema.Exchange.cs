namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class MailServerSchema : Terrasoft.Configuration.MailServer_CrtCoreBase_TerrasoftSchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("0b5a45ef-c6f9-cbc4-3483-530a346a2767")) == null) {
				Columns.Add(CreateServiceAccountPasswordColumn());
			}
			if (Columns.FindByUId(new Guid("b741c8e1-e3ef-f8b3-e0c6-031c7cb5c976")) == null) {
				Columns.Add(CreateServiceAccountLoginColumn());
			}
			if (Columns.FindByUId(new Guid("47657147-4320-9148-139f-a58e13886e00")) == null) {
				Columns.Add(CreateUseImpersonationColumn());
			}
		}
		...
		protected virtual EntitySchemaColumn CreateServiceAccountPasswordColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("SecureText")) {
				UId = new Guid("0b5a45ef-c6f9-cbc4-3483-530a346a2767"),
		...
		protected virtual EntitySchemaColumn CreateServiceAccountLoginColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("LongText")) {
				UId = new Guid("b741c8e1-e3ef-f8b3-e0c6-031c7cb5c976"),
		...
		protected virtual EntitySchemaColumn CreateUseImpersonationColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Boolean")) {
				UId = new Guid("47657147-4320-9148-139f-a58e13886e00"),
	...
	/// Email provider.
	/// </summary>
	public class MailServer : Terrasoft.Configuration.MailServer_CrtCoreBase_Terrasoft
	{
		...
		public string ServiceAccountPassword {
			get {
				return GetTypedColumnValue<string>("ServiceAccountPassword");
			}
			set {
				SetColumnValue("ServiceAccountPassword", value);
			}
		}
		...
		public string ServiceAccountLogin {
			get {
				return GetTypedColumnValue<string>("ServiceAccountLogin");
			}
			set {
				SetColumnValue("ServiceAccountLogin", value);
			}
		}
		...
		public bool UseImpersonation {
			get {
				return GetTypedColumnValue<bool>("UseImpersonation");
			}
			set {
				SetColumnValue("UseImpersonation", value);
			}
		}
	...
	/// <exclude/>
	public partial class MailServer_ExchangeEventsProcess<TEntity> : Terrasoft.Configuration.MailServer_CrtCoreBaseEventsProcess<TEntity> where TEntity : MailServer
	{

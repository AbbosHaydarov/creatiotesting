namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Account_CrtCustomer360App_TerrasoftSchema : Terrasoft.Configuration.Account_SSP_TerrasoftSchema
	{
	...
	/// Account.
	/// </summary>
	public class Account_CrtCustomer360App_Terrasoft : Terrasoft.Configuration.Account_SSP_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Account_CrtCustomer360App_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Account_CrtCustomer360App_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("Account_CrtCustomer360App_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("Account_CrtCustomer360App_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Account_CrtCustomer360App_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Account_CrtCustomer360App_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Account_CrtCustomer360App_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class Account_CrtCustomer360AppEventsProcess<TEntity> : Terrasoft.Configuration.Account_SSPEventsProcess<TEntity> where TEntity : Account_CrtCustomer360App_Terrasoft
	{

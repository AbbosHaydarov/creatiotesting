namespace Terrasoft.Configuration
{
	...
	public class OpportunityFile_CrtOpportunity_Terrasoft : Terrasoft.Configuration.File
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("OpportunityFile_CrtOpportunity_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("OpportunityFile_CrtOpportunity_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("OpportunityFile_CrtOpportunity_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("OpportunityFile_CrtOpportunity_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("OpportunityFile_CrtOpportunity_TerrasoftSaving", e);
			Updated += (s, e) => ThrowEvent("OpportunityFile_CrtOpportunity_TerrasoftUpdated", e);
			Validating += (s, e) => ThrowEvent("OpportunityFile_CrtOpportunity_TerrasoftValidating", e);
	...
	/// <exclude/>
	public partial class OpportunityFile_CrtOpportunityEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : OpportunityFile_CrtOpportunity_Terrasoft
	{

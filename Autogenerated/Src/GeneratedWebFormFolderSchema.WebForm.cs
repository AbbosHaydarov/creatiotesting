namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class GeneratedWebFormFolder_WebFormEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : GeneratedWebFormFolder
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MLModelColumnType_CrtMLEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : MLModelColumnType
	{

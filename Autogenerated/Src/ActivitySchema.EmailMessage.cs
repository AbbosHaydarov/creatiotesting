namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_EmailMessage_TerrasoftSchema : Terrasoft.Configuration.Activity_CoreContracts_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_EmailMessage_Terrasoft : Terrasoft.Configuration.Activity_CoreContracts_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_EmailMessageEventsProcess<TEntity> : Terrasoft.Configuration.Activity_CoreContractsEventsProcess<TEntity> where TEntity : Activity_EmailMessage_Terrasoft
	{

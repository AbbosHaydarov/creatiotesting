namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LoginPageLink_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LoginPageLink
	{

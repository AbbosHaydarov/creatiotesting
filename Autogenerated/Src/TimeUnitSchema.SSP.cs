namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class TimeUnitSchema : Terrasoft.Configuration.TimeUnit_CrtCalendar_TerrasoftSchema
	{
	...
	/// Time unit.
	/// </summary>
	public class TimeUnit : Terrasoft.Configuration.TimeUnit_CrtCalendar_Terrasoft
	{
	...
	/// <exclude/>
	public partial class TimeUnit_SSPEventsProcess<TEntity> : Terrasoft.Configuration.TimeUnit_CrtCalendarEventsProcess<TEntity> where TEntity : TimeUnit
	{

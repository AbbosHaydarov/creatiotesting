namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceStatus_CrtSLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ServiceStatus
	{

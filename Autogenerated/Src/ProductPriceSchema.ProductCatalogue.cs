namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class ProductPriceSchema : Terrasoft.Configuration.ProductPrice_CrtProductCatalogue_TerrasoftSchema
	{
	...
	/// Product price.
	/// </summary>
	public class ProductPrice : Terrasoft.Configuration.ProductPrice_CrtProductCatalogue_Terrasoft
	{
	...
	/// <exclude/>
	public partial class ProductPrice_ProductCatalogueEventsProcess<TEntity> : Terrasoft.Configuration.ProductPrice_CrtProductCatalogueEventsProcess<TEntity> where TEntity : ProductPrice
	{

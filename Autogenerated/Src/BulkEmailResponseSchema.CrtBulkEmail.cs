namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailResponse_CrtBulkEmailEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : BulkEmailResponse
	{

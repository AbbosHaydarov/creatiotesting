namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysMsgUserStateIcon_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseImageLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysMsgUserStateIcon
	{

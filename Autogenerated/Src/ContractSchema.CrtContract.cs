namespace Terrasoft.Configuration
{
	...
	public class Contract_CrtContract_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("9b616281-6de1-8cd9-fe46-04cf6eea3efd")) == null) {
				Columns.Add(CreateCreatedFromOrderColumn());
			}
		}
		...
		protected virtual EntitySchemaColumn CreateCreatedFromOrderColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Boolean")) {
				UId = new Guid("9b616281-6de1-8cd9-fe46-04cf6eea3efd"),
				Name = @"CreatedFromOrder",
				IsValueCloneable = false,
				CreatedInSchemaUId = new Guid("897be3e4-0333-467d-88e2-b7a945c0d810"),
				ModifiedInSchemaUId = new Guid("897be3e4-0333-467d-88e2-b7a945c0d810"),
				CreatedInPackageId = new Guid("7c211ceb-ac84-4aeb-b0ed-0c820edb993b")
			};
		}

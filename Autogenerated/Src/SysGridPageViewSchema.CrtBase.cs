namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class SysGridPageView_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseHierarchicalLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysGridPageView
	{

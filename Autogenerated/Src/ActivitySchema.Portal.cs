namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Activity_Portal_TerrasoftSchema : Terrasoft.Configuration.Activity_Opportunity_TerrasoftSchema
	{
	...
	/// Activity.
	/// </summary>
	public class Activity_Portal_Terrasoft : Terrasoft.Configuration.Activity_Opportunity_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Activity_PortalEventsProcess<TEntity> : Terrasoft.Configuration.Activity_OpportunityEventsProcess<TEntity> where TEntity : Activity_Portal_Terrasoft
	{

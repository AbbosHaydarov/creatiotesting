namespace Terrasoft.Configuration
{
	...
	public class MLModelSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("1d272df2-dc16-e0bb-b155-aef8f74445b7")) == null) {
				Columns.Add(CreateOpenaiApiKeyColumn());
			}
			if (Columns.FindByUId(new Guid("0fe63c77-1ab6-ba24-8ac2-9ada8a4f6e33")) == null) {
				Columns.Add(CreateLlmModelPromptColumn());
			}
			if (Columns.FindByUId(new Guid("2e2a0f0b-db2b-c543-abfc-cbb5db69a5e9")) == null) {
				Columns.Add(CreateLlmModelNameColumn());
			}
			if (Columns.FindByUId(new Guid("5523b5a6-b5d0-c765-7734-0a5980048dae")) == null) {
				Columns.Add(CreateLlmModelTemperatureColumn());
			}
			if (Columns.FindByUId(new Guid("1a847f96-71ad-8fa6-6202-fe68e558c6b1")) == null) {
				Columns.Add(CreateDocumentMaxChunkSizeColumn());
			}
			if (Columns.FindByUId(new Guid("081bef1d-02af-259e-ba2b-1e5875f7f46b")) == null) {
				Columns.Add(CreateDocumentChunkSizeOverlapColumn());
			}
		}
		...
		protected virtual EntitySchemaColumn CreateOpenaiApiKeyColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("MediumText")) {
				UId = new Guid("1d272df2-dc16-e0bb-b155-aef8f74445b7"),
				Name = @"OpenaiApiKey",
				IsValueCloneable = false,
				CreatedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
				ModifiedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
		...
		protected virtual EntitySchemaColumn CreateLlmModelPromptColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("RichText")) {
				UId = new Guid("0fe63c77-1ab6-ba24-8ac2-9ada8a4f6e33"),
				Name = @"LlmModelPrompt",
				IsValueCloneable = false,
				CreatedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
				ModifiedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
		...
		protected virtual EntitySchemaColumn CreateLlmModelNameColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("ShortText")) {
				UId = new Guid("2e2a0f0b-db2b-c543-abfc-cbb5db69a5e9"),
				Name = @"LlmModelName",
				IsValueCloneable = false,
				CreatedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
				ModifiedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
		...
		protected virtual EntitySchemaColumn CreateLlmModelTemperatureColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Float2")) {
				UId = new Guid("5523b5a6-b5d0-c765-7734-0a5980048dae"),
				Name = @"LlmModelTemperature",
				IsValueCloneable = false,
				CreatedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
				ModifiedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
				CreatedInPackageId = new Guid("156df22d-8b42-46c8-91d7-a4aa335a181f")
		...
		protected virtual EntitySchemaColumn CreateDocumentMaxChunkSizeColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Integer")) {
				UId = new Guid("1a847f96-71ad-8fa6-6202-fe68e558c6b1"),
				Name = @"DocumentMaxChunkSize",
				IsValueCloneable = false,
				CreatedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
				ModifiedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
				CreatedInPackageId = new Guid("156df22d-8b42-46c8-91d7-a4aa335a181f"),
		...
		protected virtual EntitySchemaColumn CreateDocumentChunkSizeOverlapColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Integer")) {
				UId = new Guid("081bef1d-02af-259e-ba2b-1e5875f7f46b"),
				Name = @"DocumentChunkSizeOverlap",
				IsValueCloneable = false,
				CreatedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
				ModifiedInSchemaUId = new Guid("f0d58f4a-303d-477c-8cf9-d00eaf04f32b"),
				CreatedInPackageId = new Guid("156df22d-8b42-46c8-91d7-a4aa335a181f"),
	...
	public class MLModel : Terrasoft.Configuration.BaseEntity
	{
		...
		public string OpenaiApiKey {
			get {
				return GetTypedColumnValue<string>("OpenaiApiKey");
			}
			set {
				SetColumnValue("OpenaiApiKey", value);
			}
		}
		...
		/// LLM model prompt.
		/// </summary>
		public string LlmModelPrompt {
			get {
				return GetTypedColumnValue<string>("LlmModelPrompt");
			}
			set {
				SetColumnValue("LlmModelPrompt", value);
			}
		}
		...
		public string LlmModelName {
			get {
				return GetTypedColumnValue<string>("LlmModelName");
			}
			set {
				SetColumnValue("LlmModelName", value);
			}
		}

		/// <summary>
		/// Temperature value for LLM model.
		/// </summary>
		public Decimal LlmModelTemperature {
			get {
				return GetTypedColumnValue<Decimal>("LlmModelTemperature");
			}
			set {
				SetColumnValue("LlmModelTemperature", value);
			}
		}

		/// <summary>
		/// Maximum size for document chunks.
		/// </summary>
		public int DocumentMaxChunkSize {
			get {
				return GetTypedColumnValue<int>("DocumentMaxChunkSize");
			}
			set {
				SetColumnValue("DocumentMaxChunkSize", value);
			}
		}

		/// <summary>
		/// Overlap size for document chunks.
		/// </summary>
		public int DocumentChunkSizeOverlap {
			get {
				return GetTypedColumnValue<int>("DocumentChunkSizeOverlap");
			}
			set {
				SetColumnValue("DocumentChunkSizeOverlap", value);
			}
		}

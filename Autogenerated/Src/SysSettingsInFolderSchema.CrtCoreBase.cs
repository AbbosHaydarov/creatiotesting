namespace Terrasoft.Configuration
{
	...
	public class SysSettingsInFolderSchema : Terrasoft.Configuration.BaseItemInFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysSettingsInFolder_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class SysSettingsInFolder : Terrasoft.Configuration.BaseItemInFolder
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysSettingsInFolder_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysSettingsInFolder_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class SysSettingsInFolder_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : SysSettingsInFolder
	{

		public SysSettingsInFolder_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysSettingsInFolder_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class SysSettingsInFolder_CrtCoreBaseEventsProcess : SysSettingsInFolder_CrtCoreBaseEventsProcess<SysSettingsInFolder>
	{
	...
	public partial class SysSettingsInFolder_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysSettingsInFolderEventsProcess : SysSettingsInFolder_CrtCoreBaseEventsProcess
	{

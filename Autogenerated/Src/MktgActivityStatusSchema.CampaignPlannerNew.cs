namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class MktgActivityStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
	...
	/// </summary>
	public class MktgActivityStatus : Terrasoft.Configuration.BaseLookup
	{
	...
	/// <exclude/>
	public partial class MktgActivityStatus_CampaignPlannerNewEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : MktgActivityStatus
	{
	...
	/// <exclude/>
	public class MktgActivityStatus_CampaignPlannerNewEventsProcess : MktgActivityStatus_CampaignPlannerNewEventsProcess<MktgActivityStatus>
	{
	...
	/// <exclude/>
	public class MktgActivityStatusEventsProcess : MktgActivityStatus_CampaignPlannerNewEventsProcess
	{

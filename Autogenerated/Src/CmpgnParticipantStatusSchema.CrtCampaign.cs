namespace Terrasoft.Configuration
{
	...
	public class CmpgnParticipantStatusSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new CmpgnParticipantStatus_CrtCampaignEventsProcess(userConnection);
		}
	...
	public class CmpgnParticipantStatus : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new CmpgnParticipantStatus_CrtCampaignEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: CmpgnParticipantStatus_CrtCampaignEventsProcess

	/// <exclude/>
	public partial class CmpgnParticipantStatus_CrtCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CmpgnParticipantStatus
	{

		public CmpgnParticipantStatus_CrtCampaignEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "CmpgnParticipantStatus_CrtCampaignEventsProcess";
	...
	/// <exclude/>
	public class CmpgnParticipantStatus_CrtCampaignEventsProcess : CmpgnParticipantStatus_CrtCampaignEventsProcess<CmpgnParticipantStatus>
	{
	...
	public partial class CmpgnParticipantStatus_CrtCampaignEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class CmpgnParticipantStatusEventsProcess : CmpgnParticipantStatus_CrtCampaignEventsProcess
	{

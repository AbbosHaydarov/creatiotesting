define("FacebookClientUtilities", ["FacebookClientUtilitiesResources", "ConfigurationConstants"],
	...
	Ext.define("Terrasoft.configuration.social.mixins.FacebookClientUtilities", {
		...
		getCanAddSeveralProfilesForOneRecord: function(canAddSeveralFacebookProfiles) {
			if (canAddSeveralFacebookProfiles) {
				return true;
			}
			return !this.get("FacebookProfileExists");
		},

		initCanAddSeveralFacebookProfiles: function() {
			this.canAddSeveralFacebookProfiles = Terrasoft.Features.getIsDisabled("CanAddOnlyOneFacebookProfile");
		},

		setCanDirectManageаFacebookProfile: function (items, canDirectManageаFacebookProfile) {
			if (canDirectManageаFacebookProfile) {
				items.forEach(item => item.set("CanDirectChangeRecord", true, {silent: true}));
			}
		},

		initCanDirectManageаFacebookProfile: function() {
			this.canDirectManageаFacebookProfile =
				Terrasoft.Features.getIsDisabled("DisableDirectManageаFacebookProfile");
		}
	});
});

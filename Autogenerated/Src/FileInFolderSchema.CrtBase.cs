namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class FileInFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseItemInFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : FileInFolder
	{

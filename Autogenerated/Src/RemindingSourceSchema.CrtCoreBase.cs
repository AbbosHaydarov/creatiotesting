namespace Terrasoft.Configuration
{
	...
	public class RemindingSourceSchema : Terrasoft.Configuration.BaseCodeLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new RemindingSource_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class RemindingSource : Terrasoft.Configuration.BaseCodeLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new RemindingSource_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: RemindingSource_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class RemindingSource_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : RemindingSource
	{

		public RemindingSource_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "RemindingSource_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class RemindingSource_CrtCoreBaseEventsProcess : RemindingSource_CrtCoreBaseEventsProcess<RemindingSource>
	{
	...
	public partial class RemindingSource_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class RemindingSourceEventsProcess : RemindingSource_CrtCoreBaseEventsProcess
	{

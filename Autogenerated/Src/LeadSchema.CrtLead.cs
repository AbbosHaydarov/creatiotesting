namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class Lead_CrtLeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityNotes_CrtCoreBaseEventsProcess<TEntity> where TEntity : Lead_CrtLead_Terrasoft
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class JunkFilterTypeOfField_CrtJunkFilterEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : JunkFilterTypeOfField
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwWorkspaceObjects_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwWorkspaceObjects
	{

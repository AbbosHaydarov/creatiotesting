namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AdCampaignStatus_CrtDigitalAdsAppEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : AdCampaignStatus
	{

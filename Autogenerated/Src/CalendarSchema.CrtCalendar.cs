namespace Terrasoft.Configuration
{
	...
	#region Class: Calendar_CrtCalendar_TerrasoftSchema

	/// <exclude/>
	public class Calendar_CrtCalendar_TerrasoftSchema : Terrasoft.Configuration.BaseHierarchicalLookupSchema
	{

		#region Constructors: Public

		public Calendar_CrtCalendar_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Calendar_CrtCalendar_TerrasoftSchema(Calendar_CrtCalendar_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Calendar_CrtCalendar_TerrasoftSchema(Calendar_CrtCalendar_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "Calendar_CrtCalendar_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Calendar_CrtCalendar_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Calendar_CrtCalendarEventsProcess(userConnection);
		}

		public override object Clone() {
			return new Calendar_CrtCalendar_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Calendar_CrtCalendar_TerrasoftSchema(this, true);
		}
	...
	#region Class: Calendar_CrtCalendar_Terrasoft

	/// <summary>
	/// Calendar.
	/// </summary>
	public class Calendar_CrtCalendar_Terrasoft : Terrasoft.Configuration.BaseHierarchicalLookup
	{

		#region Constructors: Public

		public Calendar_CrtCalendar_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Calendar_CrtCalendar_Terrasoft";
		}

		public Calendar_CrtCalendar_Terrasoft(Calendar_CrtCalendar_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Calendar_CrtCalendarEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Calendar_CrtCalendar_TerrasoftDeleted", e);
			Inserting += (s, e) => ThrowEvent("Calendar_CrtCalendar_TerrasoftInserting", e);
			Validating += (s, e) => ThrowEvent("Calendar_CrtCalendar_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new Calendar_CrtCalendar_Terrasoft(this);
		}
	...
	#region Class: Calendar_CrtCalendarEventsProcess

	/// <exclude/>
	public partial class Calendar_CrtCalendarEventsProcess<TEntity> : Terrasoft.Configuration.BaseHierarchicalLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : Calendar_CrtCalendar_Terrasoft
	{

		public Calendar_CrtCalendarEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Calendar_CrtCalendarEventsProcess";
	...
	/// <exclude/>
	public class Calendar_CrtCalendarEventsProcess : Calendar_CrtCalendarEventsProcess<Calendar_CrtCalendar_Terrasoft>
	{
	...
	public partial class Calendar_CrtCalendarEventsProcess<TEntity>
	{

namespace Terrasoft.Configuration
{
	...
	public class WebFormData : Terrasoft.Configuration.WebFormData_CrtWebForm_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("WebFormDataDeleted", e);
			Deleting += (s, e) => ThrowEvent("WebFormDataDeleting", e);
			Inserted += (s, e) => ThrowEvent("WebFormDataInserted", e);
			Inserting += (s, e) => ThrowEvent("WebFormDataInserting", e);
			Saved += (s, e) => ThrowEvent("WebFormDataSaved", e);
			Saving += (s, e) => ThrowEvent("WebFormDataSaving", e);
			Validating += (s, e) => ThrowEvent("WebFormDataValidating", e);

namespace Terrasoft.Configuration
{
	...
	public class SysPrcElHistoryLog : Terrasoft.Configuration.SysBasePrcElLog
	{
		...
		protected override void InitializeThrowEvents() {
			...
			Deleting += (s, e) => ThrowEvent("SysPrcElHistoryLogDeleting", e);
			Inserted += (s, e) => ThrowEvent("SysPrcElHistoryLogInserted", e);
			Inserting += (s, e) => ThrowEvent("SysPrcElHistoryLogInserting", e);
			Saved += (s, e) => ThrowEvent("SysPrcElHistoryLogSaved", e);
			Saving += (s, e) => ThrowEvent("SysPrcElHistoryLogSaving", e);
			Validating += (s, e) => ThrowEvent("SysPrcElHistoryLogValidating", e);

namespace Terrasoft.Configuration
{
	...
	public class BaseLookupSchema : Terrasoft.Configuration.BaseEntitySchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new BaseLookup_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class BaseLookup : Terrasoft.Configuration.BaseEntity
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new BaseLookup_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: BaseLookup_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class BaseLookup_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : BaseLookup
	{

		public BaseLookup_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "BaseLookup_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class BaseLookup_CrtCoreBaseEventsProcess : BaseLookup_CrtCoreBaseEventsProcess<BaseLookup>
	{
	...
	public partial class BaseLookup_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class BaseLookupEventsProcess : BaseLookup_CrtCoreBaseEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	#region Class: KnowledgeBase_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class KnowledgeBase_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public KnowledgeBase_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public KnowledgeBase_CrtCoreBase_TerrasoftSchema(KnowledgeBase_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public KnowledgeBase_CrtCoreBase_TerrasoftSchema(KnowledgeBase_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "KnowledgeBase_CrtCoreBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new KnowledgeBase_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new KnowledgeBase_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new KnowledgeBase_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new KnowledgeBase_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: KnowledgeBase_CrtCoreBase_Terrasoft

	/// <summary>
	/// Knowledge base article.
	/// </summary>
	public class KnowledgeBase_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public KnowledgeBase_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "KnowledgeBase_CrtCoreBase_Terrasoft";
		}

		public KnowledgeBase_CrtCoreBase_Terrasoft(KnowledgeBase_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new KnowledgeBase_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("KnowledgeBase_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("KnowledgeBase_CrtCoreBase_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("KnowledgeBase_CrtCoreBase_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("KnowledgeBase_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("KnowledgeBase_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("KnowledgeBase_CrtCoreBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("KnowledgeBase_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new KnowledgeBase_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: KnowledgeBase_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class KnowledgeBase_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : KnowledgeBase_CrtCoreBase_Terrasoft
	{
		...
		public class GenerateNumberUserTaskFlowElement : GenerateSequenseNumberUserTask
		{
			...
			public GenerateNumberUserTaskFlowElement(UserConnection userConnection, KnowledgeBase_CrtCoreBaseEventsProcess<TEntity> process)
				: base(userConnection) {
				UId = Guid.NewGuid();
				Owner = process;
		...
		public KnowledgeBase_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "KnowledgeBase_CrtCoreBaseEventsProcess";
		...
		public override void ThrowEvent(ProcessExecutingContext context, string message) {
			switch(message) {
					case "KnowledgeBase_CrtCoreBase_TerrasoftSaved":
	...
	/// <exclude/>
	public class KnowledgeBase_CrtCoreBaseEventsProcess : KnowledgeBase_CrtCoreBaseEventsProcess<KnowledgeBase_CrtCoreBase_Terrasoft>
	{
	...
	public partial class KnowledgeBase_CrtCoreBaseEventsProcess<TEntity>
	{

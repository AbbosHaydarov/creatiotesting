namespace Terrasoft.Configuration
{
	...
	public class DistributionTypeSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new DistributionType_CrtBaseEventsProcess(userConnection);
		}
	...
	public class DistributionType : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new DistributionType_CrtBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: DistributionType_CrtBaseEventsProcess

	/// <exclude/>
	public partial class DistributionType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : DistributionType
	{

		public DistributionType_CrtBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "DistributionType_CrtBaseEventsProcess";
	...
	/// <exclude/>
	public class DistributionType_CrtBaseEventsProcess : DistributionType_CrtBaseEventsProcess<DistributionType>
	{
	...
	public partial class DistributionType_CrtBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class DistributionTypeEventsProcess : DistributionType_CrtBaseEventsProcess
	{

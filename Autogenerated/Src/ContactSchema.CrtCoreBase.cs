namespace Terrasoft.Configuration
{
	...
	#region Class: Contact_CrtCoreBase_TerrasoftSchema

	/// <exclude/>
	public class Contact_CrtCoreBase_TerrasoftSchema : Terrasoft.Configuration.BaseEntitySchema
	{

		#region Constructors: Public

		public Contact_CrtCoreBase_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Contact_CrtCoreBase_TerrasoftSchema(Contact_CrtCoreBase_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Contact_CrtCoreBase_TerrasoftSchema(Contact_CrtCoreBase_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			Name = "Contact_CrtCoreBase_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Contact_CrtCoreBase_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Contact_CrtCoreBaseEventsProcess(userConnection);
		}

		public override object Clone() {
			return new Contact_CrtCoreBase_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Contact_CrtCoreBase_TerrasoftSchema(this, true);
		}
	...
	#region Class: Contact_CrtCoreBase_Terrasoft

	/// <summary>
	/// Contact.
	/// </summary>
	public class Contact_CrtCoreBase_Terrasoft : Terrasoft.Configuration.BaseEntity
	{

		#region Constructors: Public

		public Contact_CrtCoreBase_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Contact_CrtCoreBase_Terrasoft";
		}

		public Contact_CrtCoreBase_Terrasoft(Contact_CrtCoreBase_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Contact_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("Contact_CrtCoreBase_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("Contact_CrtCoreBase_TerrasoftDeleting", e);
			Inserting += (s, e) => ThrowEvent("Contact_CrtCoreBase_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("Contact_CrtCoreBase_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("Contact_CrtCoreBase_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("Contact_CrtCoreBase_TerrasoftValidating", e);
		...
		public override object Clone() {
			return new Contact_CrtCoreBase_Terrasoft(this);
		}
	...
	#region Class: Contact_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class Contact_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntity_LocalMessageEventsProcess<TEntity> where TEntity : Contact_CrtCoreBase_Terrasoft
	{
		...
		public class SynchronizeAnniversaryFlowElement : SynchronizeChildEntityData
		{
			...
			public SynchronizeAnniversaryFlowElement(UserConnection userConnection, Contact_CrtCoreBaseEventsProcess<TEntity> process)
				: base(userConnection) {
				UId = Guid.NewGuid();
				Owner = process;
		...
		public Contact_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Contact_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class Contact_CrtCoreBaseEventsProcess : Contact_CrtCoreBaseEventsProcess<Contact_CrtCoreBase_Terrasoft>
	{

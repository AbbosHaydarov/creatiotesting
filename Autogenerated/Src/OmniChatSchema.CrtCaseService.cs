namespace Terrasoft.Configuration
{
	...
	public class OmniChat_CrtCaseService_Terrasoft : Terrasoft.Configuration.OmniChat_OmnichannelMessaging_Terrasoft
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("OmniChat_CrtCaseService_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("OmniChat_CrtCaseService_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("OmniChat_CrtCaseService_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("OmniChat_CrtCaseService_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("OmniChat_CrtCaseService_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("OmniChat_CrtCaseService_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("OmniChat_CrtCaseService_TerrasoftValidating", e);

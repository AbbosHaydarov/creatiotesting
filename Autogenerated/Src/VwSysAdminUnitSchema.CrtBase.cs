namespace Terrasoft.Configuration
{
	...
	public class VwSysAdminUnit_CrtBase_TerrasoftSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		protected override void InitializeColumns() {
			...
			if (Columns.FindByUId(new Guid("73166daf-76bb-b80d-6441-b5c6072a2dd9")) == null) {
		...
		protected virtual EntitySchemaColumn CreateWeekFirstDayColumn() {
			return new EntitySchemaColumn(this, DataValueTypeManager.GetInstanceByName("Lookup")) {
				UId = new Guid("73166daf-76bb-b80d-6441-b5c6072a2dd9"),
				Name = @"WeekFirstDay",
	...
	/// <exclude/>
	public partial class VwSysAdminUnit_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSysAdminUnit_CrtBase_Terrasoft
	{

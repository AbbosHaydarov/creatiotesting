		...
		return {
			...
			methods: {
				...
				onDefaultValuesInitialized: function () {
					...
					const components =  Terrasoft.UseMfForAngularElements
						? ["mf!OmnichannelMessagingComponent", "css-ltr!OmnichannelMessagingComponentStyles"]
						: ["OmnichannelMessagingComponentOld"];
					this.Terrasoft.require(components, function () {

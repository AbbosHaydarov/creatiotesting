namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class WebService_CrtProcessDesignerEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : WebService
	{

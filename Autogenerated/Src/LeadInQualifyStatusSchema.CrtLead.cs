namespace Terrasoft.Configuration
{
	...
	public class LeadInQualifyStatus_CrtLead_Terrasoft : Terrasoft.Configuration.BaseEntityInStage
	{
		...
		protected override void InitializeThrowEvents() {
			Deleted += (s, e) => ThrowEvent("LeadInQualifyStatus_CrtLead_TerrasoftDeleted", e);
			Deleting += (s, e) => ThrowEvent("LeadInQualifyStatus_CrtLead_TerrasoftDeleting", e);
			Inserted += (s, e) => ThrowEvent("LeadInQualifyStatus_CrtLead_TerrasoftInserted", e);
			Inserting += (s, e) => ThrowEvent("LeadInQualifyStatus_CrtLead_TerrasoftInserting", e);
			Saved += (s, e) => ThrowEvent("LeadInQualifyStatus_CrtLead_TerrasoftSaved", e);
			Saving += (s, e) => ThrowEvent("LeadInQualifyStatus_CrtLead_TerrasoftSaving", e);
			Validating += (s, e) => ThrowEvent("LeadInQualifyStatus_CrtLead_TerrasoftValidating", e);

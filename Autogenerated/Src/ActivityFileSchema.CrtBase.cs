namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ActivityFile_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.File_LinkPreviewEventsProcess<TEntity> where TEntity : ActivityFile
	{

namespace Terrasoft.Configuration
{
	...
	public class EventFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new EventFolder_CrtEventEventsProcess(userConnection);
		}
	...
	public class EventFolder : Terrasoft.Configuration.BaseFolder
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new EventFolder_CrtEventEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: EventFolder_CrtEventEventsProcess

	/// <exclude/>
	public partial class EventFolder_CrtEventEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtCoreBaseEventsProcess<TEntity> where TEntity : EventFolder
	{

		public EventFolder_CrtEventEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "EventFolder_CrtEventEventsProcess";
	...
	/// <exclude/>
	public class EventFolder_CrtEventEventsProcess : EventFolder_CrtEventEventsProcess<EventFolder>
	{
	...
	public partial class EventFolder_CrtEventEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class EventFolderEventsProcess : EventFolder_CrtEventEventsProcess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class UIType_CrtNUIEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : UIType_CrtNUI_Terrasoft
	{

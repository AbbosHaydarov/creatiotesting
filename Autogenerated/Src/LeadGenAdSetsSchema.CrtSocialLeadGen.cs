namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadGenAdSets_CrtSocialLeadGenEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LeadGenAdSets
	{

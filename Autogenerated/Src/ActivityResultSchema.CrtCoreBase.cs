namespace Terrasoft.Configuration
{
	...
	public class ActivityResultSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new ActivityResult_CrtCoreBaseEventsProcess(userConnection);
		}
	...
	public class ActivityResult : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new ActivityResult_CrtCoreBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: ActivityResult_CrtCoreBaseEventsProcess

	/// <exclude/>
	public partial class ActivityResult_CrtCoreBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : ActivityResult
	{

		public ActivityResult_CrtCoreBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "ActivityResult_CrtCoreBaseEventsProcess";
	...
	/// <exclude/>
	public class ActivityResult_CrtCoreBaseEventsProcess : ActivityResult_CrtCoreBaseEventsProcess<ActivityResult>
	{
	...
	public partial class ActivityResult_CrtCoreBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class ActivityResultEventsProcess : ActivityResult_CrtCoreBaseEventsProcess
	{

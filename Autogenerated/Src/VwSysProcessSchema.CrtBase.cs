namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwSysProcess_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.VwSysSchemaInWorkspace_CrtCoreBaseEventsProcess<TEntity> where TEntity : VwSysProcess
	{

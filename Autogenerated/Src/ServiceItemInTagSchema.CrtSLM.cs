namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceItemInTag_CrtSLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : ServiceItemInTag
	{

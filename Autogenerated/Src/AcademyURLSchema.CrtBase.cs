namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AcademyURL_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : AcademyURL_CrtBase_Terrasoft
	{

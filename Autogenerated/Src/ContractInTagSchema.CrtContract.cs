namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ContractInTag_CrtContractEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : ContractInTag
	{

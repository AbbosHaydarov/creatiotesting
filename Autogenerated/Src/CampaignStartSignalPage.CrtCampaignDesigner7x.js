		...
		methods: {
			...
			_getSignalEntityInfo: function(signalEntityId, callback, scope) {
				...
				esq.getEntity(signalEntityId, function(response) {
					...
					var extraValues = this.extendSignalEntityInfo(entity);
			...
			_createEntitySelectList: function(schemaItems) {
				...
				schemaItems.each(function(schemaItem) {
					...
					var itemData = this.extendSignalEntityInfo(schemaItem); 
					resultList[id] = {
						value: id,
			...
			/**
			 * Prepare ESQ for signal entities.
			 * @protected
			 */
			...
			/**
			 * Initializes additional parameters for signal entity
			 * @param {Terrasoft.BaseModel} entity Model of signal entity schema.
			 * @protected
			 */
				...
				if (!this.Ext.isEmpty(signalEntityId)) {
					this._getSignalEntityInfo(signalEntityId, function(item) {
						if (item) {
							...
							this.initValuesFromEntitySchemaSelect()
						}
			...
			/**
			 * Set values from EntitySchemaSelect
			 * @protected
			 */
			initValuesFromEntitySchemaSelect: function() {}
		},
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "remove",

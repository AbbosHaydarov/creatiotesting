namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CaseRuleHandler_CaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : CaseRuleHandler
	{

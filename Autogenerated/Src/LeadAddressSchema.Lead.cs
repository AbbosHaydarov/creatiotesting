namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LeadAddress_LeadEventsProcess<TEntity> : Terrasoft.Configuration.BaseAddress_AddressFinanceEventsProcess<TEntity> where TEntity : LeadAddress
	{

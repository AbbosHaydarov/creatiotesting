	...
	public class GlobalSearchBaseEntityListener : BaseEntityEventListener
	{
		...
		public override void OnInserted(object sender, EntityAfterEventArgs e) {
			...
			try {
				...
				_log.Error($"Error during indexing after entity inserted: {entity?.PrimaryColumnValue}", exception);
			}
		}
		...
		public override void OnDeleted(object sender, EntityAfterEventArgs e) {
			...
			try {
				...
				_log.Error($"Error during indexing after entity deleted: {entity?.PrimaryColumnValue}", exception);
			}
		}
		...
		public override void OnUpdated(object sender, EntityAfterEventArgs e) {
			...
			try {
				...
				_log.Error($"Error during indexing after entity updated: {entity?.PrimaryColumnValue}", exception);
			}
		}

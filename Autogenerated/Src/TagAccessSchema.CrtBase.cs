namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class TagAccess_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : TagAccess
	{

namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class VwGroupSysAdminUnit_CaseEventsProcess<TEntity> : Terrasoft.Configuration.SysAdminUnit_CrtBaseFinservEventsProcess<TEntity> where TEntity : VwGroupSysAdminUnit
	{

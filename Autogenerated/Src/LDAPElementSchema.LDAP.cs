namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class LDAPElement_LDAPEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtCoreBaseEventsProcess<TEntity> where TEntity : LDAPElement
	{

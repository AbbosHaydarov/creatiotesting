namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DocumentInTag_CrtDocumentEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtCoreBaseEventsProcess<TEntity> where TEntity : DocumentInTag
	{
